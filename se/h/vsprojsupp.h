...
EXTERN_C int VSAPI _GetXcodeProjectGetSubProjects(VSPSZ projectPath, VSHREFVAR projectslistRef);
 ...
 * @return int Zero on success
 */
EXTERN_C int VSAPI _InsertVCXProjectHierarchy(VSPSZ workspaceFilePath, VSPSZ projectFilePath, int isFilterFile, int treeID, int iParentIndex);
...
EXTERN_C
int VSAPI scGetProjectFiles(VSPSZ workspaceFile, VSPSZ projectFile, VSHREFVAR filelist, int absolute, int projectHandle = -1,int expandWildCardsInAssociatedProjects=1);

EXTERN_C
int VSAPI scGetProjectDerivedSourceFiles(VSPSZ workspaceFile, VSPSZ projectFile, VSHREFVAR filelist, int absolute, int projectHandle);

EXTERN_C
void VSAPI scProjectMatchFile(VSPSZ workspaceFile, VSPSZ projectFile, VSPSZ file, VSHREFVAR filelist,int append,int force_case_insensitive_matching);
...
EXTERN_C
VSPSZ VSAPI scProjectGetTaggingOption(VSPSZ workspaceFile, VSPSZ projectFile);

EXTERN_C
int VSAPI scIsFileInProject(VSPSZ workspaceFile, VSPSZ projectFile, VSPSZ file);

EXTERN_C
int VSAPI scIsDerivedSourceFile(VSPSZ workspaceFile, VSPSZ projectFile, VSPSZ file);
...
VSDLLEXPORT int SEGetProjectFiles(const slickedit::SEString &workspaceFile, 
                                  ...
                                  bool absolute, int projectHandle = -1, bool derivedFiles=false, bool expandWildCardsInAssociatedProjects=true);

VSDLLEXPORT void SEProjectMatchFile(const slickedit::SEString &workspaceFile, const slickedit::SEString &projectFile,
                                    const slickedit::SEString &file, slickedit::SEArray<slickedit::SEString> &filelist,int force_case_insensitive_matching);
...
VSDLLEXPORT slickedit::SEString SEProjectGetTaggingOption(const slickedit::SEString &workspaceFile, const slickedit::SEString &projectFile);
...
VSDLLEXPORT bool SEIsFileProjectWildcard(const slickedit::SEString &workspaceFile, 
                                         const slickedit::SEString &projectFile,
                                         const slickedit::SEString file);

VSDLLEXPORT bool SEIsDerivedSourceFile(const slickedit::SEString& workspaceFile, 
                                       const slickedit::SEString& projectFile,
                                       const slickedit::SEString file);
...
VSDLLEXPORT int SEGetWildcardFiles(const slickedit::SEString &projectPath, 
                                   const SEWildcardInfo &wildcards, 
