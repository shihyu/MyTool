...
#define VSOFN_NOOVERWRITEPROMPT 0x8  // Don't prompt user with overwrite existing dialog. */
...
#define VSP_OUTERMOST_ACTIVE_FORM  32 // int
/* #define                         32 *//* int */
...
#define VSP_AUTOSELECTEXTENSION VSDEPRECATECONSTANT(240)  // deprecated, use VSP_AUTOSELECTLANGUAGE
...
#define VSP_AUTOLEFTMARGIN             313   // boolean
#define VSP_FIXEDWIDTHRIGHTMARGIN      314   // int
#define VSP_ALLOWDELETEHISTORY         315   // boolean
#define VSP_HEX_MODE_RELOAD_ENCODING   316   // int
#define VSP_WIDTH_OF_SPACE             317   // int
#define VSP_HEX_MODE_RELOAD_BUF_WIDTH  318   // int
#define VSP_MODIFIED_TEMP_NAME         319   // String
#define VSP_SPELL_CHECK_WHILE_TYPING   320   // boolean
//#define I_CUSTOMDELEGATE             321   // int
#define VSP_SPELL_CHECK_WHILE_TYPING_ELEMENTS   322   // string
#define VSP_X_EXTENT                   323   // int
#define VSP_Y_EXTENT                   324   // int
#define VSP_SHOW_MINIMAP               325   // boolean
#define VSP_ISMINIMAP                  326   // boolean
#define VSP_FONT_SCALABLE              327   // boolean
#define VSP_MINIMAP_WIDTH_IS_FIXED     328   // boolean
#define VSP_MINIMAP_WIDTH              329   // int
#define VSP_MINIMAP_WID                330   // int
#define VSP_SCROLL_HAS_MARKUP          331   // int
#define VSP_HEX_BYTES_PER_COL          332   // unsigned char
#define VSP_MINIMAP_TO_EDITOR_WID      333   // int
#define VSP_SHOWEXTRALINE              334   // bool
#define VSP_INTERACTIVE_WID            335   // int
#define VSP_FORCEWRAPLINELEN           336   // int
 ...
 */
#define VSARG2_AUTO_DESELECT 0x200  
...
#define VSARG2_MULTI_CURSOR                0x10000000            // Execute this command for each cursor when in multi-cursor mode
#define VSARG2_REQUIRES_PRO_EDITION        0x20000000            // This command is not allowed in the Standard edition
...
#define VSBUFFLAG_DISABLE_SPELL_CHECK_WHILE_TYPING  0x200  /* Don't allow spell checking while typing for this buffer */
...
#define VSOPTION_SEARCHDEFAULTFLAGS           36
   ...
   //#define VSSEARCHDEFAULTFLAG_RE_SYNTAX_PERL           0x000
   ...
   #define VSSEARCHDEFAULTFLAG_RE_VIM                   0x8000

   #define VSSEARCHDEFAULTFLAGC_RE_SYNTAX_MASK         (0x800|0x2000|0x4000|0x8000)
...
#define VSOPTION_MULTI_CURSOR_AUTO_MERGE           86
#define VSOPTION_SPECIAL_CHAR_TAB_OPTION           87
#define VSOPTION_SPECIAL_CHAR_SPACE_OPTION         88
   // Hovering over a dock-channel Tab raises the auto-hide window
   #define VSOPTION_DOCKCHANNEL_HOVER  0x1
#define VSOPTION_DOCKCHANNEL_FLAGS                 89
#define VSOPTION_DOCKCHANNEL_HOVER_DELAY           90
// Milliseconds to wait before lowering auto-hide window 
// when unfocused and mouse not inside.
#define VSOPTION_TOOLWINDOW_AUTOHIDE_DELAY         91
#define VSOPTION_DRAW_SELECTIVE_DISPLAY_LINES      92
// show all windows on the primary display only
#define VSOPTION_PRIMARY_DISPLAY                   93
#define VSOPTION_STATE_FILE_HOT_FIX_VERSION        94
#define VSOPTION_WIN_RESOLVE_SYMLINKS              95
/*
Mini Find dialog needs this option. When processing, 
multiple files (like <workspace>) and in one file per window mode 
holding down the Enter key would potentially modify the editor 
buffer. There's a small window of time where the mini find dialog gets closed 
for the first window, then the second editor window is opened and has focus
before the new instance of the mini find dialog is displayed. 
Setting this option fixes this problem. Be sure to turn it off 
when done with the operation. For safety, this option will be 
automatically turned off after enough time has elapsed since the editor 
control was created.
 
NOTE: Visual Studio 2015 has this bug and never fixed it. 
*/
#define VSOPTION_INITIALLY_DISABLE_EDITOR_CONTROL_KEY_INPUT  96
#define VSOPTION_MAX_ALLOCATORS                              97
#define VSOPTION_DRAW_VERTICAL_LINE_AT_CURSOR                98
#define VSOPTION_EXITING_APP                                 99

/* #define VSOPTION_APP_THEME  100 **SAFE TO REUSE** */

// When on, allow auto mapping of keypad keys if
// p_window_flags don't have VSWFLAG_NO_AUTO_MAP_PAD_KEYS
#define VSOPTION_AUTO_MAP_PAD_KEYS   101
// 0x0  No support for .editorconfig or .seeditorconfig.xml
// 0x1  .editorconfig support
// 0x2  .seeditorconfig.xml support
#define VSOPTION_EDITORCONFIG_FLAGS       102
#define VSOPTION_MAX_DELTA_SIZE_IN_K      103
#define VSOPTION_MIN_FAST_DELTA_SIZE_IN_K 104
#define VSOPTION_FORCERO                  105
#define VSOPTION_AUTORESTORE_MULTIPLE_MONITOR_CONFIGS 106
#define VSOPTION_MINIMAP_MOVE_CURSOR_ON_CLICK 107
#define VSOPTION_MINIMAP_WIDTH_IS_FIXED 108
#define VSOPTION_MINIMAP_WIDTH          109
#define VSOPTION_MINIMAP_WIDTH_PERCENTAGE 110
#define VSOPTION_MINIMAP_DELAYED_UPDATING 111
#define VSOPTION_MINIMAP_SHOW_VERTICAL_LINES 112
#define VSOPTION_MINIMAP_LEFT_MARGIN      113
#define VSOPTION_MINIMAP_SHOW_MODIFIED_LINES 114
#define VSOPTION_MINIMAP_ALTERNATE_SEARCH_HILIGHTING 115
#define VSOPTION_MINIMAP_SHOW_TOOLTIP     116
#define VSOPTION_BACKUP_HISTORY_VERIFY_CHECKSUMS     117
#define VSOPTION_DIFF_TIMEOUT_IN_SECONDS  118
#define VSOPTION_DIR_PROJECT_FLAGS        119
#define VSOPTION_XTERM_BUILD_COLORING     120
#define VSOPTION_BETA_NUMBER              121
#define VSOPTION_SHOW_EXTRA_LINE_AFTER_LAST_NL 122
#define VSOPTION_LOCALSTA                 123
/*
 Windos only:
 Currently, this only effects the absolute()
 function when called with a filename over 254 bytes
 without the resolve symlinks option. This is
 useful if your filename is being passed as an
 argument to a tool that doesn't support long filenames.
*/
#define VSOPTION_PREFER_SHORT_FILENAMES   124
// Mac only:
// Hack for macOS Catalina (10.15) slow scrolling performance in 
// editor window is (especially noted at higher resolution). 
#define VSOPTION_MAC_USE_SCROLL_PERFORMANCE_HACK  125
// +new +newi options (0,1,2 (restore files))
#define VSOPTION_NEW_OPTION         126
#define VSOPTION_ALLOW_FILE_LOCKING    127
/* 
  Indicates whether plugins should be loaded at startup.
  Used by bgsearch which runs a second instance of SlickEdit
  to support the "List current context" multi-file find feature
*/
#define VSOPTION_LOAD_PLUGINS     128
/* 
  Indicates whether tag files should be automatically
  created (like when typing).
  Used by bgsearch which runs a second instance of SlickEdit
  to support the "List current context" multi-file find feature
*/
#define VSOPTION_AUTO_BUILD_TAG_FILES  129
...
#define VSOPTIONZ_SPECIAL_CHAR_XLAT_TAB  1001
   ...
   #define VSSPECIALCHAR_NOFCHARS  11
   #define VSSPECIALCHAR_MAX     (VSSPECIALCHAR_NOFCHARS+1)   /* 1 extra for null termination character */
...
#define VSOPTIONZ_DATE_FORMAT_UNIX            1007
#define VSOPTIONZ_TIME_FORMAT_UNIX            1008
// Theme used by application
#define VSOPTIONZ_APP_THEME                   1009
#define VSOPTIONZ_MINIMAP_NO_ANTI_ALIASING    1010
#define VSOPTIONZ_DEFAULT_EXCLUDES            1011
#define VSOPTIONZ_DIR_PROJECT_EXCLUDES        1012
#define VSOPTIONZ_DIR_PROJECT_INCLUDES        1013
#define VSOPTIONZ_DIR_PROJECT_TYPE            1014
#define VSOPTIONZ_ZIP_EXT_LIST                1015
#define VSOPTIONZ_APP_THEME_AUTO              1016
 ...
 * contain <i>Len</i>+1 bytes of data.
 *
 * @param appendNull	If false, do not append a null to
 * <i>pszBuf</i>. Buffer will be entirely filled with data read
 * from
 * <i>wid</i>.
 *
 * @see vsInsertLine
 ...
 *
 */
int VSAPI vsGetText(int wid, int Nofbytes, seSeekPos seekpos, char *pszBuf, int appendNull VSDEFAULT(1));
/**
 ...
 *
 */
void VSAPI vsBottom(int wid,bool goto_to_bottom_visible_line=false);
/**
...
/**
 * Moves cursor down the number of lines specified by 
 * <i>Noflines</i>, including wrapped long lnes (each wrapped
 * line is treated individiually). If the destination line is
 * not in view, it is center scrolled or smooth scrolled into
 * view.
 *
 * @return Returns 0 if successful. Otherwise TOP_OF_FILE_RC
 * is returned.
 *
 * @param wid	Window id of editor control.  0 specifies the
 * current object.
 ...
 *
 */
int VSAPI vsScreenUp(int wid, seSeekPos Noflines);
/**
 * Moves cursor down the number of lines specified by 
 * <i>Noflines</i>,, including wrapped long lnes (each wrapped
 * line is treated individiually). If the destination line is not in view, it
 * is center scrolled or smooth scrolled into view.
 *
 * @return Returns 0 if successful. Otherwise BOTTOM_OF_FILE_RC is
 * returned.
 *
 ...
 *
 */
int VSAPI vsScreenDown(int wid, seSeekPos Noflines);
/**
...
void VSAPI vsRight(int wid);
void VSAPI vsLeft(int wid);
/** 
 * @deprecated 
 ...
 */
VSDEPRECATED int VSAPI vsActivateView(int view_id);
 ...
 * state 
 *  
 * <p>Must call vsUndoPopModify after calling this function. 
 *  
 * @param wid	Window id of editor control.  0 specifies the
 * current object.
 */
void VSAPI vsUndoPushModify(int wid);
/**
 * Add an undo pop modify state to restore the pushed undo 
 * modify current modify state 
 *  
 */
void VSAPI vsUndoPopModify(int wid);
/**
 ...
 * @param wid	Window id of editor control.  0 specifies the
 * current object.
 * @param start Start seek position in editor buffer.
 * @param end   End seek position in editor buffer. 
 *  
 ...
 * @categories Edit_Window_Methods, Editor_Control_Methods, Selection_Functions
 */
seSeekPosRet VSAPI vsUTF8CountCharsInRange(int wid, seSeekPosParam start, seSeekPosParam end);
 ...
 */
/*VSDEPRECATED*/ int VSAPI vsTestEvent(int wid=0,VSPSZ pszOptions=nullptr);
...
char **VSAPI vsTagListTagFiles(int reserved VSDEFAULT(0),VSPSZ pszExt VSDEFAULT(0),int includeSlickC VSDEFAULT(1));
void VSAPI vsTagSetExtTagFiles(VSPSZ pszExt,char **ppList,int append VSDEFAULT(0));
...
int VSAPI vsBookmarkAdd(const char *pszBookmarkName,
                        int markid,
                        int vsbmflags = (VSBMFLAG_SHOWTOOLTIP|VSBMFLAG_STANDARD|VSBMFLAG_SHOWPIC),
                        seSeekPos RealLineNumber = seSeekPos(-1),
                        int col = 0,
                        seSeekPos BeginLineROffset = 0,
                        const char *pszLineData = nullptr,
                        const char *pszFilename = nullptr,
                        const char *pszDocumentName = nullptr
                       );
/**
...
void VSAPI vsMessageSetParamS(int index,const slickedit::SEString &str);
 ...
 * filename start with an "_" (ex. "c:\slickedit\_ed_stack.svg"). 
 * This tells SlickEdit that the bitmap is global 
 * (not attatched to a Slick-C&reg; dialog box).
 *
 * @return If succcessful, returns names table index of picture. 
 ...
 * 
 * @param update If true, update the picture if it already
 *               exists. If false, nothing is done if the
 *               picture already exists.
 *
 * @categories File_Functions
 *
 */
int VSAPI vsUpdatePicture(const char *pszFilename,bool update=true);
/**
 ...
 *
 */
int VSAPI vsBufCreateTempView(int buf_id,int *pTempWindowId,int *pOrigWindowId);
/**
 ...
 *                            <b>vsBufEdit</b>, or vsBufMatch.
 * @param documentName	      Set to document name (VSP_DOCUMENTNAME). 
 *                            If <i>defaultToBufferName</i> is non-zero
 *                            and the document name is "" then this
 *                            parameter is set to the buffer name (VSP_BUFNAME).
 * @param MaxDocumentName	  Number of characters allocated to <i>pszDocumentName</i>.
 * @param pMaxDocumentNameLen If this is not 0, this is set to the number of
 *                            characters needed to be allocated.
 * @param defaultToBufferName Indicates that the <i>pszDocumentName</i> parameter
 *                            should be set to the buffer name if the document is "".
 *
 * @categories Buffer_Functions
 */
VSPSZ VSAPI vsBufGetDocumentName(int buf_id,char *pszDocumentName,int MaxDocumentName,int *pMaxDocumentNameLen VSDEFAULT(0),int defaultToBufferName VSDEFAULT(1));
/**
 * Gets the document name to be displayed to the user.
 *
 * @attention
 ...
 * @categories Buffer_Functions
 */
VSPSZ VSAPI vsBufGetDocumentNameS(int buf_id, slickedit::SEString &documentName,int defaultToBufferName VSDEFAULT(1));
void VSAPI vsBeautifierGetBufferProfile(const slickedit::SEString &langId, const slickedit::SEString &buf_name, slickedit::SEString &profile_name);
/**
 ...
 * @categories Buffer_Functions
 */
VSPSZ VSAPI vsBufGetName(int buf_id,
 ...
 * @param buf_id	    Buffer id returned by <b>vsPropGetI</b>(<i>wid</i>,VSP_BUF_ID),
 *                      <b>vsBufEdit</b>, or <b>vsBufMatch</b>.
 * @param bufferName	(output) Name of buffer corresponding to <i>buf_id</i> specified.
 *
 * @categories Buffer_Functions
 */
VSPSZ VSAPI vsBufGetNameS(int buf_id, slickedit::SEString &bufferName);
 ...
 * @param buf_id	    Buffer id returned by <b>vsPropGetI</b>(<i>wid</i>,VSP_BUF_ID),
 *                      <b>vsBufEdit</b>, or <b>vsBufMatch</b>.
 * @param languageId	Name of language setting corresponding to <i>buf_id</i> specified.
 *
 * @categories Buffer_Functions
 */
VSPSZ VSAPI vsBufGetLanguageIdS(int buf_id, slickedit::SEString &languageId);
 ...
 * @param buf_id	       Buffer id returned by <b>vsPropGetI</b>(<i>wid</i>,VSP_BUF_ID),
 *                         <b>vsBufEdit</b>, or <b>vsBufMatch</b>.
 * @param modeName         (output) Name of language mode corresponding to <i>buf_id</i> specified.
 *
 * @categories Buffer_Functions
 */
VSPSZ VSAPI vsBufGetModeNameS(int buf_id, slickedit::SEString &modeName);
 ...
 *                   <b>vsBufEdit</b>, or <b>vsBufMatch</b>.
 *
 * @return Returns newline string. 1 or two bytes.
 *
 * @categories Buffer_Functions
 */
VSPSZ VSAPI vsBufGetNewline(int buf_id);
...
#define VS_LANGUAGE_OPTIONS_VERSION 12
struct VS_LANGUAGE_OPTIONS {
    slickedit::SEString m_langId;
    slickedit::SEHashTable<slickedit::SEString, slickedit::SEString> m_properties;
#if 0
   slickedit::SEString LangId;
   slickedit::SEString LexerName;
#define VSCOLORFLAG_LANGUAGE    0x1
#define VSCOLORFLAG_MODIFY      0x2
#define VSCOLORFLAG_CURRENT_LINE  0x4
   ...
   //int DisplayLineNumbers;  // Boolean ==((LineNumbersFlags & 0x1) != 0)
   //int SyntaxExpansion;  // Boolean.  Ignored for fundamental extension
   slickedit::SEString ModeName;
   slickedit::SEString BeginEndPairs;
   //slickedit::SEString AliasFilename;
   slickedit::SEString EventTableName;
   slickedit::SEString WordChars;
   int IndentStyle; // see VSINDENTSTYLE_???
   int TruncateLength;
   slickedit::SEString InheritsFromLangId;
   int BoundsStart;
   int BoundsEnd;
   int AutoCaps;
   int SoftWrap;
   int SoftWrapOnWord;
   int ShowSpecialChars;    // Was named ShowTabs
   slickedit::SEString FileExtensions;
   int HexMode;
   int LineNumbersLen;
   int LineNumbersFlags;
   slickedit::SEString Tabs;
   int AutoLeftMargin;
   int FixedWidthRightMargin;
#endif
};

int VSAPI vsLangOptionsGetPropertyInt32(const VS_LANGUAGE_OPTIONS *pLangOptions, const slickedit::SEString &name, int defaultValue, bool *pApply=0);
VSINT64 VSAPI vsLangOptionsGetPropertyInt64(const VS_LANGUAGE_OPTIONS *pLangOptions, const slickedit::SEString &name, VSINT64 defaultValue, bool *pApply=0);
// IMPORTANT: pLangOptions->LangId must be set and be valid when calling vsLangOptionsSetPropertyInt32
void VSAPI vsLangOptionsSetPropertyInt32(VS_LANGUAGE_OPTIONS *pLangOptions, const slickedit::SEString &name, int value, bool *pApply=0,int createNew=0);
void VSAPI vsLangOptionsSetPropertyInt64(VS_LANGUAGE_OPTIONS *pLangOptions, const slickedit::SEString &name, VSINT64 value, bool *pApply=0,int createNew=0);
// IMPORTANT: pLangOptions->LangId must be set and be valid when calling vsLangOptionsSetProperty
void VSAPI vsLangOptionsSetProperty(VS_LANGUAGE_OPTIONS *pLangOptions, const slickedit::SEString &name, const slickedit::SEString &value, bool *pApply=0,int createNew=1);

typedef VS_LANGUAGE_OPTIONS VSEXTENSIONOPTIONS;
#define VSEXTENSIONOPTIONS_VERSION VS_LANGUAGE_OPTIONS_VERSION

// VS_LANGUAGE_OPTIONS::m_properties
#define VSLOI_SYNTAX_INDENT "syntax_indent"
#define VSLOI_SYNTAX_EXPANSION "syntax_expansion"
#define VSLOI_MIN_ABBREVIATION "minimum_abbreviation"
#define VSLOI_INDENT_CASE_FROM_SWITCH "indent_case"
#define VSLOI_KEYWORD_CASE "wc_keyword"
#define VSLOI_BEGIN_END_COMMENTS "begin_end_comments"
#define VSLOI_INDENT_FIRST_LEVEL "indent_first_level"
#define VSLOI_MULTILINE_IF_EXPANSION "multiline_if_expansion"
#define VSLOI_MAIN_STYLE "main_style"
#define VSLOI_USE_CONTINUATION_INDENT_ON_FUNCTION_PARAMETERS "listalign_fun_call_params"
#define VSLOI_BEGIN_END_STYLE "begin_end_style"
#define VSLOI_PAD_PARENS "sppad_parens"
#define VSLOI_NO_SPACE_BEFORE_PAREN "no_space_before_paren"
#define VSLOI_POINTER_STYLE "pointer_style"
#define VSLOI_FUNCTION_BEGIN_ON_NEW_LINE "function_begin_on_new_line"
#define VSLOI_INSERT_BEGIN_END_IMMEDIATELY "insert_begin_end_immediately"
#define VSLOI_INSERT_BLANK_LINE_BETWEEN_BEGIN_END "insert_blank_line_between_begin_end"
#define VSLOI_QUICK_BRACE "quick_brace"
#define VSLOI_CUDDLE_ELSE "nl_before_else"
#define VSLOI_DELPHI_EXPANSIONS "delphi_expansions"              // pascal
#define VSLOI_TAG_CASE "wc_tag_name"
#define VSLOI_ATTRIBUTE_CASE "wc_attr_name"
#define VSLOI_WORD_VALUE_CASE "wc_attr_word_value"
#define VSLOI_HEX_VALUE_CASE "wc_attr_hex_value"
#define VSLOI_QUOTE_NUMBER_VALUES "quote_attr_number_value"
#define VSLOI_QUOTE_WORD_VALUES "quote_attr_word_value"
#define VSLOI_LOWERCASE_FILENAMES_WHEN_INSERTING_LINKS "lowercase_filenames_when_inserting_links"
#define VSLOI_USE_COLOR_NAMES "use_color_names"
#define VSLOI_USE_DIV_TAGS_FOR_ALIGNMENT "use_div_tags_for_alignment"
#define VSLOI_USE_PATHS_FOR_FILE_ENTRIES "use_paths_for_file_entries"
#define VSLOI_AUTO_VALIDATE_ON_OPEN "auto_validate_on_open"
#define VSLOI_AUTO_WELLFORMEDNESS_ON_OPEN "auto_wellformedness_on_open"
#define VSLOI_AUTO_CORRELATE_START_END_TAGS "auto_correlate_start_end_tags"
#define VSLOI_AUTO_SYMBOL_TRANSLATION "auto_symbol_translation"
#define VSLOI_INSERT_RIGHT_ANGLE_BRACKET "insert_right_angle_bracket"     // deprecated
#define VSLOI_COBOL_SYNTAX "cobol_syntax"                   // cobol only
#define VSLOI_AUTO_INSERT_LABEL "auto_insert_label"              // vhdl only
#define VSLOI_RUBY_STYLE "ruby_style"                     // ruby only

// List of language properties not in VS_LANGUAGE_OPTIONS::m_properties
#define VSLANGPROPNAME_AUTO_LEFT_MARGIN    "auto_left_margin"
#define VSLANGPROPNAME_BOUNDS       "bounds"
#define VSLANGPROPNAME_AUTO_CAPS    "auto_caps"
#define VSLANGPROPNAME_COLOR_FLAGS    "color_flags"
#define VSLANGPROPNAME_FIXED_WIDTH_RIGHT_MARGIN    "fixed_width_right_margin"
#define VSLANGPROPNAME_HEX_MODE    "hex_mode"
#define VSLANGPROPNAME_INDENT_WITH_TABS    "indent_with_tabs"
#define VSLANGPROPNAME_INDENT_STYLE    "indent_style"
#define VSLANGPROPNAME_EVENTTAB_NAME    "eventtab_name"
#define VSLANGPROPNAME_LEXER_NAME    "lexer_name"
#define VSLANGPROPNAME_LINE_NUMBERS_LEN    "line_numbers_len"
#define VSLANGPROPNAME_LINE_NUMBERS_FLAGS    "line_numbers_flags"
#define VSLANGPROPNAME_MARGINS    "margins"
#define VSLANGPROPNAME_MODE_NAME    "mode_name"
#define VSLANGPROPNAME_SHOW_SPECIAL_CHARS_FLAGS    "show_special_chars_flags"
#define VSLANGPROPNAME_SOFT_WRAP    "soft_wrap"
#define VSLANGPROPNAME_SOFT_WRAP_ON_WORD    "soft_wrap_on_word"
#define VSLANGPROPNAME_SPELL_CHECK_WHILE_TYPING    "spell_check_while_typing"
#define VSLANGPROPNAME_SPELL_CHECK_WHILE_TYPING_ELEMENTS "spell_check_while_typing_elements"
#define VSLANGPROPNAME_TABS       "tabs"
#define VSLANGPROPNAME_TRUNCATE_LENGTH    "truncate_length"
#define VSLANGPROPNAME_WORD_CHARS        "word_chars"
#define VSLANGPROPNAME_WORD_WRAP_FLAGS    "word_wrap_flags"

#define VSLANGPROPNAME_CW_FLAGS          "cw_flags"
#define VSLANGPROPNAME_CW_STYLE          "cw_style"
#define VSLANGPROPNAME_CW_LINE_COMMENT_MIN  "cw_line_comment_min"
#define VSLANGPROPNAME_CW_FIXED_WIDTH_SIZE  "cw_fixed_width_size"
#define VSLANGPROPNAME_CW_FIXED_WIDTH_MAX_RIGHT_COLUMN  "cw_fixed_width_max_right_column"
#define VSLANGPROPNAME_CW_FIXED_RIGHT_COLUMN            "cw_fixed_right_column"
#define VSLANGPROPNAME_CW_AUTOMATIC_WIDTH_MAX_RIGHT_COLUMN "cw_automatic_width_max_right_margin"

#define VSLANGPROPNAME_XW_FLAGS          "xw_flags"
#define VSLANGPROPNAME_XW_PROFILE        "xw_profile"

#define VSLANGPROPNAME_BEAUTIFIER_DEFAULT_PROFILE    "beautifier_default_profile"
#define VSLANGPROPNAME_RTE_DEFAULT_PROFILE    "rte_default_profile"
#define VSLANGPROPNAME_RTE_LANG_ENABLED      "rte_lang_enabled"
#define VSLANGPROPNAME_TAB_CYCLES_INDENT    "tab_cycles_indents"
#define VSLANGPROPNAME_BEAUTIFIER_EXPANSION_FLAGS    "beautifier_expansion_flags"
#define VSLANGPROPNAME_CONTEXT_MENU    "context_menu"
#define VSLANGPROPNAME_CONTEXT_MENU_IF_SELECTION    "context_menu_if_selection"

#define VSLANGPROPNAME_INHERITS_FROM    "inherits_from"
#define VSLANGPROPNAME_NUMBERING_STYLE    "numbering_style"
#define VSLANGPROPNAME_REFERENCED_IN_LANGIDS    "referenced_in_langids"
#define VSLANGPROPNAME_BEGIN_END_PAIRS    "begin_end_pairs"
#define VSLANGPROPNAME_SMART_TAB    "smart_tab"
#define VSLANGPROPNAME_ALIAS_FILENAME    "alias_filename"
#define VSLANGPROPNAME_CODE_MARGINS    "code_margins"
#define VSLANGPROPNAME_DIFF_COLUMNS    "diff_columns"
#define VSLANGPROPNAME_ADAPTIVE_FORMATTING_FLAGS    "adaptive_formatting_flags"
#define VSLANGPROPNAME_USE_ADAPTIVE_FORMATTING    "use_adaptive_formatting"
#define VSLANGPROPNAME_SURROUND_FLAGS    "surround_options"
#define VSLANGPROPNAME_CODEHELP_FLAGS    "codehelp_flags"
#define VSLANGPROPNAME_AUTO_COMPLETE_FLAGS    "auto_complete_flags"
#define VSLANGPROPNAME_AUTO_COMPLETE_MIN_LENGTH    "auto_complete_minimum_length"
#define VSLANGPROPNAME_SYMBOL_COLORING_FLAGS    "symbol_coloring_flags"
#define VSLANGPROPNAME_DOC_COMMENT_FLAGS    "doc_comment_flags"
//#define VSLANGPROPNAME_COMMENT_WRAP_OPTIONS    "comment_wrap_options"
#define VSLANGPROPNAME_BACKSPACE_UNINDENTS    "backspace_unindents"
//#define VSLANGPROPNAME_XML_WRAP_OPTIONS    "xml_wrap_options"
#define VSLANGPROPNAME_LOAD_FILE_OPTIONS    "load_file_options"
#define VSLANGPROPNAME_SAVE_FILE_OPTIONS    "save_file_options"
#define VSLANGPROPNAME_REAL_INDENT    "real_indent"
#define VSLANGPROPNAME_AUTO_CASE_KEYWORDS    "auto_case_keywords"
#define VSLANGPROPNAME_COMMENT_EDITING_FLAGS    "comment_editing_flags"
#define VSLANGPROPNAME_COMMENT_BOX_OPTIONS   "comment_box_options"
#define VSLANGPROPNAME_TAG_FILE_LIST         "tag_file_list"
#define VSLANGPROPNAME_TAG_FILE_LIST_ALL     "tag_file_list_all"
#define VSLANGPROPNAME_AUTO_BRACKET_FLAGS    "auto_bracket_flags"
#define VSLANGPROPNAME_AUTO_SURROUND_FLAGS    "auto_surround_flags"
#define VSLANGPROPNAME_EXPAND_ALIAS_ON_SPACE    "expand_alias_on_space"
#define VSLANGPROPNAME_AUTO_COMPLETE_POUND_INCLUDE    "auto_complete_pound_include"
#define VSLANGPROPNAME_SELECTIVE_DISPLAY_FLAGS    "selective_display_flags"
#define VSLANGPROPNAME_SMART_PASTE    "smart_paste"
#define VSLANGPROPNAME_INCLUDE_RE  "include_re"
#define VSLANGPROPNAME_DEBUG_PRINT_FUNCTION  "debug_print_function"
#define VSLANGPROPNAME_SHOW_MINIMAP  "show_minimap"
#define VSLANGPROPNAME_HEX_NOFCOLS  "hex_nofcols"
#define VSLANGPROPNAME_HEX_BYTES_PER_COL  "hex_bytes_per_col"
 ...
 */
VSDEPRECATED void VSAPI vsUpdateExistingBufferExtensionOptions(const char *pszLangId,const char *pszReserved VSDEFAULT(0),int reserved VSDEFAULT(0));
/**
 * Updates all editor control buffers which are using these language
 * options to the newly configured values.
 *
 ...
 * files of the given language.  It looks first in the language specific
 ...
 * @deprecated Use {@link vsLangSetInheritsFrom}.
 */
VSDEPRECATED void VSAPI vsSetDefaultExtensionInheritsFrom(const char *pszExtension,const char *pszInheritFrom);

#define vsSetLanguageInheritsFrom vsLangSetInheritsFrom
/**
 * Allows you to create a language which has it's own set of
 * options, but can inherit support callbacks from another
 * language.
 ...
 * @since 13.0
 */
void VSAPI vsLangSetInheritsFrom(const char *pszLangId,const char *pszParentLangId);
 ...
 */
void VSAPI vsDeleteExtensionOptions(const char *pszExt);

/**
 * Creates a new extension with the given settings.  If the 
 * extension already exists, its settings will be overwritten. 
 * 
 * @param pszExt              new extension 
 * @param pszLangId           langid which extension refers to
 * @param encoding            default encoding of files with 
 *                            this extension
 * @param openApp             path of the outside application to 
 *                            open files of this type
 * @param useFileAssociation  whether to use an outside application 
 * @param ignoreSuffix        ignore this extension (for example test.cpp.bak), 
 *                            you might want to ignore .bak 
 * 
 */
void VSAPI vsCreateExtension(const char *pszExt, 
                             const char *pszLangId = "fundamental",
                             const char *encoding = "", 
                             const char *openApp = "", 
                             bool useFileAssociation = false,
...
/**
 * Creates a new language with the given settings.
 * 
 * @param pszLangId     language id (see {@link p_LangId} 
 * @param pLangOptions  New language specific options.
 *                      Since all options are must be set, use the
 ...
 *                      setting new values.
 */
void VSAPI vsCreateNewLanguage(const char *pszLangId, const VS_LANGUAGE_OPTIONS  *pLangOptions,int version=VS_LANGUAGE_OPTIONS_VERSION);
...
int VSAPI vsSetDefaultFont(int field,const char *pszFontName,
                           int FontSizex10,int FontFlags,int CharSet VSDEFAULT(VSCHARSET_DEFAULT),int reserved=0);
/**
 ...
 */
VSDEPRECATED void VSAPI vsSelectEditMode(int wid,const char *pszLangId VSDEFAULT(0),int reserved VSDEFAULT(0));
/**
 * Sets the language specific information such as tabs, margins,
 * color coding, etc. to the specified language's options.
 *
 ...
 * @categories Tagging_Functions
 */
int VSAPI vsQLocalsSupported(int wid VSDEFAULT(0), VSPSZ lang VSDEFAULT(0));
 ...
 * @categories Edit_Window_Methods, Editor_Control_Methods, Search_Functions
 */
int vsClexSkipBlanks(int wid, VSPSZ options VSDEFAULT(nullptr));
 ...
 *
 */
int VSAPI vsConcurProcessQRunning(const slickedit::SEString &name="");
/**
 * Force terminate the process buffer
 */
void VSAPI vsConcurProcessKill(const slickedit::SEString &name="");
/**
 ...
 *
 */
int VSAPI vsConcurProcessQExited(const slickedit::SEString &name="");
/**
 ...
 *
 */
int VSAPI vsConcurProcessQReadRunning(const slickedit::SEString &name="");
/**
 * @return Processes data in concurrent process buffer and returns non-zero value
 ...
 *
 */
int VSAPI vsConcurProcessQReadExited(const slickedit::SEString &name="");
/**
 * @return Returns concurrent process id name if the 
 * editor control specified has concurrent process.
 *
 * @param wid	Window id of editor control.  0 specifies the
 * current object.
 *
 ...
 *
 */
VSPSZ VSAPI vsConcurProcessName(int wid);
/**
 ...
 *
 */
void VSAPI vsResetIdle(bool isMouseMove=false);
 ...
 *
 */
long VSAPI vsQIdle(bool exclude_mouse_move=false);
...
#define VSBUFMATCH_CASE_INSENSITIVE_PREFIX_MATCHING    0x200
struct VSBUFMATCHINFO {
    int BufID;
    int ModifyFlags;
    int ReadOnly;
    int BufFlags;
    slickedit::SEString BufName;
    slickedit::SEString BufNameNoSymlinks;
    slickedit::SEString DocumentName;
    slickedit::SEString ModeName;
};
...
int VSAPI vsFindModifiedTempName(VSPSZ pszModifiedTempName);
...
#define VSTREE_ADD_AS_FIRST_CHILD    0x40
#define VSTREE_OVERLAY_BITMAP1       0x80
...
#define VSTREENODE_HIDEINDICATOR     0x400
...
#define VSTREE_CAPTION_HTML 0x1
...
#define VSLTF_SKIP_OUT_OF_SCOPE       0x0020   // [DEPRECATED] Skip locals that are out of scope
#define VSLTF_SET_TAG_CONTEXT         0x0040   // Set tagging context at cursor position
#define VSLTF_SET_TAG_MATCHES         0x0080   // [21.0] Insert tags into match set
...
#define VSLTF_REMOVE_FILE             0x80000  // [20.0] Remove the given file from a tag database
#define VSLTF_FIND_SYMBOLS            0x100000 // [21.0] Search for symbols matching a search specification
#define VSLTF_READ_FROM_STRING_IS_ACP 0x200000 // string is active page and not Utf-8
#define VSLTF_NO_SAVE_COMMENTS        0x400000 // [25.0] Do not store documentation comments when tagging
...
#define VS_UPDATEFLAG_test_only     0x0010  // Test if context is up to date only
 ...
 *
 * @param iWID	Window id of tree control.  0 specifies the current object.
 *
 * @param ItemIndex	Specifies a tree item.  The root of the tree
 *          can't be deleted and always has an item index of 0.
 *
 * @param Flags	One or more of the following flags OR'd together:
 *        <dl>
 *        <dt>VSTREE_ADD_BEFORE</dt><dd>Add this item before the item specified.</dd>
 *        <dt>VSTREE_ADD_AS_CHILD</dt><dd>Add this item after last child of
 *            the item specified by <i><b>ItemIndex</b></i>.</dd>
 *        <dt>VSTREE_ADD_SORTED_CS</dt><dd>Add this item sorted case sensitive.</dd>
 *        <dt>VSTREE_ADD_SORTED_CI</dt><dd>Add this item sorted case insensitive.</dd>
 *        <dt>VSTREE_ADD_SORTED_FILENAME</dt><dd>Add this item sorted by filename.</dd>
 *        <dt>VSTREE_OVERLAY_BITMAP1</dt><dd>Treat 'iOverlayBMIndex' as an overlay index.
 *            Otherwise, 'iOverlayBMIndex' is ignored.</dd>
 *        </dl>
 *
 * @param iOverlayBitmapIndex	Names table index to a picture to overlay. 
 *          Ignored if (iFlags & VSTREE_OVERLAY_BITMAP1) == 0.
 *
 * @param iBitmapIndex	Names table index to a picture which
 *          gets displayed to the left of the caption text.
 *
 * @param iShowChildren	Indicates whether to show the children of this node. 
 *          0 specifies not to show the children.  Specify 1 to initially show
 *          children of this node.  Set this to -1 for leaf items.
 *
 * @param iNodeFlags	This is 0 or VSTREENODE_HIDDEN. 
 *          The hidden flag indicates that the new item not  be visible.
 *
 * @param hvarUserInfo  Slick-C variable containing per-node user data.
 *
 * @see vsTreeSetUserInfo
 * @appliesTo Tree_View
 * @categories Tree_View_Methods
 */
int VSAPI vsTreeAddItem(int iWID,
                        int iRelativeIndex,
 ...
 *
 * @return int index of sibling previous to 
 *         <B>iRelativeIndex</B>, or -1
 */
int VSAPI vsTreeGetPrevSiblingIndex(int iWID, int  iRelativeIndex);

/**
 * Finds the prev index of <B>iRelativeIndex</B> ("prev" is the 
 * sibling "up" in the list) .  This will find a non-sibling
 * @param iWID Window ID of tree.  Specify 0 if it is the
 *             current window
 * @param iRelativeIndex Tree node index to find sibling for
 *
 * @return int index previous to <B>iRelativeIndex</B>, or -1.
 */
int VSAPI vsTreeGetPrevIndex(int wid, int iHandle, int iSearchHidden VSDEFAULT(0));
...
/**
 * Sets the caption from node <B>iIndex</B>
 * @param iWID Window ID of tree.  Specify 0 if it is the
 *             current window
 * @param iIndex Tree node index to get caption for
 * @param pszCaption Buffer put in caption 
 * @aparam iFlags 0 or VSTREE_CAPTION_HTML.  Do not use VSTREE_CAPTION_HTML if 
 *                you do not need it, it can affect performance.
 * @return 0 if successful
 */
int VSAPI vsTreeSetCaption(int iWID, int iIndex, VSPSZ pszCaption,int iColIndex=-1,int iFlags=0);
/** 
 * Gets the number of children of node <B>iHandle</B> in the tree control <B>iWID</B>
 * 
 * @param iWID Tree control to count nodes of.
 * @param iHandle Node to count children of.
 * @param iRecursive set to 1 to count recursively.
 * 
 * @return int number of children of node <B>iHandle</B> in the tree control <B>iWID</B>
 */
int VSAPI vsTreeGetNumChildren(int iWID, int iHandle, int iRecursive=0);
 ...
 *  
 * @param iWID Window ID of tree.  Specify 0 if it is the current window
 * @param iIndex Tree node index to set info for
 * @param iState >-1, set the expansion state for this node
 * @param iIgnoredBitmapIndex (unused) Bitmap index
 * @param iBitmapIndex Bitmap index for node
 ...
 * @param pBitmapsArray- Array of picture indexes to add as overlays
 * @param iNumBitmaps - number of items in pBitmapsArray
 *
 * @return 0 if successful
 */
int VSAPI vsTreeSetInfo(int iWID,
                        int iIndex,
                        int iState,
                        int iIgnoredBitmapIndex=-1,
                        int iBitmapIndex=-1,
                        int iFlags=-1,
                        int iSetNewCurrentNodeIfHidden=1,
                        int iMask=-1,
                        int *pBitmapsArray=nullptr, int iNumBitmaps=0);
 ...
 *                     VSTREENODE_*
 * @param pBitmapsArray - (output) Array of picture indexes
 * @param piNumBitmaps - (output) number of items in pBitmapsArray
 * @param iMaxBitmaps - number of items allocated to pBitmapsArray
 *
 * @return 0 if successful
 */
int VSAPI vsTreeGetInfo(int iWID,int iIndex,int *piState=0,
                        ...
                        int *pBitmapsArray=nullptr, int *piNumBitmaps=nullptr, int iMaxBitmaps=0);
 ...
 * @param iWID Window ID of tree.  Specify 0 if it is the current window
 * @param iIndex Tree node index to set info for
 * @param iMask        flag mask for returned flags, bitset of VSTREENODE_*
 */
int VSAPI vsTreeGetCurFlags(int iWID,int iIndex,int iMask=-1);
 ...
 *     <LI>VSTREENODE_GRAYTEXT - Show text as disabled</LI>
 * </UL>
 * @param iSetNewCurrentNodeIfHidden   Set the first visible node. 
 *          If setting info for many node indexes in a loop, it is better
 *          for performance to save this until it is necessary
 * @param iMask  bitset of VSTREENODE_* for which flags to set or reset.
 *
 * @return 0 if successful
 */
int VSAPI vsTreeSetCurFlags(int iWID,
                            int iIndex,
                            int iFlags=-1,
                            int iSetNewCurrentNodeIfHidden=1,
                            int iMask=-1);
...
/**
 * Depth of node <B>iIndex</B>
 * 
 * @param iWID Window ID of the treeview control
 * @param iIndex index to get depth of 
 * 
 * @return int depth of <B>iIndex</B>
 */
int vsTreeGetDepth(int wid, int iIndex);

void VSAPI vsTreeSetDateTime(int iWID, int iHandle, int iColumn,
                             int iYear, int iMonth, int iDay,
                             int iHour VSDEFAULT(-1), int iMinute VSDEFAULT(-1),
                             int iSecond VSDEFAULT(0), int iMS VSDEFAULT(0));

/**
 * Set external data model for tree.  This is so you can use a 
 * paint delegate to draw your own data.  Caller is responsible 
 * for making sure there are enough items in the tree to draw 
 * the data. 
 * 
 * @param iWID Window ID of the tree control
 * @param pExternalDataModel pointer to data
 */
void VSAPI vsTreeSetExternalModel(int iWID, void *pExternalDataModel);

/**
 * Get external data model for tree.  This is so you can use a 
 * paint delegate to draw your own data.  Caller is responsible 
 * for making sure there are enough items in the tree to draw 
 * the data. 
 * 
 ...
 */
void* VSAPI vsTreeGetExternalModel();

/**
 * Set color of a tree node
 * 
 * @param iWID - Window ID of tree
 * @param iHandle - nodeIndex Index to set the color for
 * @param iCol - Column (0..N-1) to set the color for
 * @param iFGColor - FGColor RGB color for text in this cell
 * @param iBGColor - BGColor RGB color for background in this 
 *                 cell
 * @param iFlags - Combination of font flags. Currently only 
 ...
 */
int VSAPI vsTreeSetColor(int iWID, int iHandle, int iCol, int iFGColor, int iBGColor, int iFlags);
/**
 * Set overlay bitmaps for the given tree node.
 * 
 * @param iWID - Window ID of tree
 * @param iHandle - nodeIndex Index to set the color for
 * @param pBitmapsArray- Array of picture indexes to add
 * @param iNumBitmaps - number of items in pBitmapsArray
 * 
 * @return int 0 if sucessful
 */
int VSAPI vsTreeSetOverlayBitmaps(int iWID,int iHandle, int *pBitmapsArray, int iNumBitmaps);
/**
 * Get overlay bitmaps for the given tree node.
 * 
 * @param iWID - Window ID of tree
 * @param iHandle - nodeIndex Index to set the color for
 * @param pBitmapsArray - (output) Array of picture indexes
 ...
 * @param iMaxBitmaps - number of items allocated to pBitmapsArray
 * 
 * @return number of bitmaps &gt;= 0 if successful
 */
int VSAPI vsTreeGetOverlayBitmaps(int iWID,int iHandle, int *pBitmapsArray, int *piNumBitmaps, int iMaxBitmaps);
/**
 ...
 * the selection).
 * @param RestoreScrollPos  When true, scroll information stored
 *                          in the selection is applied.
 * @param beginEndPivot    When true, go to end to start pivot
 *                         of selection.
 *
 ...
 *
 */
int VSAPI vsBeginSelect(int wid,int markid=-1,int LockSelection=1,int RestoreScrollPos=1,int beginEndPivot=0);
/**
 ...
 * @param markid
 * @param LockSelection
 *               If this is 1, the selection is "locked" (moving
 *               the cursor will no longer remove or extend
 *               the selection).
 * @param RestoreScrollPos  When true, scroll information stored
 *                          in the selection is applied.
 * @param beginEndPivot    When true, go to end opposit to 
 *                         pivot.
 * 
 * @return Returns 0 if successful.  Possible return codes are
 *         PROPERTY_OR_METHOD_NOT_ALLOWED_RC,
 ...
 * @see vsBeginSelect
 */
int VSAPI vsEndSelect(int wid,int markid=-1,int LockSelection=1,int RestoreScrollPos=1,int beginEndPivot=0);
/**
 ...
 *  
 *  @deprecated This function is obsolete, as of 22.0.0
 */
 ...
 * modal wait state.  This callback is necessary if you are using 
...
/**
 * <pre>int (VSAPI * vspfnTruncateLengthCustom)(char * line, int line_len, int trunc_col);</pre> 
 * <p>
 * The Custom Truncate Length callback is used to provide a custom calculation for the 
 * truncation line length for lines in a file.  It is called on a per line basis, and 
 * can be used to acommodate supporting Unicode with the truncation line length 
 * feature. 
 * 
 * @param line        The line. 
 * @param line_len    Total number of bytes in line.
 * @param trunc_col   The user setting in SlickEdit for truncation line length.
 *  
 * @return int        The calculated line truncation value. 
 *  
 * @categories Editor_Control_Callback_Functions
 *
 */
VSCALLBACK_BUF_TRUNCATE_LENGTH_CUSTOM=46,
/** 
 * <pre>void *(VSAPI *vspfnGitBranchesGetInstance)();</pre>
 * <p>
 * Used to get an instance of a singleton object for of a branch model for a
 * repository browser.
 *  
 * @return void *    pointer to branch model used for a repository browser.
 */
VSCALLBACK_APP_VC_BRANCHES_INFO_GET_INSTANCE = 47,
/**
 * <pre>void (VSAPI *vspfnVCBranchesSetTimer)(slickedit::SEString path, slickedit::SEString gitPath, int iWID)</pre>;
 * <p>
 * Used to set a timer to refresh the window in a repository browser.
 * @param path path that is being queried.
 * @param gitPath absolute path of version control executable.
 * @param iWID window ID of the tree control in the repository browser.
 */
VSCALLBACK_APP_VC_BRANCHES_INFO_SET_TIMER = 48,
/**
 * <pre>int(VSAPI *vspfnVCGetNumItems)(void *pBranchModel)</pre> 
 * <p> 
 * Gets the number of items in a branch model 
 * @param pBranchModel Pointer to a branch model object
 * @return number of items in pBranchModel
 */
VSCALLBACK_APP_VC_BRANCHES_INFO_GET_NUM_ITEMS = 49,
/**
 * <pre>void *(VSAPI *vspfnVCGetItem)(void *pBranchModel,int iItemNumber)</pre>
 * <p> 
 * Gets an item from the branch model. 
 * @param pBranchModel Pointer to a branch model object 
 * @param iItemNumber ID of item to get from branch model 
 * @return pointer to a branch model item 
 */
VSCALLBACK_APP_VC_BRANCHES_INFO_GET_ITEM = 50,
/**
 * <pre>void(VSAPI *vspfnVCGetPaths)(void *pBranchModel,slickedit::SEString &path, slickedit::SEString &gitPath)</pre> 
 * <p>
 * Get source path and and path to verssion control executable. 
 * @param path Gets the soruce path referenced by pBranchModel. 
 * @param gitPath Gets the absolute path of version control executable 
 */
VSCALLBACK_APP_VC_BRANCHES_INFO_GET_PATHS = 51,
/**
 * <pre> int(VSAPI *vspfnVCFindKey)(void *pBranchModel, slickedit::SEString hash)</pre> 
 * <p> 
 * Find out of the commit represented by <B>hash</B> is the endpoint of the branch. 
 * @param pBranchModel Pointer to a branch model object 
 * @param hash revision string for the commit. 
 */
VSCALLBACK_APP_VC_BRANCHES_INFO_FIND_KEY = 52,

/**
 * <pre> int(VSAPI *vspfnVCBranchesInfoBranchEndHash)(void *pBranchModel, slickedit::SEString &hash)</pre> 
 * <p> 
 * Find <B>hash</B> is the endpoint of the current branch. 
 * @param pBranchModel Pointer to a branch model object 
 * @param hash gets the hash of teh current. 
 */
VSCALLBACK_APP_VC_BRANCHES_INFO_BRANCH_END_HASH = 53,

/**
 * <pre> int(VSAPI *vspfnVCGetFilteredRowNumber)(void *pBranchModel, int)</pre> 
 * <p> 
 * Returns actual row number when there are filtered rows.
 * @param pBranchModel Pointer to a branch model object 
 * @param "Real" row we're looking for a mapped number to.
 */
VSCALLBACK_APP_VC_GET_FILTERED_ROW_NUMBER = 54
};
...
/** 
 * Determines whehter closing the application should be ignored.
 *  
 * @return Returns false if an attemp to close the application 
 * should be ignored. 
 * 
 * @return bool 
 */
int VSAPI vsAllowExit();
/**
 ...
 * conjuction with <b>vsIsWindowValid</b> to traverse all 
 * SlickEdit objects. 
 *
 * @example
 * <pre>
 ...
 * @categories Form_Methods
 */
int VSAPI vsFindFormObject(VSPSZ pszName, VSPSZ pszOptions VSDEFAULT(nullptr));
 ...
 * of an object.
 *
 * @param pszName       is a string in the format:
 ...
 * @categories Form_Methods
 */
int VSAPI vsFindObject(VSPSZ pszName, VSPSZ pszOptions VSDEFAULT(nullptr));
...
#define VSCFG_UNICODE_DIFF_EDITOR_WINDOW (-12)
#define VSCFG_SBCS_DBCS_MINIMAP_WINDOW (-13)
#define VSCFG_UNICODE_MINIMAP_WINDOW (-14)
...
#define VSCFG_UNKNOWN_TAG                33
#define VSCFG_UNKNOWNXMLELEMENT          VSCFG_UNKNOWN_TAG
...
#define VSCFG_IDENTIFIER2                56
#define VSCFG_FLOATING_NUMBER            57
#define VSCFG_HEX_NUMBER                 58
#define VSCFG_SINGLEQUOTED_STRING        59
#define VSCFG_BACKQUOTED_STRING          60
#define VSCFG_UNTERMINATED_STRING        61
#define VSCFG_INACTIVE_CODE              62
#define VSCFG_INACTIVE_KEYWORD           63
#define VSCFG_IMAGINARY_SPACE            64
#define VSCFG_INACTIVE_COMMENT           65
#define VSCFG_MODIFIED_ITEM              66
#define VSCFG_NAVHINT                    67
#define VSCFG_XML_CHARACTER_REF          68
#define VSCFG_SEARCH_RESULT_TRUNCATED    69
#define VSCFG_MARKDOWN_HEADER            70
#define VSCFG_MARKDOWN_CODE              71
#define VSCFG_MARKDOWN_BLOCKQUOTE        72
#define VSCFG_MARKDOWN_LINK              73
#define VSCFG_MARKDOWN_LINK2             74
#define VSCFG_MARKDOWN_BULLET            75
#define VSCFG_MARKDOWN_EMPHASIS          76
#define VSCFG_MARKDOWN_EMPHASIS2         77
#define VSCFG_MARKDOWN_EMPHASIS3         78
#define VSCFG_CSS_ELEMENT                79
#define VSCFG_CSS_CLASS                  80
//#define VSCFG_CSS_PROPERTY_VALUE         VSCFG_LIBRARY_SYMBOL
#define VSCFG_CSS_PROPERTY               81
#define VSCFG_CSS_SELECTOR               82
#define VSCFG_DOCUMENT_TAB_ACTIVE        83
#define VSCFG_DOCUMENT_TAB_SELECTED      84
#define VSCFG_DOCUMENT_TAB_UNSELECTED    85
#define VSCFG_SELECTIVE_DISPLAY_LINE     86
#define VSCFG_TAG                        87
#define VSCFG_UNKNOWN_ATTRIBUTE          88
#define VSCFG_REF_HIGHLIGHT_0            89
#define VSCFG_REF_HIGHLIGHT_1            90
#define VSCFG_REF_HIGHLIGHT_2            91
#define VSCFG_REF_HIGHLIGHT_3            92
#define VSCFG_REF_HIGHLIGHT_4            93
#define VSCFG_REF_HIGHLIGHT_5            94
#define VSCFG_REF_HIGHLIGHT_6            95
#define VSCFG_REF_HIGHLIGHT_7            96
#define VSCFG_MINIMAP_DIVIDER            97

#define VSCFG_YAML_TEXT_COLON            98 
#define VSCFG_YAML_TEXT                  99 
#define VSCFG_YAML_TAG                   100
#define VSCFG_YAML_DIRECTIVE             101
#define VSCFG_YAML_ANCHOR_DEF            102
#define VSCFG_YAML_ANCHOR_REF            103
#define VSCFG_YAML_PUNCTUATION           104
#define VSCFG_YAML_OPERATOR              105
#define VSCFG_MARKDOWN_EMPHASIS4         106

#define VSCFG_FIRST_COLOR                 1
#define VSCFG_LAST_COLOR                 106
...
#define VSFONTFLAG_USE_SCALABLE_FONT          0x4000
#define VSFONTFLAG_NO_COLOR_BLENDING          0x8000
...
/**
 * Set default colors to profile specified 
 *  
 * @param pszProfileName
 * @param optionLevel
 */
void VSAPI vsSetDefaultColorsFromProfile(VSPSZ pszProfileName, int optionLevel=0);

/**
 * Set default fonts to misc.fonts
 *  
 * @param pszProfileName   Not supported yet. Must be NULL
 * @param optionLevel
 */
void VSAPI vsSetDefaultFontsFromProfile(VSPSZ pszProfileName=0, int optionLevel = 0,int reserved=0);
/**
 * Gets rgb color values (always in Windows format) and font style flag
 * for the <i><b>cfgfield</b></i> specified.
 *
...
int VSAPI vsGetDefaultColor(int cfgfield,
                            ...
                            int *pFontFlag VSDEFAULT(nullptr),
                            int *pcfgParentColor VSDEFAULT(nullptr));
 ...
 * 	Editor control display translation table. MaxResult should be set to
 * VSSPECIALCHAR_MAX.   Each character corresponds to one of the
 * VSSPECIALCHAR_??? constants.</dd>
 * </dl>
 *
...
// Do not store documentation comments when tagging
#define VSCODEHELPFLAG_NO_COMMENT_TAGGING 0x80000000000
 ...
 * mode.</dd>
 *
 * <dt>VSOPTION_APP_THEME</dt><dd>
 * 	Theme used by application. One of VSAPPTHEME_*.</dd>
 * </dl>
 *
 * <dt>VSOPTION_MAX_DELTA_SIZE_IN_K</dt><dd>
 *  Approximate maximium size in k of a delta
 *  in backup history before it is written to
 *  a separate file.</dd>
 * </dl>
 *
 * @see vsGetDefaultFont
...
#define  VSBDS_FIXED_SINGLE  1
    ...
    * which contains the editor control window.  Otherwise, 
...
int VSAPI vsX11_UseExistingInstance(int processId,const char * commandLine);
   #if 0
 ...
 * @categories File_Functions
 */
void VSAPI vsDropFiles(slickedit::SEArray<slickedit::SEString> dropFiles, int atWid=0,int mouseWid=0);

enum vsDockAreaFlag {
   VSDOCKAREA_LEFT   = 0x1,
   VSDOCKAREA_TOP    = 0x2,
   VSDOCKAREA_RIGHT  = 0x4,
   VSDOCKAREA_BOTTOM = 0x8,

   VSDOCKAREA_NONE   = 0
};

enum vsRestorePosition {
   LastPosition  = 0,  // Last known postion
   Docked        = 1,  // Docked inside main window
   Floating      = 2   // Floating outside main window
};

enum vsDockAreaPos {
   VSDOCKAREAPOS_NONE   = 0,
   VSDOCKAREAPOS_LEFT,
   VSDOCKAREAPOS_TOP,
   VSDOCKAREAPOS_RIGHT,
   VSDOCKAREAPOS_BOTTOM,
   VSDOCKAREAPOS_COUNT,

   VSDOCKAREAPOS_FIRST = VSDOCKAREAPOS_LEFT,
   VSDOCKAREAPOS_LAST = VSDOCKAREAPOS_BOTTOM,
};
 ...
 * must be called by OEM's who implement our MDI API so 
 * SlickEdit knows at all times which edit window is active. 
 * This function is called during the Windows WM_ACTIVATE 
 * message or 
 ...
 * tabgroup. Set <code>insertAfter=true</code> to create 
 * tabgroup after current tabgroup. Set <code>edge=true</code> 
 * and <code>insertAfter=false</code> to create tabgroup along 
 * top edge of mdi-area. Set <code>edge=true</code> 
 * and <code>insertAfter=true</code> to create tabgroup along 
 * bottom edge of mdi-area. 
 *
 * @param wid
 * @param insertAfter
 * @param edge
 */
void VSAPI vsMDIChildNewHorizontalTabGroup(int wid, int insertAfter, int edge);
 ...
 * tabgroup after current tabgroup. Set <code>edge=true</code> 
 * and <code>insertAfter=false</code> to create tabgroup along 
 * left edge of mdi-area. Set <code>edge=true</code> 
 * and <code>insertAfter=true</code> to create tabgroup along 
 * right edge of mdi-area. 
 *
 * @param wid
 * @param insertAfter
 * @param edge
 */
void VSAPI vsMDIChildNewVerticalTabGroup(int wid, int insertAfter, int edge);
...
/**
 * Return window id most recently active floating (non-main) MDI
 * window 
 *  
 *  
 * @return Return window id of most recently active floating 
 *         (non-main) MDI window. May return 0.
 */
int VSAPI vsMDICurrentFloating();
/**
 ...
 * @categories Form_Methods
 */
int VSAPI vsMDIFindFormObject(int mdi_wid, VSPSZ pszName, VSPSZ pszOptions = "N");
...
/**
 * Used for traversing multiple cursors/selections.
 *  
 * @param wid
 * @param findFirst  Set to non-zero first to start with first 
 *                   cursor/selection.
 * 
 * @return  Returns true if there is another cursor/selection 
 *          and activates that cursor/selection.
 */
bool VSAPI vsMultiCursorNext(int wid, int findFirst);

/**
 * Adds a new cursor/selection. Puts the window in multi-cursor 
 * mode. 
 *  
 * @param wid
 */
void VSAPI vsMultiCursorAdd(int wid);
/**
 * Determines if the window is in multi-cursor mode. 
 *  
 * @param wid
 * 
 * @return Returns true if the window is in multi-cursor mode.
 */
bool VSAPI vsMultiCursor(int wid);
/**
 * Returns number of multiple cursors 
 *  
 * @param wid
 * 
 * @return Returns number of multiple cursors
 */
size_t VSAPI vsMultiCursorCount(int wid);

/**
 * Returns true if on last loop iteration of multi cursor loop 
 * or not in multi cursor loop.
 *  
 * @param wid
 * 
 * @return Returns true if on last loop iteration of multi cursor loop 
 * or not in multi cursor loop. Otherwise, false is returned.
 */
bool VSAPI vsMultiCursorLastLoopIteration(int wid);

/**
 * Returns true if on first loop iteration of multi cursor loop
 *  
 * @param wid
 * 
 * @return Returns true if on first loop iteration of multi 
 * cursor loop. Otherwise, false is returned. 
 */
bool VSAPI vsMultiCursorFirstLoopIteration(int wid);


/**
 * Returns true if on active loop iteration of multi cursor loop
 * or not in multi cursor loop. 
 *  
 * NOTE: The active cursor is the one that the editor will 
 * scroll in view. There can only be one active cursor. 
 *  
 * @param wid
 * 
 * @return Returns true if on active loop iteration of multi
 * cursor loop or not in multi cursor loop. Otherwise, false is 
 * returned. 
 */
bool VSAPI vsMultiCursorActiveLoopIteration(int wid);

/**
 * Remove multiple cursors/selections from the current 
 * buffer
 *  
 * @param wid
 * 
 */
void VSAPI vsMultiCursorClearAll(int wid);
/**
 * If a buffer other than the buffer specified has multiple 
 * cursors/selections, clear them.
 *  
 * @param wid
 * 
 */
void VSAPI vsMultiCursorClearAllIfOtherBuffer(int wid);
/**
 * Determines if there is multiple cursor/selection loop that 
 * was started by vsMultiCursorNext() 
 *  
 * @param wid
 *  
 * @return Returns true if there is a multiple cursor/selection 
 *         loop that was started by vsMultiCursorNext().
 */
bool VSAPI vsMultiCursorAlreadyLooping(int wid);

/**
 * Cancel multiple cursor/selection loop started by
 * vsMultiCursorNext()
 * 
 * @param wid
 */
void VSAPI vsMultiCursorLoopDone(int wid);
/**
 * Merge overlapping multiple selections
 *  
 * @param wid
 *  
 */
void VSAPI vsMultiCursorMergeOverlap(int wid);

/**
 * Add character selections based on the active selection.
 *  
 * <p>One character selection is added per line. Selections 
 * created do not include virtual space. No selection is created
 * if it is empty. 
 *  
 * @param wid
 *  
 */
int VSAPI vsMultiCursorAddFromActiveSelection(int wid);
 ...
 * @param state   'N','F','M'
 */
void VSAPI vsSetPendingWindowState(int wid, VSPSZ state);
/**
 * Retrieves language property XML
 *  
 * @param pszLangId  Language id 
 * @param pszPropertyName   Name of property
 * @param pApply     If non-null, set to property "apply" 
 *                   setting. Set to true if apply attribute is
 *                   not present.
 * 
 * @return Returns XMLCFG tree handle if successful. Otherwise a 
 *         negative error code is returned.
 */
int VSAPI vsLangGetPropertyXml(VSPSZ pszLangId, VSPSZ pszPropertyName, bool *pApply=0);

void VSAPI vsLangSetPropertyXml(VSPSZ pszLangId, VSPSZ pszName, int iHandle, bool *pApply=0);

/**
 * Called on MDI move event
 * 
 * @param mdi_wid Window id
 */
void VSAPI vsMDIMoved(int mdi_wid);
EXTERN_C_END

VSDLLEXPORT slickedit::SEString vsLangOptionsGetProperty(const VS_LANGUAGE_OPTIONS *pLangOptions, const slickedit::SEString &propertName, const slickedit::SEString &defaultValue=(char *)0, bool *pApply=0);
VSDLLEXPORT slickedit::SEString vsLangGetProperty(VSPSZ pszLangId, VSPSZ pszPropertyName,VSPSZ pszDefaultValue=0, bool *pApply=0);

VSDLLEXPORT slickedit::SEString vsLangGetIdentifierChars(const char *pszLangId); 
VSDLLEXPORT slickedit::SEString vsUTF8GetEncodingName(int encoding);
...
typedef struct {
   ...
   */
    ...
    */
   void (VSAPI *pfnCmdLineRegisterAlert)(VSPSZ alertGroupID);
   /*
	  Unregisters an alert in the alert field of the status area.
    */
   void (VSAPI *pfnCmdLineUnregisterAlert)(VSPSZ alertGroupID);
   /*
	  Activates an alert in the alert field of the status area.
	*/
   void (VSAPI *pfnCmdLineActivateAlert)(VSPSZ alertGroupID, VSPSZ alertID, const char* msg, const char* header, int showToast);
   /*
	  Deactivates an alert in the alert field of the status area.
	*/
   void (VSAPI *pfnCmdLineDeactivateAlert)(VSPSZ alertGroupID, VSPSZ alertID, const char* msg, const char* header, int showToast);
   /*
	  Clears the last active alert for an alert group.
	*/
   void (VSAPI *pfnCmdLineClearLastAlert)(VSPSZ alertGroupID, VSPSZ alertID);
   /*
	  Sets the status for an alert group
	*/
   void (VSAPI *pfnCmdLineSetAlertGroupStatus)(VSPSZ alertGroupID, int enabled, int showPopups);
   /*
	   Sets the status for an alert
	*/
   void (VSAPI *pfnCmdLineSetAlertStatus)(VSPSZ alertGroupID, VSPSZ alertID, int enabled, int showPopups);
   /*
	  Returns info about an alert group
	*/
   void (VSAPI *pfnCmdLineGetAlertGroup)(VSPSZ alertGroupID, VSHREFVAR alertGroup);
   /*
	  Returns info about an alert
	*/
   void (VSAPI *pfnCmdLineGetAlert)(VSPSZ alertGroupID, VSPSZ alertID, VSHREFVAR alert);
   /*
	  Sets info about an alert
	*/
   void (VSAPI *pfnCmdLineSetAlert)(VSPSZ alertGroupID, VSPSZ alertID, VSHREFVAR alert);
   void (VSAPI *pfnjunk4)();
   void (VSAPI *pfnjunk5)();
   void (VSAPI *pfnjunk6)();
   void (VSAPI *pfnjunk7)();
...
#define VSAPIFLAG_SLICKEDIT                                0x80000000
...
*/
   ...
   */
   ...
   /**
    * Register window <code>wid</code> as a tool-window. Return 0
    * on success, < 0 on error. 
    *
    * <p>
    *
    * Set <code>flags</code> to one or more of vsToolWindowFlag. 
    *
    * <p>
    *
    * Set <code>preferredArea</code> to one of vsDockAreaPos. In 
    * the absence of saved docking information, this area will be 
    ...
    * @return int
    */
   int (VSAPI * pfnMDIToolWindowRegister)(int wid, int flags, int preferredArea);
    ...
    * <p>
    *
    * Return the list of Slick-C tool-window window-ids, registered
    * with <code>pfnMDIToolWindowRegister</code>, into the Slick-C 
    * array of <code>wids</code>. Set <code>mdi_wid</code> to a 
    * specific mdi-window to only return tool-windows for that 
    * mdi-window. Set <code>mdi_wid=0</code> to return all 
    * tool-windows (even those that are not part of a layout). 
    *
    * @param wids
    * @param mdi_wid 
    */
   void (VSAPI * pfnMDIGetRegisteredToolWindows)(VSHREFVAR wids, int mdi_wid);

   /**
    * Add tool-window <code>wid</code>. Set <code>mdi_wid</code> to 
    * add to specific mdi-window; set to 0 for current mdi-window. 
    * Tool-window is placed into current tabgroup. Return 0 on 
    * success, < 0 on error. 
    *
    * <p>
    *
    * Set <code>dFlags</code> to one or more of 
    * vsToolWindowDockingFlag. 
    *
    * @param mdi_wid 
    * @param wid
    * @param dFlags
    ...
    * @return int
    */
   int (VSAPI * pfnMDIToolWindowAdd)(int mdi_wid, int wid, int dFlags);
    ...
    * @param wid
    */
   void (VSAPI * pfnMDIToolWindowRemove)(int wid);

   /**
    * Create a new horizontal or vertical tile from tool-window 
    * specified by <code>wid</code>. If tool-window is already part 
    * of a tile, then it is removed and inserted into new tile. Set 
    * <code>mdi_wid</code> to add new tile to specific mdi-window; 
    * set to 0 for current mdi-window. Return 0 on success, < 0 on 
    * error. 
    *
    * <p>
    *
    * If <code>vertical</code> is true, then a vertical tile is
    * created, otherwise a horizontal tile is created. A vertical 
    * tile spans from top-to-bottom and is width-adjustable with a 
    * separator that runs vertically. A horizontal tile spans from
    * left-to-right and is height-adjustable with a separator that 
    * runs horizontally. 
    *
    * <p>
    *
    * Tool-window is inserted as first tab of a new tabgroup by 
    * default unless registered with TWF_NO_TABLINK flag. 
    *
    * <p>
    *
    * Set <code>dFlags</code> to one or more of 
    * vsToolWindowDockingFlag. 
    * <dl>
    * <dt>TWD_INSERTAFTER<dt> <dd>Create tile after current 
    * tile.</dd> 
    * <dt>TWD_EDGE</dt> <dd>Create tile along left/top edge of 
    * main-area.</dd> 
    * <dt>TWD_EDGE | TWD_INSERTAFTER</dt> <dd>Create tile along 
    * right/bottom edge of main-area.</dd> 
    * </dl>
    *
    * @pram mdi_wid 
    * @param wid
    ...
    * @return int
    */
   int (VSAPI * pfnMDIToolWindowNewTile)(int mdi_wid, int wid, bool vertical, int dFlags);

   /**
    * Set tool-window specified by <code>wid</code> active. If 
    * tool-window is part of a tabgroup, then the tab is set 
    * current. 
    * 
    * @param wid 
    */
   void (VSAPI * pfnMDIToolWindowSetActive)(int wid);

   /**
    * Destroy MDI tool-window from window handle <code>wid</code>. 
    * Set <code>noRestore=true</code> if you do not want the layout 
    * to remember the position of the tool-window. Otherwise you 
    * can call <code>pfnMDIToolWindowRestore</code> later to 
    * restore the tool-window to the remembered position. 
    *
    * @param wid
    * @param noRestore 
    */
   void (VSAPI * pfnMDIDestroyToolWindow)(int wid, bool noRestore);
    ...
    * @param wid 
    */
   void (VSAPI *pfnMDIToolWindowFloat)(int wid);

   /**
    * Restore tool-window <code>wid</code> to 
    * <code>position</code>. 
    *  
    * @param wid 
    * @param position 
    */
   void (VSAPI *pfnMDIToolWindowRestore)(int wid, vsRestorePosition position);
    ...
    * @return bool
    */
   bool (VSAPI *pfnMDIToolWindowIsFloating)(int wid);
    ...
    *         otherwise.
    */
   int (VSAPI * pfnMDINextToolWindow)(int wid, char option_letter, bool move_or_close);
    ...
    */
   int (VSAPI * pfnMDICurrentToolWindow)(int mdi_wid);
    ...
    * 
    * @param form_name 
    * @param position   vsRestorePosition
    * @param info       Slick-C ToolWindowRestoreInfo
    */
   void (VSAPI * pfnMDIGetToolWindowRestoreInfo)(VSPSZ form_name, int position, VSHREFVAR info);
    ...
    */
   int (VSAPI * pfnMDIWindowHasMdiArea)(int wid);
    ...
    */
   vsDockAreaPos (VSAPI * pfnMDIToolWindowDockArea)(int wid);
    ...
    * <p>
    *
    * Flag is one of vsToolWindowFlag. 
    *
    * @param wid 
    * @param f 
    *
    * @return bool
    */
   bool (VSAPI * pfnMDIToolWindowTestFlag)(int wid, int f);
    ...
    * @param v 
    */
   void (VSAPI * pfnMDIToolWindowSetFlag)(int wid, int f, bool v);
    ...
    * @param hideGroup 
    */
   void (VSAPI * pfnMDIToolWindowAutoHide)(int wid, bool hideGroup);
    ...
    * @param wid 
    */
   void (VSAPI * pfnMDIToolWindowAutoRaise)(int wid);
    ...
    * @param wid 
    */
   void (VSAPI * pfnMDIToolWindowAutoLower)(int wid);
    ...
    * <code>pfnMDIToolWindowIsAutoRaised</code>. 
    * <code>to_mdi_wid</code> specifies which mdi window to test. 
    * Set it to 0 to test all mdi windows. 
    * 
    * @param wid 
    * @param to_mdi_wid 
    *
    * @return true if window is an auto-hide window.
    */
   bool (VSAPI * pfnMDIToolWindowIsAuto)(int wid, int to_mdi_wid);
    ...
    * @param to_mdi_wid 
    *
    * @return true if window is raised.
    */
   bool (VSAPI * pfnMDIToolWindowIsAutoRaised)(int wid, int to_mdi_wid);
    ...
    * @param restoreGroup 
    */
   void (VSAPI * pfnMDIToolWindowAutoRestore)(int wid, bool restoreGroup);

   /**
    * Retrieves dock-channel info for MDI window 
    * <code>mdi_wid</code> in <code>area</code>. Results are stored 
    * in <code>info</code>. 
    *
    * @param mdi_wid  Window id of MDI frame window.
    * @param area     Indicates which docking side. May be one of 
    *                 the following:
    *                 
    *                 <ul>
    *                 <li>VSDOCKAREAPOS_LEFT</li>
    *                 <li>VSDOCKAREAPOS_TOP</li>
    *                 <li>VSDOCKAREAPOS_RIGHT</li>
    *                 <li>VSDOCKAREAPOS_BOTTOM</li>
    *                 </ul>
    * @param info     (out) Slick-C DockChannelInfo.
    */
   void (VSAPI * pfnMDIDockChannelGetInfo)(int mdi_wid, vsDockAreaPos area, VSHREFVAR info);

   /**
    * Clear dock-channel in <code>area</code> from MDI window 
    * <code>mdi_wid</code>. This will remove all tabs and hide the 
    * dock-channel. 
    *
    * @param mdi_wid  Window id of MDI frame window.
    * @param area     Indicates which docking side.  May be one of the
    *                 following:
    *                 
    *                 <ul>
    *                 <li>VSDOCKAREAPOS_LEFT</li>
    ...
    *                 </ul>
    */
   void (VSAPI * pfnMDIDockChannelClear)(int mdi_wid, vsDockAreaPos area);
...
#define VSMDITILE_TILE       0x8
...
#if VSMACOSX
   void (VSAPI *pfnMDIMacSetFastScroll)(int wid, bool onoff);
#endif
   ...
   */
    ...
    *                 tab group after wid.
    * @param edge     Set to true to create tabgroup along edge of 
    *                 MDI area.
    */
   void (VSAPI * pfnMDIChildNewTabGroup)(int wid, bool vertical, bool insertAfter, bool edge);
    ...
    * <p>
    *
    * Save layout state for specified mdi-window 
    * <code>mdi_wid</code> and return as encoded string. The format 
    * of this string is user-implementation specific. Specify which 
    * areas to restore by setting <code>areas</code> to one or more
    * vsWindowLayoutArea flags. 
    *
    * @param mdi_wid 
    * @param areas 
    * 
    ...
    */
   slickedit::SEString (VSAPI * pfnMDIWindowSaveLayout)(int mdi_wid, int areas);
    ...
    * <p>
    *
    * Restore windows from Slick-C array <code>wids</code> into 
    * specified mdi window <code>mdi_wid</code> using layout 
    * <code>state</code> returned from 
    * <code>pfnMDIWindowSaveLayout</code>. The format of this 
    * string is user-implementation specific. Specify which areas 
    * to restore by setting <code>areas</code> to one or more 
    * vsWindowLayoutArea flags. Set optional <code>flags</code> to 
    * one or more vsRestoreStateFlag. 
    * 
    * @param mdi_wid 
    * @param state 
    * @param areas 
    * @param flags 
    * @param wids Slick-C array of window ids, <code>int wids[]</code>
    *
    * @return true on success.
    */
   bool (VSAPI * pfnMDIWindowRestoreLayout)(int mdi_wid, const slickedit::SEString& state, int areas, int flags, VSHREFVAR wids);
    ...
    * <p>
    *
    * Save MDI state and return as encoded string. The format of 
    * this string is user-implementation specific. Specify which 
    * areas to restore by setting <code>areas</code> to one or more
    * vsWindowLayoutArea flags. 
    *
    * @param areas 
    ...
    * @return slickedit::SEString 
    */
   slickedit::SEString (VSAPI * pfnMDISaveState)(int areas);
    ...
    * <code>pfnMDISaveState</code>. The format of this string
    * is user-implementation specific. Specify which areas to
    ...
    * @return true on success.
    */
   bool (VSAPI * pfnMDIRestoreState)(const slickedit::SEString& state, int areas, int flags);

   /**
    * Finds document window adjacent to current document window 
    * <code>wid</code>. 
    *  
    ...
    *    <dt><b>"N"</b> <dd>find next document tab (current or not)
    *    <dt><b>"P"</b> <dd>find previous document tab (current or not)
    ...
    * @param move_or_close  True means window edge can be sized
    *                       with current window
    * @return Non-zero window id if adjecent document window 
    *         exists. 0 otherwise.
    */
    ...
    * <code>window_list</code> array. Set 
    * <code>includeHidden=true</code> to include hidden MDI windows 
    * in the list. 
    *  
    * @param window_list 
    * @param includeHidden 
    */
   void (VSAPI *pfnMDIGetMDIWindowList)(slickedit::SEArray<int> &window_list, bool includeHidden);
   ...
   /**
    *  Return window id most recently active non-main MDI window
    *  
    *  @return Return window id of most recently non-main active
    *          MDI window. May return 0 if there are none.
    */
   int (VSAPI *pfnMDICurrentFloating)();
   /**
    * Returns non-zero value if MDI child edit window is 
    * visible 
    *  
    ...
    * @return slickedit::SEString
    */
   slickedit::SEString (VSAPI *pfnMDIGetUserProperty)(int mdi_wid, VSPSZ name);
   void (VSAPI *pfnMDISetUserProperty)(int mdi_wid, VSPSZ name, VSPSZ value);

   void (VSAPI *pfnInitGraphics)(slickedit::SEArray<slickedit::SEString> &array);
   int (VSAPI *pfnGetActiveForm)();
   void (VSAPI  *pfnMDIQtDragDropFilesActivate)(int x,int y,QWidget *pthiswidget,int &editor_wid);
...
/************************Miscellaneous option callbacks*******************************************/
   /*
       ...
       editor instance.
   */
   int (VSAPI *pfnUseCurrentInstance)(int new_option, const char *pszCmdline);
   ...
   */
    ...
    */
   void (*pfnEclipseRegisterAlert)(VSPSZ alertGroupID);
   void (*pfnEclipseUnregisterAlert)(VSPSZ alertGroupID);
   void (*pfnEclipseActivateAlert)(VSPSZ alertGroupID, VSPSZ alertID, const char* msg, const char* header, int showToast);
   void (*pfnEclipseDeactivateAlert)(VSPSZ alertGroupID, VSPSZ alertID, const char* msg, const char* header, int showToast);
   void (*pfnEclipseClearLastAlert)(VSPSZ alertGroupID, VSPSZ alertID);
   void (*pfnEclipseSetAlertGroupStatus)(VSPSZ alertGroupID, int enabled, int showPopups);
   void (*pfnEclipseSetAlertStatus)(VSPSZ alertGroupID, VSPSZ alertID, int enabled, int showPopups);
   void (*pfnEclipseGetAlertGroup)(VSPSZ alertGroupID, VSHREFVAR alertGroup);
   void (*pfnEclipseGetAlert)(VSPSZ alertGroupID, VSPSZ alertID, VSHREFVAR alert);
   void (*pfnEclipseSetAlert)(VSPSZ alertGroupID, VSPSZ alertID, VSHREFVAR alert);
   VSPSZ (VSAPI *pfnGetAlertHistory)();
   void  (VSAPI *pfnSetAlertHistory)(VSPSZ pszHistory);
   void *Reserved4[4];
} VSINIT;
...
/**
 * Retrieves the "sysconfig" path. 
 *  
 * @param sysConfigPath        Set to absolute sysconfig path.
 * @param resolvePluginPath 
 *    When true, plugin://<baseplugin>/sysconfig/ is converted
 *    to physical directory for the most up-to-date version of
 *    this plugin.
 */
void VSAPI vsGetSysConfigPath(slickedit::SEString &sysConfigPath, bool resolvePluginPath=true);
/**
 * Retrieves the "toolconfig" path. 
 * This is where configuration files are placed for 3rdparty tools. 
 *  
 * @param toolConfigPath        Set to absolute toolconfig path.
 */
void VSAPI vsGetToolConfigPath(slickedit::SEString &toolConfigPath);
/**
 ...
 * @see vsSaveSearch
 * @see vsRestoreSearch
 * @see vsMatchStartByName
 * @see vsMatchLengthByName
 *
 * @appliesTo Edit_Window, Editor_Control
 *
 * @categories Search_Functions
 ...
 * @appliesTo Edit_Window, Editor_Control
 * @categories Search_Functions
 * @param pName   Name of tagged expressions
 * @param nameLen Length of pName or -1 if pName is NULL
 *                terminated.
 * 
 * @return Returns the character offset from the beginning of the buffer to the last
 *         match or tagged expression found by the last <b>vsSearch</b> or
 ...
 * <pre>
 * int status;
 * status=vsSearch(0,"(?&lt;a&gt;this)|(?&lt;b&gt;that)",-1,"L");
 * if (!status ){
 *     char temps[100];
 *     // Get the word matched
 *     vsGetText(0,vsMatchLengthByName("a"),vsMatchStartByName("a"),temps);
 *     vsMessage(temps);
 * }
 * </pre>
 * @see vsMatchLength
 ...
 * @see vsMatchLengthByName
 */
seSeekPosRet VSAPI vsMatchStartByName(const char *pName, int nameLen = -1);
/**
 ...
 * @see vsMatchLengthByName
 */
int VSAPI vsMatchLengthByName(const char *pName,int nameLen=-1);
 ...
 *                  selection.
 * @param pszText   Utf-8 string to fill selection.
 * @param textLen   Length of pszRawText string. Can be
 *                  -1 if pszBuf is null terminated.
 ...
 */
void VSAPI vsFillSelection(int wid,int markid=-1,VSPSZ pszText="",int textLen=-1,int markflags=-1);
/**
 ...
 * @param wid    Window id of object.  0 specifies the current
 *               object.
 * @param stripLeadingBlanks
 *               When true, leading blanks are
 ...
 */
int VSAPI vsJoinLine(int wid,bool stripLeadingBlanks=false);
/**
 ...
 * @see vsJoinLine
 */
int VSAPI vsJoinLineToCursor(int wid,bool stripLeadingBlanks=false);
/**
...
#define VSWRAPFLAG_LINEWRAP   0x1
#define VSWRAPFLAG_WORDWRAP   0x2
// Only effects _delete_char()
#define VSWRAPFLAG_JOIN_STRIP_LEADING_BLANKS   0x4
/**
 ...
 *
 */
void VSAPI vsDeleteChar(int wid, int wrapFlags=0);
/**
 ...
 *
 */
void VSAPI vsRubout(int wid, int wrapFlags=0);
/**
 ...
 * @categories Selection_Functions
 *  
 * @see vsBlockSelStartAndEndSimilar 
 * @see vsBlockSelGetStartAndEndCol 
 */
void VSAPI vsBlockSelGetStartAndEndPixel(int &columnStartPixel, int &columnEndPixel,int markid= -1);
/**
 ...
 *  
 * @see vsBlockSelStartAndEndSimilar
 * @see vsBlockSelGetStartAndEndPixel
 */
void VSAPI vsBlockSelGetStartAndEndCol(int wid, int &start_col, int &end_col, int columnStartPixel, int columnEndPixel, int markid=-1);
/**
 * Determines if the start and end columns of a selection can be 
 * consider the same (ineffectively the same vertical column).
 *  
 * @param markid  mark id
 * 
 ...
 *  
 */
int VSAPI vsBlockSelStartAndEndSimilar(int markid=-1);
/**
 ...
 * opened, these offsets will not match what is on disk.
 *
 * @param wid	Window id of editor control.  0 specifies the
 * current object.
 *
 ...
 *
 */
int VSAPI vsGetRText(int wid,int Nofbytes,seSeekPos point,char *pszBuf,int *pNofbytesRead VSDEFAULT(0), int appendNull VSDEFAULT(1));
/**
...
#if 0
/**
 * Sets the line status flags for all lines in the editor
 * control specified.
 *
 * @param wid Window id of editor control.  0 specifies the current object.
 *
 ...
 */
EXTERN_C
void VSAPI vsSetAllLineFlags(int wid, int Flags, int Mask = 0);
#endif
/**
 * @return Returns 0 if successful.
 *
 ...
 *
 */
int VSAPI vsDeleteText(int wid,seSeekPos DelLen,char option VSDEFAULT(0));
/**
...
int VSAPI vsSearch(int wid,const char *pSearchString,int SearchStringLen, const char *pszOptions=0,const char *pReplaceString=0,int ReplaceStringLen=0,VSINT64 *pNofchanges=0,
                   int (VSAPI *pfnCompletionStatus)(VSINT64 new_filesize, VSINT64 offset,VSINT64 NofChanges,void *puserdata)=0,void *puserdata=0
                   );
 ...
 *
 */
VSDEPRECATED void VSAPI vsQuitView(int wid);
/**
...
#define VSDIFF_COMP_OPT_SKIP_LEADING_COMMENTS  0x800
...
/**
 * Get all the diff column options in one shot.
 * 
 * @param iWID      WID of window to check
 * @param bOnOff    is column handling on or off?
 * @param iStart    start column (&gt;= 1)
 * @param iEnd      end column
 * 
 * @return 0 if successful.
 *
 * @categories File_Functions
 */
EXTERN_C int VSAPI vsDiffGetStartEnd(const cmStringUtf8 &langId, bool &bOnOff, int &iStart, int &iEnd);

/**
 * @param iWID WID of window to check
 * 
 * @return int 1 if we should use start/end col info for file in <B>iWID</B>
 *
 * @categories File_Functions
 */
EXTERN_C int VSAPI vsDiffGetColOnOff(int iWID);

/**
 * @param iWID WID of window to check
 * 
 * @return int Start column for file in <B>iWID</B>
 *
 * @categories File_Functions
 */
EXTERN_C int VSAPI vsDiffGetStartCol(int iWID);

/**
 * @param iWID WID of window to check
 * 
 * @return int End column for file in <B>iWID</B>
 *
 * @categories File_Functions
 */
EXTERN_C int VSAPI vsDiffGetEndCol(int iWID);

/**
 * Get the current line from the editor control and process it with the 
 * given set of diff options and column options to set it up for comparing. 
 * 
 * @param iWID          WID of window to check
 * @param utf8          UTF-8 source?
 * @param psDest        (output) set to processed contents of line
 * @param psSource      (input) raw line text
 * @param iOptions      diff options to use (VSDIFF_COMP_OPT_*)
 * @param bOnOff        is column handling on or off?
 * @param iStart        start column (&gt;= 1)
 * @param iEnd          end column
 *
 * @categories File_Functions
 */
EXTERN_C void VSAPI vsDiffGetProcessedLine(int iWID, 
                                           int utf8, 
                                           slickedit::SEString &psDest, 
                                           const slickedit::SEString &psSource, 
                                           int iOptions,
                                           bool bColOnOff = false, 
                                           int iStartCol = 0, 
                                           int iEndCol = 0);

/**
 * Compare the contents of the two editor cotnrols, starting at the given 
 * seek position to see if the files match exactly. 
 *  
 * Will check for columns.  If you do not want to compare columns, use 
 * vsDiffFastBinaryCompare.
 * 
 * @param iViewId1      window id of editor control 2
 * @param iStartSeek1   start seek position
 * @param iViewId2      window id of editor control 2
 * @param iStartSeek2   start seek position
 * @param iOptions      diff options to use (VSDIFF_COMP_OPT_*)
 * 
 * @return Returns 0 if files match
 *
 * @categories File_Functions
 */
EXTERN_C
int VSAPI vsDiffFastCompare(int iViewId1,seSeekPosParam iStartSeek1,
                            int iViewId2,seSeekPosParam iStartSeek2,
                            int iOptions);
 ...
 */
EXTERN_C
int VSAPI vsDiffFastBinaryCompare(int iViewId1, seSeekPosParam iStartSeek1,
                                  int iViewId2, seSeekPosParam iStartSeek2);
/**
 * Compare the raw contents of two files.  This tests for the case where 
 * the files match exactly, byte-for-byte, case-sensitive.
 * 
 * @param filename1     file to compare
 * @param filename2     file to compare
 * 
 * @return Returns 0 if files match
 *
 * @categories File_Functions
 */
EXTERN_C
int VSAPI vsDiffFastRawFileCompare(VSPSZ filename1, VSPSZ filename2);
 ...
 * (array[0]&0xff). 
 * 
 * @param hexMode  If hexMode==1, current byte is returned if
 *                 the cursor is not past end of line.
 *
 ...
 *
 */
int VSAPI vsBeginChar(int wid,int doBeginChar VSDEFAULT(1), int *pCharLen VSDEFAULT(0),int beginComposite VSDEFAULT(1),unsigned *pUTF32Array VSDEFAULT(0),int *pUTF32ArrayLen VSDEFAULT(0),int hexMode=0);
...
#define VSFILETYPE_GVFS_FILE     7
#define VSFILETYPE_PLUGIN_FILE   8
#define VSFILETYPE_GZIP_FILE     9
#define VSFILETYPE_TAR_FILE      10
 ...
 */
VSDEPRECATED VSPICLISTITEM *VSAPI vsPicFindList(int wid,seSeekPos LineNum,seSeekPos LineOffset=(seSeekPos)VSNULLSEEK,int CheckNofLines=0,int reserved=0);
 ...
 *
 */
/*VSDEPRECATED*/ int VSAPI vsPicGet(int PicIndex,
 ...
 *
 * <dl>
 * <dt>_ed_breakpoint.svg</dt><dd>Indicates a line with an enabled breakpoint.</dd> 
 * <dt>_ed_breakpoint_disabled.svg</dt><dd>Indicates a line with a disabled breakpoint.</dd>
 * <dt>_ed_exec.svg</dt><dd>Indicates current execution line.</dd>
 * <dt>_ed_stack.svg</dt><dd>Indicates a line on the execution call stack.</dd>
 * </dl>
 *
 ...
 *                       0,4, vsFindIndex("_ed_breakpoint.svg",VSTYPE_PICTURE),
 *                       type);
 *
 * // Add a line marker which draws a box
 * int type=vsMarkerTypeAlloc();
 * int LineMarkerIndex=vsLineMarkerAdd(0,vsPropGetI64(0,VSP_LINE),
 *                       0,4,vsFindIndex("_ed_plus.svg",VSTYPE_PICTURE),
 ...
 *                  vsFindIndex("_ed_plus.svg",VSTYPE_PICTURE),type,"this is a test");
 ...
 * @categories Marker_Functions
 */
int VSAPI vsStreamMarkerGet(int StreamMarkerIndex,VSSTREAMMARKERINFO &info,int reserved0=-1,class VSHBLOCKTAB_LIST *reserved1=0,seSeekPos reserved2=(seSeekPos)0);
 ...
 *                        10,
 *                        1,4,
 *                        vsFindIndex("_ed_breakpoint.svg",VSTYPE_PICTURE),
 *                        type);
 * </pre>
 *
 * @appliesTo Edit_Window, Editor_Control
...
/**
 * When on, if this marker type has a color index set, use that color 
 * for each marker unless the marker specifies it's own color. 
 */
#define VSMARKERTYPEFLAG_USE_MARKER_TYPE_COLOR      0x400000
 ...
 * <dt>VSMARKERTYPEFLAG_USE_MARKER_TYPE_COLOR</dt><dd>
 * </dd>
 ...
 * VSMARKERTYPEFLAG_DRAW_SCROLL_BAR_MARKER flag and stream markers 
 * with the VSMARKERTYPEFLAG_USE_MARKER_TYPE_COLOR flag. 
 *
 * @param type	Index of marker type.
 *
 ...
 *         Call vsFree to free the list.
 */
int *VSAPI vsStreamMarkerAllocFindList(int wid,int *pNofItems,seSeekPos StartOffset,seSeekPos Length,seSeekPos SearchStartOffset=(seSeekPos)VSNULLSEEK,int type=0,class VSHBLOCKTAB_LIST *internalStartBlock=0,seSeekPos internalStartBlockPos_l=(seSeekPos)0);
/**
...
/**
 * Redraws all stream markers that have the specified type.
 *
 * @param type	Type of marker
 *
 * @appliesTo Edit_Window, Editor_Control
 ...
 *
 */
void VSAPI vsStreamMarkerRefreshAllType(int type);
/**
 ...
 * @appliesTo Edit_Window, Editor_Control
 * @categories Marker_Functions
 * @param StreamMarkerIndex
 *               Index of stream marker returned by a vsStreamMarkerAdd function.
 * @param StartOffset
 *               Replace StartOffset of this
 *               stream marker with the
 *               StartOffset
 */
...
void VSAPI vsStreamMarkerSetUserDataInt64(int StreamMarkerIndex, VSINT64 UserData);
void VSAPI scStreamMarkerSetUserDataInt64(int StreamMarkerIndex, VSINT64Param UserData);
VSINT64 VSAPI vsStreamMarkerGetUserDataInt64(int StreamMarkerIndex);
 ...
 *
 * @param pszNewPath          new current working directory
 * @param pszOrigPath         (by-ref) old current working
 *                            directory, used to send to
 *                            SEPopDir so we can revert to our
 *                            previous state
 * @param iOrigPathSize       number of bytes allocated for pszOrigPath 
 * @param iChangeDrive        if true (default), change current
 *                            drive to the drive specified by
 *                            <B>path</B>.
 *
 * @return int                0 if successful
 */
int VSAPI vsPushDir(VSPSZ pszNewPath, 
                    char *pszOrigPath VSDEFAULT(nullptr), 
                    int iOrigPathSize VSDEFAULT(0),
                    int iChangeDir VSDEFAULT(1));
...
EXTERN_C
int VSAPI vsAppendToZipFile(VSPSZ pszZipFilename, VSHREFVAR files, VSHREFVAR zipStatus, VSHREFVAR archiveNames);
...
struct VSWATCHEDPATHINFO {
   VSWATCHEDPATHINFO() : autoVCSystem(WATCHEDPATH_AUTO_VC_UNKOWN) {
   }
   ...
   vsAutoVCSystemTypes autoVCSystem;
...
VSDLLEXPORT
int VSAPI _eclipse_call_int_method(const char * methodName, const char * methodArgs);
...
extern bool VSAPI vsInTimer();
   ...
   #define VSW_SHOWNOACTIVATE_FOCUS_LATER 6
...
#define VSF2LI_NO_CHECK_BINARY_DATA    0x4            // do not check file contents for binary data
...
/**
 * Adds an item to a list box or combo box. 
 *  
 * @param list_wid  Window id of list box or combo box
 * @param pBuf      Utf-8 text to add
 * @param bufLen    length of text in pBuf
 * @param pic_index   Index to picture in names table or 0.
 * 
 ...
 */
EXTERN_C
void VSAPI vsLBAddItem(int list_wid, const char *pBuf, int bufLen = -1, int pic_index = 0);
...
/** 
 * @return
 * Returns the file encoding associated with the given file. 
 * (one of VSENCODING_*)
 *
 * @param fileName  source file name with path 
 * @param langId    language mode for file 
 * @param flags     one or more of the following flags ORed together:
 * <dl>
 * <dt>F2LI_NO_CHECK_PERFILE_DATA</dt><dd>Do not go through data saved
 * for previously opened files to determine encoding.  Normally, we check
 * the data stored in perfile.xml to see if this file has been opened
 * before and has a stored lang id.  If this flag is included, this step
 * is skipped</dd>
 * </dl>
 */
extern VSDLLEXPORT
int SEFilename2Encoding(const slickedit::SEString &filename,
                        const slickedit::SEString &langId, int flags=0);
...
slickedit::SEString regQueryValue(VSINT64 root, const slickedit::SEString &subkey,
                                  const slickedit::SEString &valueName, const slickedit::SEString &defaultValue = "");
slickedit::SEString regGetLatestVersionValue(VSINT64 root, const slickedit::SEString &subkey,
...
typedef slickedit::SEString (*ExtFileContentsCallback)  (const slickedit::SEString &buffer, int fileHandle, const slickedit::SEString &filename,int flags);
...
enum vsToolWindowFlag {
   TWF_FIXEDHEIGHT      = 0x01,  // Tool-window has fixed height
   TWF_NO_TABLINK       = 0x02,  // Do not allow tool-window to be added to a tabgroup
   TWF_NO_DOCKING       = 0x04,  // DO not allow tool-window to be docked with other tool-windows
   TWF_SUPPORT_MULTIPLE = 0x08,  // Support multiple instances of a tool-window
   TWF_NO_UNPIN         = 0x10,  // Do not allow tool-window unpin action

   // (user configurable) Solitary floating tool-window, ESC dismisses the window like a dialog
   ...
   TWF_FIXEDWIDTH      = 0x200  // Tool-window has fixed width
};

enum vsToolWindowDockingFlag {
...
enum vsWindowLayoutArea {
   MainArea = 0x1,  // Note that dock-channels are included in MainArea
   MdiArea  = 0x2,

   AllAreas = 0x3
};

// IMPORTANT: Any change to vsRestoreStateFlag must be reflected in RestoreStateFlag in slick.sh
enum vsRestoreStateFlag {
   RestorePostCleanup     = 0x1,  // Do post-cleanup after restoring state. Includes deleting empty/unused floating windows.
   RestoreNoNameMatch     = 0x2,  // Do not match on name when restoring windows. This implies ~RestoreNoInstanceMatch.
   RestoreNoInstanceMatch = 0x4,  // Do not match on instance/tile-id when restoring windows. This implies ~RestoreNoNameMatch.
   RestoreOnlyFloating    = 0x8   // Only restore to floating windows.
};

/**
 * Kill the timer <B>iHandle</B>
 * 
 * @param iHandle Timer to kill.
 */
EXTERN_C void VSAPI vsTimerKill(int iHandle);

/**
 * Set a timer
 * 
 * @param iMilliInterval Timer interval in milliseconds
 * @param pfnCallback callback function to call 
 * @param pUserData user data to pass to callback funciton
 * 
 * @return int 
 */
EXTERN_C int VSAPI vsTimerSet(int iMilliInterval, int(VSAPI *pfnCallback)(void *pUserData), void *pUserData=0);
/**
 * Temporarily disable timers.
 * 
 * @param onoff When false, disable all timers. When on, enable 
 *              all timers.
 */
EXTERN_C void VSAPI vsTimerEnable(bool onoff);

VSDLLEXPORT slickedit::SEString vsAbsolute(const slickedit::SEString &filename, const slickedit::SEString toDir="", bool resolveSymLinks=false);

VSDLLEXPORT bool vsFileSupportsGetFileTime(slickedit::SEString filename);
