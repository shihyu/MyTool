...
#define VSDEBUG_EVENT_UPDATE_CLASSES      0x0010

// constants for debugging support options
// by default these are ALL on.
#define VSDEBUG_OPTION_SUPPORT_HOTSWAP    0x0001
#define VSDEBUG_OPTION_CONFIRM_DIRECTORY  0x0002
 ...
 */
EXTERN_C int VSAPI vsDebugInitialize();
 ...
 * @categories Debugger_Functions
 */
EXTERN_C void VSAPI vsDebugFinalize();
 ...
 * @since 10.0
 */
EXTERN_C int VSAPI dbg_create_new_session(VSPSZ package_name, VSPSZ session_name, int copy_setup VSDEFAULT(0));
 ...
 * @since 10.0
 */
EXTERN_C int VSAPI dbg_get_num_sessions();
 ...
 * @since 10.0
 */
EXTERN_C int VSAPI dbg_get_current_session();
 ...
 * @since 10.0
 */
EXTERN_C int VSAPI dbg_set_current_session(int new_session_id);

/**
 * Get all of the session ID's for the active sessions
 *
 * @param id_array      Slick-C&reg; array of integers
 * 
 * @return 0 on success, <0 on error.
 * 
 * @since 10.0
 */
EXTERN_C int VSAPI dbg_get_all_sessions(VSHREFVAR id_array);
 ...
 * @since 10.0
 */
EXTERN_C int VSAPI dbg_find_session(VSPSZ session_name);
 ...
 * 
 * @since 10.0
 * @catagories Debugger_Functions
 */
EXTERN_C VSPSZ VSAPI dbg_get_callback_name(int session_id);
 ...
 * @param session_id    debugger session ID (1 .. max_session)
 * 
 * @return "" on failure, otherwise return session name
 *
 * @see dbg_find_session
 ...
 * @catagories Debugger_Functions
 */
EXTERN_C VSPSZ VSAPI dbg_get_session_name(int session_id);
 ...
 * @catagories Debugger_Functions
 */
EXTERN_C int VSAPI dbg_is_session_active(int session_id);
 ...
 * @catagories Debugger_Functions
 */
EXTERN_C int VSAPI dbg_set_session_name(int session_id, VSPSZ session_name);
 ...
 * @since 10.0
 */
EXTERN_C int VSAPI dbg_destroy_session(int session_id);
 ...
 * @since 10.0
 */
EXTERN_C int VSAPI dbg_translate_capability(VSPSZ capability);
 ...
 * @since 10.0
 */
EXTERN_C VSPSZ VSAPI dbg_get_capability_name(int capability);
 ...
 */
EXTERN_C int VSAPI
dbg_session_is_implemented(int session_id, int capability);
 ...
 */
EXTERN_C int VSAPI
dbg_session_is_name_implemented(int session_id, VSPSZ capability);
 ...
 * @since 10.0
 */
EXTERN_C int VSAPI dbg_session_initialize(int session_id,
                                          VSPSZ host_or_program, 
                                          VSPSZ port_or_pid, 
                                          VSPSZ arguments, int timeout, 
                                          VSPSZ debugger_path, 
                                          VSPSZ debugger_args);
 ...
 * @since 10.0
 */
EXTERN_C int VSAPI dbg_session_finalize(int session_id);
 ...
 * @since 10.0
 */
EXTERN_C int VSAPI dbg_session_terminate(int session_id, int exit_code);
 ...
 * @since 10.0
 */
EXTERN_C int VSAPI dbg_session_detach(int session_id);

/**
 * Detach from the remote debugging session and leave the application suspended.
 *
 * @param session_id       debugger session ID (1 .. max_session)
 * 
 * @return 0 on success, <0 on error.
 ...
 * @since 10.0
 */
EXTERN_C int VSAPI dbg_session_disconnect(int session_id);
 ...
 * @since 10.0
 */
EXTERN_C int VSAPI dbg_session_restart(int session_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_do_command(int session_id, VSPSZ command,
                       VSHREFVAR reply, VSHREFSTR errmsg, int parse_reply);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_error_message(int session_id, VSHREFSTR errmsg);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_print_output(int session_id, VSPSZ output_str);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_print_info(int session_id, VSPSZ info_str);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_print_error(int session_id, VSPSZ error_str);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_send_direct_input(int session_id, VSPSZ input_str);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_version(int session_id,
                    VSHREFVAR description,
                    VSHREFVAR major_version,
                    VSHREFVAR minor_version,
                    VSHREFVAR runtime_version,
                    VSHREFVAR debugger_name);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_test_version(int session_id,
                         VSPSZ debugger_path,
                         VSHREFVAR version,
                         int timeout);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_reload(int session_id, VSPSZ file_names, int options);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_get_paths(int session_id,
                      VSHREFSTR cwd, VSHREFSTR user, VSHREFSTR sys);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_resolve_path(int session_id,
                         VSPSZ file_name, VSHREFSTR full_path);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_suspend(int session_id, int thread_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_resume(int session_id, int thread_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_interrupt(int session_id, int thread_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_step_into(int session_id, int thread_id,VSPSZ dbg_session_step_into=0);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_step_over(int session_id, int thread_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_step_out(int session_id, int thread_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_step_into_runtimes(int session_id, int thread_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_step_instruction(int session_id, int thread_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_set_instruction_pointer(int session_id, 
                                    int thread_id, int frame_id,
                                    VSPSZ class_name, VSPSZ method_name,
                                    VSPSZ file_name, int line_number,
                                    VSPSZ address);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_enable_breakpoint(int session_id, int breakpoint_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_disable_breakpoint(int session_id, int breakpoint_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_probe_breakpoint(int session_id,
                             VSPSZ class_name, VSPSZ method_name,
                             VSPSZ file_name, int line_number);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_enable_watchpoint(int session_id, int breakpoint_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_disable_watchpoint(int session_id, int breakpoint_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_enable_exception(int session_id, int exception_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_disable_exception(int session_id, int exception_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_handle_event(int session_id,
                         VSHREFSTR event_kind,
                         VSHREFINT event_flags,
                         VSHREFINT event_thread,
                         VSHREFSTR event_class,
                         VSHREFINT breakpoint_id);
 ...
 * thread. 
 * <p> 
 * If this method is not overridden, the default behavior is to call 
 * the more general purpose {@link updateThreads()} method.
 *  
 * @return 0 on success, <0 on error.
 * 
 * @param session_id    debugger session ID (1 .. max_session)
 ...
 */
EXTERN_C int VSAPI 
dbg_session_update_current_thread(int session_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_update_threads(int session_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_update_thread_groups(int session_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_update_thread_names(int session_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_update_thread_states(int session_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_update_stack_top(int session_id, int thread_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_update_stack(int session_id, int thread_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_update_locals(int session_id, int thread_id, int frame_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_expand_local(int session_id,
                         int thread_id, int frame_id,
                         VSPSZ local_path);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_modify_local(int session_id,
                         int thread_id, int frame_id,
                         VSPSZ local_path, VSPSZ new_value);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_update_members(int session_id, int thread_id, int frame_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_expand_member(int session_id,
                          int thread_id, int frame_id,
                          VSPSZ member_path);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_modify_member(int session_id,
                          int thread_id, int frame_id,
                          VSPSZ member_path, VSPSZ new_value);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_update_watches(int session_id,
 ...
 */
EXTERN_C int VSAPI 
dbg_session_expand_watch(int session_id,
                         int thread_id, int frame_id,
                         VSPSZ watch_path);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_modify_watch(int session_id,
                         int thread_id, int frame_id,
                         VSPSZ watch_path, VSPSZ new_value);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_update_auto_watches(int session_id, int thread_id, int frame_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_expand_auto_watch(int session_id,
                              int thread_id, int frame_id,
                              VSPSZ autovar_path);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_modify_auto_watch(int session_id,
                              int thread_id, int frame_id,
                              VSPSZ autovar_path, VSPSZ new_value);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_eval_condition(int session_id,
                           int thread_id, int frame_id, VSPSZ expr);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_eval_expression(int session_id,
                            int thread_id, int frame_id,
                            VSPSZ expr, VSHREFSTR value);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_update_classes(int session_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_expand_class(int session_id, VSPSZ class_path);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_expand_methods(int session_id, int class_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_expand_fields(int session_id, int class_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_expand_nested(int session_id, int class_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_expand_parents(int session_id, int class_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_modify_field(int session_id, VSPSZ field_path, VSPSZ new_value);
 ...
 */
EXTERN_C int VSAPI
dbg_session_update_disassembly(int session_id, VSPSZ file_name,
 ...
 * @example
 * <pre>
 *    int status = dbg_session_update_registers(session_id,thread_id);
 *    if (status) {
 *       return status;
 *    }
 * </pre>
 ...
 */
EXTERN_C int VSAPI 
dbg_session_update_registers(int session_id,int thread_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_update_memory(int session_id, VSPSZ address, int size);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_modify_memory(int session_id, VSPSZ address, VSPSZ hexBytes, int size);
 ...
 * 
 */
EXTERN_C void VSAPI vsdebug_version();
/**
 * Initialize the debugger library and prepare to connect to
 * one or more debugging sessions.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_initialize();
/**
 * Close all existing debugging sessions, and free all memory
 * and files associated with the debugging session.
 * 
 */
EXTERN_C void VSAPI dbg_finalize();
 ...
 * 
 */
EXTERN_C int VSAPI dbg_start_java_session(VSPSZ class_path,VSPSZ server_name,
                                          VSPSZ port,VSPSZ class_name,
                                          VSPSZ entry_point);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_update_class_tree(int tree_wid,int tree_index,VSPSZ class_path,int hide_system);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_update_class_list(int list_wid, VSPSZ parent_class);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_update_group_tree(int tree_wid,int tree_index);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_update_thread_tree(int tree_wid,int tree_index);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_update_thread_list(int list_wid, int only_suspended);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_update_stack_tree(int tree_wid,int tree_index,
                                         int thread_id);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_update_stack_list(int list_wid,int thread_id);
/**
 * Remove the all disassembly information for the current buffer.
 * 
 * @param editorctl     window ID of the editor control
 * @param file_name     file name to clear disassembly for
 * 
 * @return 0 on success, <0 on error.
 * 
 */
EXTERN_C int VSAPI dbg_clear_editor_disassembly(int editorctl, VSPSZ file_name);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_update_disassembly(int editorctl, VSPSZ file_name);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_toggle_disassembly(VSPSZ file_name, int on_off);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_have_updated_disassembly(VSPSZ file_name);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_update_locals_tree(int tree_wid,int tree_index,
                                          int thread_id,int frame_id,VSPSZ local_path);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_update_members_tree(int tree_wid,int tree_index,
                                           int thread_id,int frame_id,VSPSZ member_path);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_update_autos_tree(int tree_wid,int tree_index,
                                         int thread_id,int frame_id,
                                         VSPSZ autovar_path);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_update_watches_tree(int tree_wid,int tree_index,
                                           int thread_id, int frame_id,
                                           int tab_number, VSPSZ watch_path);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_update_breakpoints_tree(int tree_wid,int tree_index, VSPSZ rel_dir,
 ...
 * 
 */
EXTERN_C int VSAPI dbg_update_exceptions_tree(int tree_wid,int tree_index,
                                              int pic_enabled, int pic_disabled);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_update_registers_tree(int tree_wid,int tree_index,int thread_id);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_update_memory_tree(int tree_wid,int tree_index);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_update_editor_stack(int thread_id, int frame_id);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_update_editor_breakpoints();
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_invalidate_views();
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_clear_editor();
 ...
 * @param arguments       arguments for program, not used here
 * @param timeout         Connection timeout in milliseconds
 ...
 * <PRE>
 *    int status=dbg_jdwp_initialize('',8000,10,0,0);
 *    if (status) {
 *       return(status);
 *    }
 * </PRE>
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_initialize(VSPSZ host_name,VSPSZ port_number,VSPSZ arguments,int timeout,VSPSZ unused_path,VSPSZ unused_args);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_finalize();
/**
 * Get the version information for the debugger.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_version(VSHREFSTR description,
                                    VSHREFSTR major_version,
                                    VSHREFSTR minor_version,
                                    VSHREFSTR runtime_version,
                                    VSHREFSTR debugger_name);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_update_classes();
/**
 * Update the items under a class recursively.  This includes
 * methods, static members, fields, and parent classes.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_expand_class(VSPSZ class_path);
/**
 * Update the methods under a class.
 *
 * @param class_id      index of class in class table
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_expand_methods(int class_id);
/**
 * Update the fields under a class.
 *
 * @param class_id      index of class to get fields of
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_expand_fields(int class_id);
/**
 * Modify the value of the specified field of the specified class.
 *
 * @param field_path      path to field to modify
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_modify_field(VSPSZ field_path, VSPSZ new_value);
/**
 * Update the nested classes under a class.
 *
 * @param class_id      index of class to get fields of
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_expand_nested(int class_id);
/**
 * Update the parent classes under a class.
 *
 * @param class_id      index of class to get fields of
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_expand_parents(int class_id);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_terminate(int exit_code);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_detach();
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_reload(VSPSZ file_names, int options);
/**
 * Get the user and system class paths for this debugging session.
 *
 * @param cwd             Set to the base directory or working directory
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_get_paths(VSHREFSTR cwd, VSHREFSTR user, VSHREFSTR sys);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_suspend(int thread_id=0);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_continue(int thread_id=0);
/**
 * Interrupt the execution of a specific thread.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_interrupt(int thread_id);
/**
 * Update the stack trace for the indicated thread
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_update_stack(int thread_id);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_update_threads();
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_update_threadgroups();
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_update_threadnames();
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_update_threadstates();
/**
 * Update the local variables for the specified stack
 * frame in the specified thread.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_update_locals(int thread_id,int frame_id);
/**
 * Expand the local variable at the given local variable path
 * for the specified stack frame in the specified thread.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_expand_local(int thread_id,int frame_id,VSPSZ local_path);
/**
 * Modify the value of the specified local variable
 * in the specified stack frame in the specified thread.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_modify_local(int thread_id,int frame_id,
                                         VSPSZ local_path, VSPSZ new_value);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_update_members(int thread_id,int frame_id);
/**
 * Expand the member variable at the given member variable path
 * for the specified stack frame in the specified thread.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_expand_member(int thread_id,int frame_id,VSPSZ member_path);
/**
 * Modify the value of the specified member variable
 * in the specified stack frame in the specified thread.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_modify_member(int thread_id,int frame_id,
                                          VSPSZ member_path, VSPSZ new_value);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_update_watches(int thread_id,int frame_id,int tab_number);
/**
 * Expand the watched variable at the given variable path
 * for the specified stack frame in the specified thread.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_expand_watch(int thread_id,int frame_id,VSPSZ watch_path);
/**
 * Modify the value of the specified watch expression
 * in the specified stack frame in the specified thread.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_modify_watch(int thread_id,int frame_id,
                                         VSPSZ watch_path, VSPSZ new_value);
/**
 * Update the watched variables for the specified stack
 * frame in the specified thread.
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_update_autos(int thread_id,int frame_id);
/**
 * Expand the watched variable at the given variable path
 * for the specified stack frame in the specified thread.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_expand_autovar(int thread_id,int frame_id,VSPSZ autovar_path);
/**
 * Modify the value of the specified auto watch expression
 * in the specified stack frame in the specified thread.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_modify_autovar(int thread_id,int frame_id,
                                          VSPSZ autovar_path, VSPSZ new_value);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_step_out(int thread_id);
/**
 * Step over the current statement or function call.
 *
 * @param thread_id       Thread ID to step
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_step_over(int thread_id);
/**
 * If the next statement is a function call, step into the function,
 * otherwise, step to the next simple statement.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_step_into(int thread_id);
/**
 * Step by the minimal amount possible, for C++, this means step
 * into the assembly code for a statement.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_step_instr(int thread_id);
/**
 * If the next statement is a function call, step into the function,
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_step_deep(int thread_id);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_disable_breakpoint(int breakpoint_id);
/**
 * Enable the given breakpoint
 *
 * @param breakpoint_id       Breakpoint to enable
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_enable_breakpoint(int breakpoint_id);
/**
 * Probe if a breakpoint can be set on the given line and return the
 * corrected line, file, class, and method that the breakpoint would
 * be placed at.
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_probe_breakpoint(VSPSZ class_name,VSPSZ method_name,
                                             VSPSZ file_name, int line_number);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_disable_exception(int exception_id);
/**
 * Enable the given exception
 *
 * @param exception_id       Exception to enable
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_enable_exception(int exception_id);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_handle_event(VSHREFSTR event_kind,
                                         VSHREFINT event_flags,
                                         VSHREFINT event_thread,
                                         VSHREFSTR event_class,
                                         VSHREFINT breakpoint_id);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_jdwp_resolve_path(VSPSZ file_name,VSHREFSTR full_path);
 ...
 */
EXTERN_C int VSAPI
dbg_jdwp_eval_condition(int thread_id,int frame_id,VSPSZ expr);
/**
 * Parse an expression in the current thread and frame.
 *
 * @param thread_id  current thread
 ...
 */
EXTERN_C int VSAPI
dbg_jdwp_eval_expression(int thread_id,int frame_id,VSPSZ expr,VSHREFVAR value);

/**
 * @return Return the index of current thread being inspected, 0 if not set.
 * 
 */
EXTERN_C int VSAPI dbg_get_cur_thread();
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_set_cur_thread(int thread_id);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_set_cur_suspended_thread(int thread_id);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_cur_frame(int thread_id);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_num_disassembly_lines(VSPSZ source_file);
/**
 * @param thread_id   index of thread
 * @param frame_id    index of stack frame
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_num_locals(int thread_id,int frame_id);
/**
 * @param thread_id   index of thread
 * @param frame_id    index of stack frame
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_num_members(int thread_id,int frame_id);
/**
 * @return Return the number of watched variables.
 * 
 */
EXTERN_C int VSAPI dbg_get_num_watches();
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_num_autos(int thread_id, int frame_id);
/**
 * @return Return the number of breakpoints.
 * 
 */
EXTERN_C int VSAPI dbg_get_num_breakpoints();
/**
 * @return Return the number of exception breakpoints.
 * 
 */
EXTERN_C int VSAPI dbg_get_num_exceptions();
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_num_fields(int class_id);
/**
 * @param class_id   index of class in class table
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_num_methods(int class_id);

/**
 * Get the details about a register.
 *
 * @param thread_id  thread ID to get register for
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_register(int thread_id,int reg_id,VSHREFSTR name,VSHREFSTR value);
/**
 * Set the value of a system register.
 *
 * @param thread_id  thread ID to update register for
 ...
 * 
 */
EXTERN_C int VSAPI dbg_set_register(int thread_id,int reg_id, VSPSZ value);
/**
 ...
 * @param class_loader  (reference) class loader (not implemented)
 *
 * @return 0 on success, <0 on error
 * 
 */
EXTERN_C int VSAPI dbg_get_class(VSPSZ class_path,VSHREFSTR name,
                                 VSHREFSTR outer_class,VSHREFSTR signature,
                                 VSHREFSTR file_name,VSHREFINT flags,
                                 VSHREFSTR class_loader);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_find_class(VSPSZ class_name,int name_only,int start_id);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_collapse_class(VSPSZ class_path);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_field(int class_id,int field_id,VSHREFSTR name,
                                 VSHREFSTR signature,VSHREFSTR value,VSHREFINT flags);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_set_field(int class_id, int field_id, VSPSZ value);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_method(int class_id,int method_id,
                                  VSHREFSTR name,VSHREFSTR class_name,
                                  VSHREFSTR signature,VSHREFSTR return_type,
                                  VSHREFSTR file_name,VSHREFINT flags);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_nested_type(int class_id, int type_id,
                                       VSHREFINT nested_id);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_parent_interface(int class_id, int parent_id,
                                            VSHREFSTR class_name);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_parent_class(int class_id, int parent_id,
                                        VSHREFSTR class_name);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_thread(int thread_id,
                                  VSHREFSTR name,VSHREFSTR group_name,VSHREFINT flags);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_suspended(int thread_id,VSHREFSTR name,
                                     VSHREFSTR group_name,VSHREFINT flags);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_has_updated_current_thread();
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_have_updated_threads();
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_add_thread(int thread_id,
                                  int thread_flags,
                                  VSPSZ thread_name,
                                  int parent_group);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_threadgroup(int threadgroup_id,
                                       VSHREFSTR name,VSHREFSTR group_name);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_frame(int thread_id,
                                 int frame_id,
                                 VSHREFSTR method_name,
                                 VSHREFSTR signature,
                                 VSHREFSTR return_type,
                                 VSHREFSTR class_name,
                                 VSHREFSTR file_name,
                                 VSHREFINT line_number,
                                 VSHREFSTR address);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_frame_path(int thread_id,
                                      int frame_id,
                                      VSHREFVAR file_name,
                                      VSHREFVAR line_number);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_set_frame_path(int thread_id, int frame_id, VSPSZ full_path);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_source_dir(int i, VSHREFSTR source_dir);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_add_source_dir(VSPSZ source_dir);
/**
 * @return Return the number of source file paths stored, <0 on error.
 * 
 */
EXTERN_C int VSAPI dbg_get_num_dirs();
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_resolve_path(VSPSZ file_name, VSHREFSTR full_path);
/**
 ...
 * 
 */
EXTERN_C VSDEPRECATED int VSAPI dbg_cache_resolved_path(VSPSZ file_name, VSPSZ full_path);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_runtime_expr(int i, VSHREFSTR expr);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_add_runtime_expr(VSPSZ expr);
/**
 * @return Return the number of runtime excludes stored, <0 on error.
 * 
 */
EXTERN_C int VSAPI dbg_get_num_runtimes();
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_is_runtime_expr(VSPSZ name);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_disassembly_line(VSPSZ source_file, int line_number,
                                            VSHREFVAR addresses,
                                            VSHREFVAR instructions,
                                            VSHREFVAR func_names,
                                            VSHREFVAR offsets);
 ...
 * @param addresses     (reference) Slick-C&reg; array of instruction addresses
 * @param instructions  (reference) Slick-C&reg; array of disassembled instructions
 * @param func_names    (reference) Slick-C&reg; array of function names
 * @param offsets       (reference) Slick-C&reg; array of function offsets
 * 
 * @return the line ID > 0 on success, < 0 on error.
 * 
 */
EXTERN_C int VSAPI dbg_add_disassembly_line(VSPSZ source_file, int line_number,
                                            VSHREFVAR addresses,
                                            VSHREFVAR instructions,
                                            VSHREFVAR func_names,
                                            VSHREFVAR offsets);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_find_disassembly_line(VSPSZ source_file, VSPSZ address,
                                             VSHREFVAR line_number,
                                             VSHREFVAR inst_offset);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_local(int thread_id,
                                 int frame_id,
                                 VSPSZ local_path,
                                 VSHREFSTR name,
                                 VSHREFSTR class_name,
 ...
 * 
 */
EXTERN_C int VSAPI dbg_set_local(int thread_id,int frame_id,
                                 VSPSZ local_path, VSPSZ value);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_collapse_local(int thread_id,int frame_id,VSPSZ local_path);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_member(int thread_id,int frame_id,VSPSZ member_path,
                                  VSHREFSTR name,VSHREFSTR class_name,
                                  VSHREFSTR signature,VSHREFINT flags,VSHREFSTR value,
                                  VSHREFVAR raw_value);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_set_member(int thread_id,int frame_id,
                                  VSPSZ member_path, VSPSZ value);
/**
 * Collapse all the nodes under the given member.
 *
 * @param thread_id   index of thread
 * @param frame_id    index of stack frame
 * @param member_path path to member in list of member variables
 ...
 * 
 */
EXTERN_C int VSAPI dbg_collapse_member(int thread_id,int frame_id,VSPSZ member_path);
 ...
 * @param context     (reference) the context to evaluate watch in
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_watch(int thread_id,int frame_id,int watch_id,
                                 VSHREFINT tab_number,VSHREFSTR expr,
                                 VSHREFSTR context,VSHREFSTR value,
                                 VSHREFINT expandable,
                                 VSHREFINT base, VSHREFSTR raw_value,
                                 VSHREFSTR type);
 ...
 * @return 0 on success, <0 on error
 */
EXTERN_C int VSAPI dbg_get_watch_info(int thread_id,int frame_id,VSPSZ watch_path,
                                      VSHREFSTR name, VSHREFSTR class_name,
                                      VSHREFSTR signature,
                                      VSHREFSTR value, VSHREFINT flags, 
                                      VSHREFSTR raw_value);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_collapse_watch(int thread_id,int frame_id,VSPSZ watch_path);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_have_autovars(int thread_id,int frame_id);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_autovar(int thread_id,int frame_id,int watch_id,
                                   VSHREFVAR expr,VSHREFVAR value,VSHREFVAR raw_value);
 ...
 * @return 0 on success, <0 on error
 */
EXTERN_C int VSAPI dbg_get_autovar_info(int thread_id,int frame_id,VSPSZ watch_path,
                                        VSHREFSTR name, VSHREFSTR class_name,
                                        VSHREFSTR signature,
                                        VSHREFSTR value, VSHREFINT flags,VSHREFVAR raw_value);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_collapse_auto(int thread_id,int frame_id,VSPSZ watch_path);
 ...
 * @param address       (reference) hex instruction address to set breakpoint at
 *
 * @return 0 on success, <0 on error.
 * 
 */
EXTERN_C int VSAPI dbg_get_breakpoint(int breakpoint_id,
                                      VSHREFINT count,
                                      VSHREFSTR condition,
                                      VSHREFSTR thread_name,
                                      VSHREFSTR class_name,
                                      VSHREFSTR method_name,
                                      VSHREFSTR file_name,
                                      VSHREFINT line_number,
 ...
 * @param address       (optional) hex address to set breakpoint at
 *
 * @return breakpoint ID > 0 on success, <0 on error.
 * 
 */
EXTERN_C int VSAPI dbg_find_breakpoint(VSPSZ file_name,int line_number,
                                       VSHREFINT enabled,int start_id,
                                       VSPSZ address VSDEFAULT(0));
/**
 ...
 * @param flags         bitset of VSDEBUG_WATCHPOINT_FLAG_*
 *
 * @return breakpoint index >0 on success, <0 on error.
 * 
 */
EXTERN_C int VSAPI dbg_add_breakpoint(int count,
                                      VSPSZ condition,
                                      VSPSZ thread_name,
                                      VSPSZ class_name,
                                      VSPSZ method_name,
 ...
 * 
 */
EXTERN_C int VSAPI dbg_remove_breakpoint(int breakpoint_id);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_set_breakpoint_enabled(int breakpoint_id,int enabled);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_breakpoint_enabled(int breakpoint_id);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_breakpoint_scope(int breakpoint_id,
                                            VSHREFSTR class_name,
                                            VSHREFSTR method_name);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_set_breakpoint_scope(int breakpoint_id,
                                            VSPSZ class_name,
                                            VSPSZ method_name);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_breakpoint_location(int breakpoint_id,
                                               VSHREFSTR file_name,
                                               VSHREFINT line_number);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_set_breakpoint_location(int breakpoint_id,
                                               VSPSZ file_name,
                                               int line_number,
                                               VSPSZ address);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_breakpoint_condition(int breakpoint_id,VSHREFSTR condition);
/**
 * Get the count constraint for the specified breakpoint.
 *
 * @param breakpoint_id index of variable in list of breakpoints
 *
 * @return -1 for temporary breakpoint, &Lt;-1 on error, &gt;=0 otherwise
 * 
 */
EXTERN_C int VSAPI dbg_get_breakpoint_count(int breakpoint_id);
/**
 ...
 * @return 0 on success, <0 on error.
 */
EXTERN_C int VSAPI dbg_get_breakpoint_type(int breakpoint_id, VSHREFVAR breakpoint_flags);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_add_exception(int stop_when,
                                     int count,
                                     VSPSZ condition,
                                     VSPSZ class_name,
                                     VSPSZ thread_name);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_remove_exception(int exception_id);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_set_exception_enabled(int exception_id,int enabled);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_exception_enabled(int exception_id);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_exception_class(int exception_id,VSHREFSTR class_name);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_exception(int exception_id,
                                     VSHREFINT stop_when,
                                     VSHREFINT count,
                                     VSHREFSTR condition,
                                     VSHREFSTR class_name,
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_exception_condition(int exception_id,VSHREFSTR condition);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_exception_count(int exception_id);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_find_exception(VSPSZ class_name,
                                      VSHREFINT enabled,int start_id);
 ...
 * @param base          base to print number values in
 *
 * @return watch ID index >0 on success, <0 on error.
 * 
 */
EXTERN_C int VSAPI dbg_add_watch(int tab_number,VSPSZ expr,VSPSZ context,int base);
/**
 * Modify a watch expression.
 *
 * @param watch_id      watch to modify
 * @param expr          expression to evaluate
 * @param context       context to evaluate expression in
 * @param base          base to print number values in
 *
 * @return 0 on success, <0 on error.
 * 
 */
EXTERN_C int VSAPI dbg_set_watch(int watch_id,VSPSZ expr,VSPSZ context,int base);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_add_autovar(int thread_id,int frame_id,VSPSZ expr);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_remove_watch(int watch_id);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_clear_watches();
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_clear_autos(int thread_id,int frame_id);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_clear_sourcedirs();
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_clear_runtimes();
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_clear_breakpoints();
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_clear_exceptions();
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_clear_classes();

/**
 * Indicate that the registers model is out of date
 *
 * @param thread_id     thread ID to clear registers for 
 *                      0 to clear all registers 
 *  
 * @return 0 on success, <0 on error.
 */
EXTERN_C int VSAPI dbg_clear_registers(int thread_id=0);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_clear_memory();
 ...
 * 
 */
EXTERN_C int VSAPI dbg_clear_threads();
 ...
 * 
 */
EXTERN_C int VSAPI dbg_clear_stack(int thread_id=0);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_clear_variables();
 ...
 * @return 0 on success, <0 on error.
 */
EXTERN_C int VSAPI dbg_clear_watch_variables();
 ...
 * 
 */
EXTERN_C int VSAPI dbg_clear_disassembly(VSPSZ file_name VSDEFAULT(0));
 ...
 *          with a 10 second timeout.
 * <PRE>
 *    int status=dbg_gdb_initialize('hellow',0,"1 2 3 4",10,0,0);
 *    if (status) {
 *       return(status);
 *    }
 * </PRE>
 * 
 */
EXTERN_C int VSAPI dbg_gdb_initialize(VSPSZ prog_name,VSPSZ pid_number,VSPSZ arguments,int timeout,VSPSZ gdb_path,VSPSZ gdb_args);
/**
 ...
 */
EXTERN_C int VSAPI
dbg_gdb_test_version(VSPSZ gdb_path, VSHREFVAR version, int timeout);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_finalize();
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_detach();
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_restart();
/**
 * Send the given command to the debugger and get the result
 * including both normal result ouput, and possible error output.
 *
 ...
 *                         otherwise it is a Slick-C&reg; array/hash table
 *
 * @return 0 on success, <0 on error.
 * 
 */
EXTERN_C int VSAPI dbg_gdb_do_command(VSPSZ command, VSHREFVAR reply, VSHREFSTR errmsg, int parse_reply);
/**
 * Get the last error message returned by GDB from a failed command.
 * GDB output of the form:  ^error,msg="..."
 *
 * @param errmsg           error message from GDB message
 *
 * @return 0 on success, <0 on error.
 * 
 */
EXTERN_C int VSAPI dbg_gdb_error_message(VSHREFSTR errmsg);
/**
 * Get the version information for the debugger.
 *
 * @param description     Description of debugger implementation and version
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_version(VSHREFSTR description,
                                    VSHREFSTR major_version,
                                    VSHREFSTR minor_version,
                                    VSHREFSTR runtime_version,
                                    VSHREFSTR debugger_name);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_terminate(int exit_code);
/**
 * Suspend the virtual machine, or a specific thread
 * within the virtual machine.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_suspend(int thread_id=0);
/**
 * Continue execution of the virtual machine, or a specific thread
 * within the virtual machine.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_continue(int thread_id=0);
/**
 * Interrupt the execution of a specific thread.
 *
 * @param thread_id       specific thread to interrupt
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_interrupt(int thread_id);
/**
 * Update the stack trace for the indicated thread
 *
 * @param thread_index  Thread ID to update stack for
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_update_stack(int thread_id);
/**
 * Update the list of threads running in the virtual machine
 *
 * @return 0 on success, <0 on error.
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_update_threads();
/**
 * Update the names of threads and thread groups in the virtual machine.
 * You must update the threads and thread groups first.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_update_threadnames();
/**
 * Update the status flags of all threads in the virtual machine.
 * You must update the threads first.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_update_threadstates();
/**
 * Update the registers and register values.
 *
 * @param thread_id  index of thread in table 
 ...
 * @return 0 on success, <0 on error.
 */
EXTERN_C int VSAPI dbg_gdb_update_registers(int thread_id);
/**
 * Update the watched memory region.
 *
 * @param address    Start address to dump
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_update_memory(VSPSZ address, int size);
/**
 * Update the local variables for the specified stack
 * frame in the specified thread.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_update_locals(int thread_id,int frame_id);
/**
 * Expand the local variable at the given local variable path
 * for the specified stack frame in the specified thread.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_expand_local(int thread_id,int frame_id,VSPSZ local_path);
/**
 * Modify the value of the specified local variable
 * in the specified stack frame in the specified thread.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_modify_local(int thread_id,int frame_id,
                                         VSPSZ local_path, VSPSZ new_value);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_update_members(int thread_id,int frame_id);
/**
 * Expand the member variable at the given member variable path
 * for the specified stack frame in the specified thread.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_expand_member(int thread_id,int frame_id,VSPSZ member_path);
/**
 * Modify the value of the specified member variable
 * in the specified stack frame in the specified thread.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_modify_member(int thread_id,int frame_id,
                                          VSPSZ member_path, VSPSZ new_value);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_update_watches(int thread_id,int frame_id,int tab_number);
/**
 * Expand the watched variable at the given variable path
 * for the specified stack frame in the specified thread.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_expand_watch(int thread_id,int frame_id,VSPSZ watch_path);
/**
 * Modify the value of the specified watch expression
 * in the specified stack frame in the specified thread.
 *
 * @param thread_id       index of thread in table
 * @param frame_id        index of frame in thread's stack
 * @param watch_path      path to watch variable to expand
 * @param new_value       value to set variable to
 *
 * @return 0 on success, <0 on error.
 * 
 */
EXTERN_C int VSAPI dbg_gdb_modify_watch(int thread_id,int frame_id,
                                        VSPSZ watch_path, VSPSZ new_value);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_update_autos(int thread_id,int frame_id);
/**
 * Expand the watched variable at the given variable path
 * for the specified stack frame in the specified thread.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_expand_autovar(int thread_id,int frame_id,VSPSZ autovar_path);
/**
 * Modify the value of the specified auto watch expression
 * in the specified stack frame in the specified thread.
 *
 * @param thread_id       index of thread in table
 * @param frame_id        index of frame in thread's stack
 * @param auto_path       path to watch variable to expand
 * @param new_value       value to set variable to
 *
 * @return 0 on success, <0 on error.
 * 
 */
EXTERN_C int VSAPI dbg_gdb_modify_autovar(int thread_id,int frame_id,
                                          VSPSZ auto_path, VSPSZ new_value);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_step_out(int thread_id);
/**
 * Step over the current statement or function call.
 *
 * @param thread_id       Thread ID to step
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_step_over(int thread_id);
/**
 * If the next statement is a function call, step into the function,
 * otherwise, step to the next simple statement.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_step_into(int thread_id);
/**
 * Step by the minimal amount possible, for C++, this means step
 * into the assembly code for a statement.
 *
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_step_instr(int thread_id);
/**
 * If the next statement is a function call, step into the function,
 * even if it is a builtin or runtime function, otherwise, step to
 * the next simple statement.
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_step_deep(int thread_id);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_set_instruction_pointer(int thread_id, int frame_id,
                                                   VSPSZ class_name, VSPSZ method_name,
                                                   VSPSZ file_name, int line_number, VSPSZ address);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_disable_breakpoint(int breakpoint_id);
/**
 * Enable the given breakpoint
 *
 * @param breakpoint_id       Breakpoint to enable
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_enable_breakpoint(int breakpoint_id);
/**
 * Probe if a breakpoint can be set on the given line and return the
 * corrected line, file, class, and method that the breakpoint would
 * be placed at.
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_probe_breakpoint(VSPSZ class_name,VSPSZ method_name,
                                             VSPSZ file_name, int line_number);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_disable_exception(int exception_id);
/**
 * Enable the given exception
 *
 * @param exception_id       Exception to enable
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_enable_exception(int exception_id);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_handle_event(VSHREFSTR event_kind,
                                         VSHREFINT event_flags,
                                         VSHREFINT event_thread,
                                         VSHREFSTR event_class,
                                         VSHREFINT breakpoint_id);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_resolve_path(VSPSZ file_name,VSHREFSTR full_path);
 ...
 */
EXTERN_C int VSAPI
dbg_gdb_eval_condition(int thread_id,int frame_id,VSPSZ expr);
/**
 * Parse an expression in the current thread and frame.
 *
 * @param thread_id  current thread
 * @param frame_id   current stack frame
 * @param expr       expression to parse
 * @param value      (reference) value of new expression
 *
 * @return 0 on success, <0 on error evaluating.
 * 
 */
EXTERN_C int VSAPI
dbg_gdb_eval_expression(int thread_id,int frame_id,VSPSZ expr,VSHREFVAR value);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_print_output(VSPSZ str);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_print_info(VSPSZ str);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_print_error(VSPSZ str);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_input_direct(VSPSZ str);

EXTERN_C int VSAPI dbg_gdb_update_disassembly(VSPSZ file_name,int start_line, int num_lines);

EXTERN_C void VSAPI dbg_get_supported_format_list(VSHREFVAR hrefList);
EXTERN_C int VSAPI dbg_get_global_format();
EXTERN_C void VSAPI dbg_set_global_format(int iNewBase);
EXTERN_C void VSAPI dbg_set_var_format(VSPSZ pszVarname,int iNewBase);
EXTERN_C int VSAPI dbg_get_var_format(VSPSZ pszVarname);
EXTERN_C VSPSZ VSAPI dbg_get_format_name(int iBase);
EXTERN_C int VSAPI dbg_get_num_formatted_vars();
EXTERN_C int VSAPI dbg_get_formatted_var(int iIndex,VSHREFVAR varname);
EXTERN_C int VSAPI dbg_get_format_is_for_type(int iBase, VSPSZ pszFormatType);


EXTERN_C int VSAPI dbg_dbgp_initialize(VSPSZ host, VSPSZ port,
                                       VSPSZ arguments, int timeout,
                                       VSPSZ debugger_path, VSPSZ debugger_args);
EXTERN_C int VSAPI dbg_dbgp_finalize();

EXTERN_C int VSAPI dbg_windbg_write_dumpfile(VSPSZ filename);
EXTERN_C int VSAPI dbg_windbg_get_modules(VSHREFVAR modulelist);
EXTERN_C int VSAPI dbg_windbg_get_symbols_path(VSHREFVAR path);
EXTERN_C int VSAPI dbg_windbg_set_symbols_path(VSPSZ path);
EXTERN_C int VSAPI dbg_windbg_get_image_path(VSHREFVAR path);
EXTERN_C int VSAPI dbg_windbg_set_image_path(VSPSZ path);
