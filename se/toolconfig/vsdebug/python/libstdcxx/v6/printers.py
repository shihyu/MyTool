...
class Printer(object):
    ...
    def add_version(self, base, name, function):
        ...
        self.add(base + '__2::' + name, function)
        self.add(base + '__3::' + name, function)
        self.add(base + '__4::' + name, function)
        self.add(base + '__5::' + name, function)
        self.add(base + '__6::' + name, function)
        self.add(base + '__7::' + name, function)
        self.add(base + '__7::' + name, function)
        self.add(base + '__8::' + name, function)
        self.add(base + '__9::' + name, function)
...
def build_libstdcxx_dictionary ():
    ...
    libstdcxx_printer.add_version('std::', 'string', StdStringPrinter)
    libstdcxx_printer.add_version('std::', '__cxx11::basic_string', StdStringPrinter)
    libstdcxx_printer.add_version('std::', '__cxx11::string', StdStringPrinter)
