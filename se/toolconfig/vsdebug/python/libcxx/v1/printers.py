...
class StdVectorPrinter:
    ...
    def to_string(self):
        ...
        if self.is_bool:
            ...
            if length == 0:
                return ('%s<bool> of length 0, capacity %d'
                        % (self.typename, int(capacity)))
            else:
            ...
            capacity = end - start
            if length == 0:
                return '%s of length 0, capacity %d' % (self.typename, int(capacity))
            else:
...
class StdDequePrinter:
    ...
    def to_string(self):
        if self.size == 0:
            ...
            return '%s of length %d' % (self.typename, long(self.size))
...
class StdBitsetPrinter:
    ...
    def to_string (self):
        return '%s of length %d' % (self.typename, self.bit_count)
...
class StdSetPrinter:
    ...
    def to_string (self):
        ...
        if length == 0:
            ...
            return '%s of length %d' % (self.typename, int(length))
