 ...
 */
int sstFindTab(_str caption, bool caseSensitive=false)
{
   result := -1;
   int i, n=p_NofTabs;
   for( i=0; i < n; ++i ) {
 ...
 */
bool sstActivateTabByCaption(_str caption, bool caseSensitive=false)
{
 ...
 */
bool sstTabExists(_str caption, bool caseSensitive=false)
{
 ...
 * contents), some platforms (macOS) require a one-time height
 * adjustment.
 *
 * <p>
 *
