...
/*
   ...
   Slick-C(R).
*/
#error "builtins.e is not meant to be compiled or imported."
...
interface _sc_lang_typeless {};
interface _sc_lang_object           : _sc_lang_typeless {};
interface _sc_lang_string           : _sc_lang_object {};
interface _sc_lang_collection       : _sc_lang_object {};
interface _sc_lang_array            : _sc_lang_collection {};
interface _sc_lang_hashtable        : _sc_lang_collection {};
interface _sc_lang_struct_or_class  : _sc_lang_object {};
interface _sc_lang_struct           : _sc_lang_struct_or_class {};
interface _sc_lang_class            : _sc_lang_struct_or_class {};
interface _sc_lang_control          : _sc_lang_typeless {};
interface _sc_lang_mdi_form         : _sc_lang_form, _sc_lang_tabbed {};
interface _sc_lang_basewindow       : _sc_lang_control {};
interface _sc_lang_window           : _sc_lang_basewindow {};
interface _sc_lang_text_window      : _sc_lang_window {};
interface _sc_lang_scrollable       : _sc_lang_text_window {};
interface _sc_lang_form             : _sc_lang_window {};
interface _sc_lang_text_or_list_box : _sc_lang_scrollable {};
interface _sc_lang_text_box         : _sc_lang_text_or_list_box {};
interface _sc_lang_list_box         : _sc_lang_text_or_list_box {};
interface _sc_lang_combo_box        : _sc_lang_text_box, _sc_lang_list_box {};
interface _sc_lang_frame            : _sc_lang_window {};
interface _sc_lang_label            : _sc_lang_text_window {};
interface _sc_lang_radio_button     : _sc_lang_label {};
interface _sc_lang_check_box        : _sc_lang_label {};
interface _sc_lang_scroll_bar       : _sc_lang_window {};
interface _sc_lang_hscroll_bar      : _sc_lang_scroll_bar {};
interface _sc_lang_vscroll_bar      : _sc_lang_scroll_bar {};
interface _sc_lang_picture_box      : _sc_lang_command_button {};
interface _sc_lang_command_button   : _sc_lang_label {};
interface _sc_lang_image            : _sc_lang_picture_box {};
interface _sc_lang_gauge            : _sc_lang_text_window {};
interface _sc_lang_spin             : _sc_lang_window {};
interface _sc_lang_menu             : _sc_lang_menu {};
interface _sc_lang_menu_item        : _sc_lang_command_button {};
interface _sc_lang_tabbed           : _sc_lang_text_window {};
interface _sc_lang_sstab            : _sc_lang_tabbed {};
interface _sc_lang_sstab_container  : _sc_lang_text_window {};
interface _sc_lang_tree_view        : _sc_lang_scrollable {};
interface _sc_lang_editor           : _sc_lang_scrollable {};
interface _sc_lang_minihtml         : _sc_lang_scrollable {};
interface _sc_lang_print_preview    : _sc_lang_text_window {};
interface _sc_lang_switch           : _sc_lang_text_window {};
...
void _insertel(typeless value,typeless index,int Nofitems= 1),
     _sc_lang_collection::_insertel(typeless value,typeless index,int Nofitems= 1);
...
void _deleteel(typeless index,int Nofitems= 1),
     _sc_lang_collection::_deleteel(typeless index,int Nofitems= 1);
...
typeless &_nextel(typeless &index),
         &_sc_lang_collection::_nextel(typeless &index);
...
typeless &_el(typeless index),
         &_sc_lang_collection::_el(typeless index);
 ...
 * @param comparePFN Slick-C function to use for comparisons, with a signature 
 *                   of 'int comparePFN(T &a, T &b);`, for an array with elements
 *                   of type T.
 *
 ...
 *
 */
int _sort(_str options="",start=0,int Nofitems= -1,int (*pfnCallback)(var,var)=0),
    _sc_lang_array::_sort(_str options="",start=0,int Nofitems= -1,int (*pfnCallback)(var,var)=0);
 ...
 * @categories Miscellaneous_Functions
 */
bool _instanceof(_str typeName),
        _sc_lang_typeless::_instanceof(_str typeName);
...
void _construct(_str className, ...),
     _sc_lang_struct_or_class::_construct(_str className, ...);
...
int _fieldindex(_str fieldName),
   _sc_lang_struct_or_class::_fieldindex(_str fieldName);
...
_str _fieldname(int index),
     _sc_lang_struct_or_class::_fieldname(int index);
...
typeless _getfield(_str indexOrName),
         _sc_lang_struct_or_class::_getfield(_str indexOrName);
...
void _setfield(_str indexOrName, typeless value),
     _sc_lang_struct_or_class::_setfield(_str indexOrName, typeless value);
...
int _findmethod(_str methodName),
    _sc_lang_struct_or_class::_findmethod(_str methodName);
...
typeless _callmethod(_str indexOrName, ...),
         _sc_lang_struct_or_class::_callmethod(_str indexOrName, ...);
...
int p_FirstActiveTab,
    _sc_lang_sstab::p_FirstActiveTab;
 ...
 * @categories SSTab_Properties
 */
bool p_AllowScrollWheel,
        _sc_lang_sstab::p_AllowScrollWheel;
 ...
 */
bool p_ClosableTabs,
        _sc_lang_tabbed::p_ClosableTabs;
...
_str p_ActiveCaption,
     _sc_lang_sstab::p_ActiveCaption;
 ...
 *
 */
bool p_ActiveEnabled,
        _sc_lang_sstab::p_ActiveEnabled;
 ...
 */
int p_ActivePicture,
    _sc_lang_sstab::p_ActivePicture;
 ...
 */
int p_ActiveToolTip,
    _sc_lang_sstab::p_ActiveToolTip;
...
int p_adaptive_formatting_flags,
    _sc_lang_editor::p_adaptive_formatting_flags;
 ...
 */
bool p_adefault,
        _sc_lang_command_button::p_adefault;
...
int p_after_pic_indent_x,
   _sc_lang_text_or_list_box::p_after_pic_indent_x;
 ...
 * @appliesTo Tree_View
 */
bool p_AlwaysColorCurrent,
        _sc_lang_tree_view::p_AlwaysColorCurrent;
...
int p_attribute_casing,
    _sc_lang_editor::p_attribute_casing;
 ...
 */
bool p_auto_select,
        _sc_lang_text_box::p_auto_select;
 ...
 */
bool p_AutoSelectExtension,
        _sc_lang_editor::p_AutoSelectExtension;
 ...
 * @since 13.0
 */
bool p_AutoSelectLanguage,
        _sc_lang_editor::p_AutoSelectLanguage;
 ...
 */
bool p_auto_size,
        _sc_lang_window::p_auto_size;

/** 
 * Determines whether auto left margin is on for hard word 
 * wrapping. 
 *  
 * <p>When auto left margin is on, the first non-blank 
 * determines the left margin for hard word wrapping. 
 *  
 * @see p_FixedWidthRightMargin
 * @see p_margins
 *
 * @appliesTo Edit_Window
 * @categories Edit_Window_Properties
 */
int p_AutoLeftMargin,
    _sc_lang_editor::p_AutoLeftMargin;
 ...
 * 
 * Note: Internally p_binary==1 means binary mode is on and the buffer should be in
 * active code page mode (p_encoding==0). p_binary==2 means binary mode is on and
 * the buffer should be in Unicode (Utf-8) mode.
 *
 * @categories Edit_Window_Properties, Editor_Control_Properties
 * @appliesTo Edit_Window, Editor_Control
 */
int p_binary,
    _sc_lang_editor::p_binary;
 ...
 */
int p_border_style,
    _sc_lang_window::p_border_style;
/**
...
_str p_buf_name_no_symlinks,
    _sc_lang_editor::p_buf_name_no_symlinks;
 ...
 */
bool p_cancel,
        _sc_lang_command_button::p_cancel;
...
bool p_case_sensitive,
        _sc_lang_combo_box::p_case_sensitive;
 ...
 */
_str p_categories,
     _sc_lang_menu_item::p_categories;
 ...
 */
int p_cb_active,
    _sc_lang_combo_box::p_cb_active;
 ...
 * @categories Combo_Box_Properties, Drive_List_Properties
 */
bool p_cb_extendedui,
    _sc_lang_combo_box::p_cb_extendedui;
...
CTL_LISTBOX p_cb_list_box,
    _sc_lang_combo_box::p_cb_list_box;
...
CTL_PICTURE p_cb_picture,
            _sc_lang_combo_box::p_cb_picture;
/**
...
CTL_TEXT p_cb_text_box,
         _sc_lang_combo_box::p_cb_text_box;
/**
 ...
 */
int p_char_width,
    _sc_lang_text_window::p_char_width;
 ...
 */
bool p_checked,
        _sc_lang_menu_item::p_checked;

bool p_CheckListBox,
        _sc_lang_tree_view::p_CheckListBox;
 ...
 */
int p_client_height,
    _sc_lang_window::p_client_height;
 ...
 */
int p_client_width,
    _sc_lang_window::p_client_width;
 ...
 */
bool p_clip_controls,
        _sc_lang_window::p_clip_controls;
 ...
 * @categories Tree_View_Properties
 */
bool p_ColorEntireLine,
        _sc_lang_tree_view::p_ColorEntireLine;
 ...
 */
_str p_command,
    _sc_lang_command_button::p_command;
 ...
 */
_str p_completion,
    _sc_lang_combo_box::p_completion;
 ...
 * @categories Combo_Box_Properties, Text_Box_Properties
 */
bool p_ListCompletions,
        _sc_lang_text_box::p_ListCompletions;

/**
 * Windows only: When a form is displayed, determines whether the form has a system menu.
 */
bool p_control_box,
        _sc_lang_form::p_control_box;
 ...
 */
bool p_default,
        _sc_lang_command_button::p_default;
 ...
 */
_str p_display_xlat,
     _sc_lang_editor::p_display_xlat;
 ...
 */
_str p_DocumentName,
     _sc_lang_editor::p_DocumentName;
 ...
 */
bool p_EditInPlace,
        _sc_lang_tree_view::p_EditInPlace;
...
_str p_EmbeddedLexerName,
     _sc_lang_editor::p_EmbeddedLexerName;
...
_str p_EmbeddedIdentifierChars,
     _sc_lang_editor::p_EmbeddedIdentifierChars;
 ...
 * language context, it will return the same thing as 
 * {@link p_LangCaseSensitive}. 
 *
 * @see p_embedded 
 * @see p_EmbeddedLexerName 
...
_str p_EmbeddedCaseSensitive,
     _sc_lang_editor::p_EmbeddedCaseSensitive;
...
typeless p_embedded_orig_values,
         _sc_lang_editor::p_embedded_orig_values;
...
int p_encoding_set_by_user,
    _sc_lang_editor::p_encoding_set_by_user;
...
int p_encoding_translation_error,
    _sc_lang_editor::p_encoding_translation_error;
 ...
 */
bool p_fixed_font,
        _sc_lang_editor::p_fixed_font;


/** 
 * Determines fixed width right margin for hard word wrapping. 
 *  
 * <p>p_FixedWidthRightMargin is only used if p_AutoLeftMargin 
 * is true. If p_FixedWidthRightMargin is 0, the fixed right 
 * margin from p_margins is used. 
 *  
 * @see p_AutoLeftMargin
 * @see p_margins
 *
 * @appliesTo Edit_Window
 * @categories Edit_Window_Properties
 */
int p_FixedWidthRightMargin,
    _sc_lang_editor::p_FixedWidthRightMargin;
...
int p_GrabbarLocation,
    _sc_lang_sstab::p_GrabbarLocation;
/**
 ...
 */
int p_Gridlines,
    _sc_lang_tree_view::p_Gridlines;
 ...
 */
int p_hex_Nofcols,
    _sc_lang_editor::p_hex_Nofcols;

/**
 * When in hex mode ({@link p_hex_mode}), determines number of bytes column of hex data.
 *
 * @appliesTo Editor_Control, Edit_Window
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
int p_hex_bytes_per_col,
    _sc_lang_editor::p_hex_bytes_per_col;
...
int p_hex_value_casing,
    _sc_lang_editor::p_hex_value_casing;
 ...
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
bool p_indent_case_from_switch,
        _sc_lang_editor::p_indent_case_from_switch;
 ...
 */
int p_indent_style,
    _sc_lang_editor::p_indent_style;
 ...
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
bool p_indent_with_tabs,
        _sc_lang_editor::p_indent_with_tabs;
 ...
 *
 */
bool p_interpret_html,
    _sc_lang_label::p_interpret_html;
 ...
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
bool p_KeepPictureGutter,
        _sc_lang_editor::p_KeepPictureGutter;
...
int p_keyword_casing,
    _sc_lang_editor::p_keyword_casing;
 ...
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
bool p_LangCaseSensitive,
        _sc_lang_editor::p_LangCaseSensitive;
...
_str p_identifier_chars,
    _sc_lang_editor::p_identifier_chars;
 ...
 */
int p_large_change,
    _sc_lang_scroll_bar::p_large_change;
 ...
 */
int p_LastModified,
    _sc_lang_editor::p_LastModified;
 ...
 */
int p_LCBufFlags,
    _sc_lang_editor::p_LCBufFlags;

/**
 * Indicates the current column position of the cursor within the line number 
 * prefix area.  
 * 
 * @appliesTo Editor_Control, Edit_Window
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
int p_LCCol,
    _sc_lang_editor::p_LCCol;

/**
 * Indicates whether the cursor is within the line number prefix area. 
 * 
 * @appliesTo Editor_Control, Edit_Window
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
int p_LCHasCursor,
    _sc_lang_editor::p_LCHasCursor;
 ...
 */
int p_LevelIndent,
    _sc_lang_tree_view::p_LevelIndent;

/**
 * Determines lexer name which defines the language coloring elements for a
 * buffer. This property is set to a valid color coding
 * profile name.  See <a href="help:Color Coding">Color 
 * Coding</a> for more information. 
 *  
 * @see p_EmbeddedLexerName 
 * @appliesTo Editor_Control, Edit_Window
 * @categories Editor_Control_Properties, Edit_Window_Properties
...
int p_line_numbers_len,
    _sc_lang_editor::p_line_numbers_len;
 ...
 */
int p_LineStyle,
    _sc_lang_tree_view::p_LineStyle;
 ...
 * @categories Editor_Control_Properties, Edit_Window_Properties, List_Box_Properties
 */
bool p_LinesForceWrapped,
        _sc_lang_editor::p_LinesForceWrapped;

/**
 * Determines the non-auto left margin, fixed right margin, and
 * new paragraph margin. This property is available only when 
 * the control is displayed. p_margins is a string in the 
 * format: 
 * <b><i>left_ma</i></b> <b><i>right_ma</i></b> [<b><i>new_paragraph_ma</i></b> ].  If new_paragraph_ma is not given,
 * it defaults to left_ma. 
 *  
 * <p>Note: The non-auto left margin is ignored by most macros 
 * if the p_AutoLeftMargin is on. The fixed right margin is 
 * ignored by most macros if p_FixedWidthRightMargin non-zero. 
 *  
 * @see p_AutoLeftMargin
 * @see p_FixedWidthRightMargin
 *
 ...
 */
int p_max,
    _sc_lang_scroll_bar::p_max;

/**
 * Display maximize button. Not fully supported.
 */
bool p_max_button,
        _sc_lang_form::p_max_button;
 ...
 */
int p_max_click,
    _sc_lang_command_button::p_max_click;
 ...
 */
int p_MaxLineLength,
    _sc_lang_editor::p_MaxLineLength;
 ...
 */
_str p_message,
    _sc_lang_command_button::p_message;
 ...
 */
int p_min,
    _sc_lang_scroll_bar::p_min;

/**
 * Gets the minimap window id if there is one.
 *  
 * <p>Not all editor contorls have a minimap window. For example, 
 * a minimap (p_IsMinimap=true) does not have a minimap window.</p>
 *
 * @appliesTo Editor_Control, Edit_Window
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
CTL_EDITOR p_minimap_wid,
    _sc_lang_editor::p_minimap_wid;
/**
 * Gets/sets the minimap window width property. 
 *  
 * <p>If p_minimap_is_fixed is true, p_minimap_width is a fixed window width value in twips.
 * <p>If p_minimap_is_fixed is false, p_minimap_width is the maximum window width allowed after the 
 * VSOPTION_MINIMAP_WIDTH_PERCENTER is applied.
 *
 * @appliesTo Editor_Control, Edit_Window
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
_str p_minimap_width,
    _sc_lang_editor::p_minimap_width;

/**
 * Gets/sets the minimap window is fixed property. 
 *  
 * <p>If p_minimap_is_fixed is true, p_minimap_width is a fixed window width value in twips.
 * <p>If p_minimap_is_fixed is false, p_minimap_width is the maximum window width allowed after the 
 * VSOPTION_MINIMAP_WIDTH_PERCENTER is applied.
 ...
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
bool p_minimap_width_is_fixed,
    _sc_lang_editor::p_minimap_width_is_fixed;
 ...
 */
int p_mode_eventtab,
    _sc_lang_editor::p_mode_eventtab;
 ...
 */
_str p_mode_name,
    _sc_lang_editor::p_mode_name;

/**
 * Determines whether the current buffer is modified.
 * The p_modify property is equivelent to setting the p_ModifyFlags to 0 or 1.
 ...
 */
int p_multi_select,
    _sc_lang_scrollable::p_multi_select;
 ...
 * @categories Tree_View_Properties
 */
bool p_NeverColorCurrent,
        _sc_lang_tree_view::p_NeverColorCurrent;
 ...
 */
bool p_no_select_color,
        _sc_lang_editor::p_no_select_color;
...
int p_NofSelDispBitmaps,
    _sc_lang_editor::p_NofSelDispBitmaps;
 ...
 */
int p_Nofselected,
    _sc_lang_list_box::p_Nofselected;
 ...
 * image1.on_create()
 * {
 *    index=_find_or_add_picture(bitmap_path_search("_arrow.bmp"));
 *    if (index<0) {
 ...
 */
int p_Nofstates,
    _sc_lang_picture_box::p_Nofstates;
 ...
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
bool p_no_space_before_paren,
        _sc_lang_editor::p_no_space_before_paren;
 ...
 */
int p_OldLineNumber,
    _sc_lang_editor::p_OldLineNumber;
 ...
 */
int p_pic_indent_x,
    _sc_lang_combo_box::p_pic_indent_x;
...
int p_pic_point_scale,
    _sc_lang_text_or_list_box::p_pic_point_scale;
 ...
 */
int p_pic_space_y,
    _sc_lang_text_or_list_box::p_pic_space_y;
 ...
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
bool p_pointer_style,
        _sc_lang_editor::p_pointer_style;
 ...
 * @categories Edit_Window_Properties, Editor_Control_Properties
 */
bool p_ProtectReadOnlyMode,
    _sc_lang_editor::p_ProtectReadOnlyMode;
...
bool p_readonly_mode,
        _sc_lang_editor::p_readonly_mode;
 ...
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
bool p_readonly_set_by_user,
        _sc_lang_editor::p_readonly_set_by_user;
 ...
 */
int p_scroll_bars,
    _sc_lang_scrollable::p_scroll_bars;
...
int p_scroll_left_edge,
    _sc_lang_editor::p_scroll_left_edge;
 ...
 */
int p_sel_length,
    _sc_lang_text_or_list_box::p_sel_length;
 ...
 */
int p_sel_start,
    _sc_lang_text_or_list_box::p_sel_start;

/**
 * Gets/sets the show minimap property. 
 *  
 * <p>When on, the Minimap window is displayed to the right of the edit window. When off, the Minimap window is closed. 
 *  
 * <p>Note: This property has no effect for non-MDI child edit windows. Use the VSWFLAG_SHOW_MINIMAP flag 
 * with  p_window_flags property to turn the minimap on/off for non-MDI child edit windows.
 *
 * @appliesTo Editor_Control, Edit_Window
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
_str p_show_minimap,
    _sc_lang_editor::p_show_minimap;
...
int p_ShowSpecialChars,
    _sc_lang_editor::p_ShowSpecialChars;
 ...
 */
int p_small_change,
    _sc_lang_scroll_bar::p_small_change;
 ...
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
bool p_SoftWrapOnWord,
        _sc_lang_editor::p_SoftWrapOnWord;
 ...
 *
 */
bool p_SourceRecording,
        _sc_lang_editor::p_SourceRecording;
 ...
 */
int p_SpaceY,
    _sc_lang_tree_view::p_SpaceY;
/**
 * Determines the height in pixels of one line in a tree control.
 *
 * @appliesTo Tree_View
 * @categories Tree_View_Properties 
 */
int p_line_height,
    _sc_lang_tree_view::p_line_height;

/**
 * Determines whether spell checking while typing is on or
 * off.
 *
 * @appliesTo Editor_Control, Edit_Window
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
bool p_spell_check_while_typing,
        _sc_lang_editor::p_spell_check_while_typing;

/**
 * Determines what color elements types are spell checked when
 * spell checking while typing is on.
 * 
 * <p>Note: tag/element languages like HTML, XML, and BBC do not
 * support this property. This property is ignored for languages
 * that do not support color coding.
 *
 * @appliesTo Editor_Control, Edit_Window
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
bool p_spell_check_while_typing_elements,
        _sc_lang_editor::p_spell_check_while_typing_elements;
 ...
 */
bool p_stretch,
        _sc_lang_picture_box::p_stretch;
 ...
 */
int p_SyntaxIndent,
    _sc_lang_editor::p_SyntaxIndent;
 ...
 */
_str p_text,
    _sc_lang_text_or_list_box::p_text;
 ...
 * @categories MDI_Window_Properties
 */
int p_mdi_child_duplicate_id,
   _sc_lang_mdi_form::p_mdi_child_duplicate_id;
 ...
 *
 * <p>In order to properly support the callback for a custom truncation 
 * line length calculation, users should reference <b>_TruncateLengthC</b> 
 * instead of this property wherever necessary.</p>
 *
 ...
 * @see trunc
 * @see p_AutoSelectLanguage
 * @see _TruncateLengthC 
 *  
 * @appliesTo Edit_Window, Editor_Control
 * @categories Edit_Window_Properties, Editor_Control_Properties
 */
int p_TruncateLength,
    _sc_lang_editor::p_TruncateLength;
 ...
 */
int p_value_casing,
    _sc_lang_editor::p_value_casing;

/**
 * @deprecated Not used.
 */
int p_vsb_max,
    _sc_lang_scroll_bar::p_vsb_max;
 ...
 * <dt>'M'</dt><dd>Maximized window  (hides Document Tabs)</dd>
 * <dt>'N'</dt><dd>Normalized window (shows Document Tabs)</dd> 
 ...
 */
_str p_window_state,
    _sc_lang_editor::p_window_state;
...
int p_word_wrap_style,
    _sc_lang_editor::p_word_wrap_style;
...
int p_begin_end_style,
    _sc_lang_editor::p_begin_end_style;
 ...
 */
bool p_font_bold,
        _sc_lang_text_window::p_font_bold;
/**
 ...
 */
bool p_font_italic,
        _sc_lang_text_window::p_font_italic;
/**
 ...
 */
_str p_font_name,
     _sc_lang_text_window::p_font_name;
 ...
 */
bool p_font_printer,
        _sc_lang_text_window::p_font_printer;
 ...
 */
_str p_font_size,
    _sc_lang_text_window::p_font_size;
 ...
 */
int p_font_charset,
    _sc_lang_text_window::p_font_charset;
 ...
 * @categories All_Windows_Properties
 */
bool p_font_strike_thru,
    _sc_lang_text_window::p_font_strike_thru;
 ...
 * @categories All_Windows_Properties
 */
bool p_font_transparent,
    _sc_lang_text_window::p_font_transparent;
 ...
 * @categories All_Windows_Properties
 */
bool p_font_underline,
        _sc_lang_text_window::p_font_underline;
 ...
 */
bool p_font_outline,
        _sc_lang_text_window::p_font_outline;
 ...
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
bool p_function_brace_on_new_line,
        _sc_lang_editor::p_function_brace_on_new_line;

/**
 *
 * Determines whether the current window has a buffer attached
 *
 * @appliesTo All_Window_Objects
 *
 ...
 */
bool p_IsTempEditor,
        _sc_lang_window::p_IsTempEditor;

/**
 *
 * Determines whether the current window is a minimap editor window.
 *
 * @appliesTo All_Window_Objects
 *
 * @categories Check_Box_Properties, Combo_Box_Properties,
 ...
 */
long p_hwndframe,
    _sc_lang_window::p_hwndframe;

_str p_init_info,
    _sc_lang_form::p_init_info;
/**
 ...
 */
int p_init_style,
   _sc_lang_form::p_init_style;

/**
 * Returns true if current object is a tool-window. If the 
 * object is not a form (p_object==OI_FORM), then false is 
 * returned. This property is available only when the object is 
 * displayed. 
 *
 * @appliesTo All_Window_Objects
 * @categories All_Windows_Properties
 */
int p_isToolWindow,
    _sc_lang_form::p_isToolWindow;

/**
 * Returns non-zero DOCKAREAPOS_* constant indicating which area
 * the current object is docked on relative to the mdi-area, 
 * otherwise returns 0 if object is not docked. If the object is 
 * not part of a tool-window form 
 * (p_active_form.p_isToolWindow==true), then 0 is returned. 
 ...
 */
int p_MouseActivate,
    _sc_lang_control::p_MouseActivate;
 ...
 */
int p_mouse_pointer,
    _sc_lang_control::p_mouse_pointer;
 ...
 * @categories All_Windows_Properties
 */
bool p_object_modify,
        _sc_lang_control::p_object_modify;
 ...
 * @categories All_Windows_Properties
 */
CTL_CONTROL p_parent,
            _sc_lang_control::p_parent;
 ...
 */
bool p_undo_visible,
        _sc_lang_control::p_undo_visible;
 ...
 */
bool p_visible,
        _sc_lang_control::p_visible;

/**
 * Determines the width of a window in the scale mode of 
 * {@link p_xyscale_mode}.
 * 
 * @see p_x 
 * @see p_x_extent 
 ...
 */
int p_window_flags,
    _sc_lang_editor::p_window_flags;
 ...
 *
 */
CTL_CONTROL p_window_id;

/**
 * Determines the left-hand side x position of a window in the
 * scale mode of {@link p_xyscale_mode}.
 *  
 * @see p_x_extent
 * @see p_width
 * @see p_y
...
/**
 * Determines the right-hand side x position of a window in the
 * scale mode of <b>p_xyscale_mode</b>.
 *  
 * Assigning to this property will change {@link p_width}.
 * If the value assigned is less than {@link p_x},
 * {@link p_width} will be set to 0 and {@link p_x} will be unchanged.
 * 
 * @appliesTo All_Window_Objects
 *
 * @categories Check_Box_Properties, Combo_Box_Properties,
 ...
 */
int p_xyscale_mode,
    _sc_lang_window::p_xyscale_mode;

/**
 * Determines the top y position of a window in the scale mode
 * of {@link p_xyscale_mode}.
 *  
 * @see p_y_extent
 * @see p_height
 * @see p_x 
...
/**
 * Determines the bottom y position of a window in the scale
 * mode of <b>p_xyscale_mode</b>.
 *  
 * Assigning to this property will change {@link p_height}. 
 * If the value assigned is less than {@link p_y}, 
 * {@link p_height} will be set to 0 and {@link p_y} will be unchanged.
 * 
 * @appliesTo All_Window_Objects
 *
 * @categories Check_Box_Properties, Combo_Box_Properties,
...
typeless call_event(...,int wid_or_etab ,_str event, option='W'),
         _sc_lang_control::call_event(...,int wid_or_etab ,_str event, option='W');
...
typedef _sc_lang_check_box       _check_box;
typedef _sc_lang_combo_box       _combo_box;
typedef _sc_lang_command_button  _command_button;
typedef _sc_lang_control         _control;
typedef _sc_lang_editor          _editor;
typedef _sc_lang_form            _form;
typedef _sc_lang_frame           _frame;
typedef _sc_lang_gauge           _gauge;
typedef _sc_lang_hscroll_bar     _hscroll_bar;
typedef _sc_lang_image           _image;
typedef _sc_lang_inherit         _inherit;
typedef _sc_lang_label           _label;
typedef _sc_lang_list_box        _list_box;
typedef _sc_lang_menu            _menu;
typedef _sc_lang_minihtml        _minihtml;
typedef _sc_lang_picture_box     _picture_box;
typedef _sc_lang_radio_button    _radio_button;
typedef _sc_lang_spin            _spin;
typedef _sc_lang_sstab           _sstab;
typedef _sc_lang_sstab_container _sstab_container;
typedef _sc_lang_text_box        _text_box;
typedef _sc_lang_tree_view       _tree_view;
typedef _sc_lang_vscroll_bar     _vscroll_bar;
 ...
 *         names table of the dialog box template.  On error, 0
 *         is returned to indicate INSUFFICIENT_MEMORY_RC.
 */
int _update_template(),
    _sc_lang_form::_update_template();
 ...
 * load options to translate files when they are opened, these offsets will
...
int _GoToROffset(long offset),
    _sc_lang_editor::_GoToROffset(long offset);
/**
...
int _QLineNumberFromOffset(long offset),
    _sc_lang_editor::_QLineNumberFromOffset(long offset);
 ...
 *                     left and right
 * @param plaintext    Message contents are plaintext, do not
 *                     use rich text markup
 *
 * @appliesTo Edit_Window, Editor_Control
 *
 * @categories Miscellaneous_Functions
...
int _text_width(_str string),
    _sc_lang_text_window::_text_width(_str string);
 ...
 */
int _text_height(),
    _sc_lang_text_window::_text_height();
...
int _find_control(_str ctlName),
    _sc_lang_form::_find_control(_str ctlName);
 ...
 * @return Returns 0 if successful.
 */
int _copy_objects_to_clipboard(bool isClipboard=true),
    _sc_lang_control::_copy_objects_to_clipboard(bool isClipboard=true);
 ...
 * @param isClipboard  Indicates whether operation is performed for the clipboard or selection.  Effects Unix only.
 * @param binary  Effects text clipboards only. Indicates
 *                whether new-lines in the clipboard should be
 ...
 */
int _copy_from_clipboard(bool isClipboard=true,bool binary=false),
    _sc_lang_text_window::_copy_from_clipboard(bool isClipboard=true,bool binary=false);
...
int _ShowWindow(int sw=-1),
    _sc_lang_form::_ShowWindow(int sw=-1);
 ...
 *
 */
void _get_window(int &x, int &y, int &width, int &height, _str option='C',int &icon_x=0,int &icon_y=0),
     _sc_lang_window::_get_window(int &x, int &y, int &width, int &height, _str option='C',int &icon_x=0,int &icon_y=0);
 ...
 *
 */
void _move_window(int x, int y, int width, int height,_str option='C',int icon_x=MAXINT,int icon_y=MAXINT),
    _sc_lang_window::_move_window(int x, int y, int width, int height,_str option='C',int icon_x=MAXINT,int icon_y=MAXINT);
...
int _get_selinfo(int &start_col, int &end_col, int &buf_id , _str mark_id="", _str &buf_name="", int utf8=0, int encoding=0, int Noflines=0),
    _sc_lang_editor::_get_selinfo(int &start_col, int &end_col, int &buf_id , _str mark_id="", _str &buf_name="", int utf8=0, int encoding=0, int Noflines=0);


/**
 * Determines if the start and end columns of a selection can be
 * consider the same (in effectively the same vertical column).
 * 
 * @appliesTo Edit_Window, Editor_Control
 * @categories Selection_Functions
 * @param mark_id mark id
 * @param return_true_if_one_character_width
 *                When the def_scursor_style option is set to 1, the block
 *                selections can become non-inclusive even
 *                though the user wants inclusive block
 *                selections. In this case, we want this
 *                function to return true if it looks like the
 *                selection width is one character. This has no
 *                effect for inclusive block selections.
 * 
 * @return Returns true if the start and end columns of the
 *         selection can be considered the same.
 */
bool _BlockSelStartAndEndSimilar(_str mark_id="",bool return_true_if_one_character_width=false),
        _sc_lang_editor::_BlockSelStartAndEndSimilar(_str mark_id="",bool return_true_if_one_character_width=false);

/**
 * Retrieves the start and end pixels for a proportional font 
 * BLOCK selection. 
 *  
 * @param columnStartPixel  Set to start pixel
 * @param columnEndPixel    Set to end pixel
 * @param mark_id           mark id
 * 
 * @appliesTo Edit_Window, Editor_Control
 * @categories Selection_Functions
 *  
 * @see _BlockSelStartAndEndSimilar 
 * @see _BlockSelGetStartAndEndCol 
 */
void _BlockSelGetStartAndEndPixel(int &columnStartPixel, int &columnEndPixel, _str mark_id=""),
     _sc_lang_editor::_BlockSelGetStartAndEndPixel(int &columnStartPixel, int &columnEndPixel, _str mark_id="");

/**
 * Retrieves the start and end column for the current line given
 * BLOCK selection. 
 *  
 * <p>This function is typically used to support a proportional 
 * font BLOCK selection but can also be used for a fixed font 
 * BLOCK selection. 
 * 
 * @param start_col  Set to start column
 * @param end_col    Set to end column (where 
 *                   width=end_col-start_col)
 * @param columnStartPixel
 *                  start pixel
 * @param columnEndPixel
 *                  end pixel
 * @param mark_id   mark id
 * 
 * @appliesTo Edit_Window, Editor_Control
 ...
 *  
 * @see _BlockSelStartAndEndSimilar
 * @see _BlockSelGetStartAndEndPixel
 */
void _BlockSelGetStartAndEndCol(int &start_col, int &end_col,int columnStartPixel, int columnEndPixel, _str mark_id=""),
     _sc_lang_editor::_BlockSelGetStartAndEndCol(int &start_col, int &end_col,int columnStartPixel, int columnEndPixel, _str mark_id="");

/**
 * Determines text width in pixels for column 
 * specified.
 * 
 * <p>Only calls this function if p_fixed_font is false. 
 *  
 * @param col     Input column (p_col)
 * 
 * @appliesTo Edit_Window, Editor_Control
 * @categories Selection_Functions
 *  
 * @see _ColFromTextWidth
 */
void _TextWidthFromCol(int col),
     _sc_lang_editor::_TextWidthFromCol(int col);


/**
 * Determines the column at the pixel position specified.
 *  
 * <p>Position is determined as if the mouse was clicked. 
 * <p>Only calls this function if p_fixed_font is false. 
 * 
 * @param col     Input column (p_col)
 * 
 ...
 * @categories Selection_Functions
 *  
 * @see _TextWidthFromCol
 */
void _ColFromTextWidth(int col),
     _sc_lang_editor::_ColFromTextWidth(int col);
...
void _prev_window(_str option=""),
     _sc_lang_editor::_prev_window(_str option="");
...
void _next_window(_str option=""),
     _sc_lang_editor::_next_window(_str option="");
...
void refresh(_str option="A"),
     _sc_lang_window::refresh(_str option="A");
 ...
 */
void _post_paint(),
     _sc_lang_text_window::_post_paint();
 ...
 * @example
 * <pre>
 *    keyin(last_event(null,/*keysOnly*/true));
 * </pre>
 * 
 ...
 *  
 * @note
 * When used in conjunction with {@link last_event}, as in
 * <code>keyin(last_event())</code>, if the last event was not a
 * key event, this method will insert what will appear to be
 * garbage characters.  Utilize the
 * <code>keysOnly</code> option of {@link last_event()} to avoid
 * this, or make certain that no non-key events could have been
 * interjected (for example, from a dialog closing, e.g.,
 * Auto-Complete) beforehand.
 * 
...
void keyin(_str string),
    _sc_lang_text_window::keyin(_str string);
...
void _SetAllOldLineNumbers(),
     _sc_lang_editor::_SetAllOldLineNumbers();
...
void _GoToOldLineNumber(int OldLineNumber),
     _sc_lang_editor::_GoToOldLineNumber(int OldLineNumber);
...
void _split_line(int col=1),
     _sc_lang_editor::_split_line(int col=1);
 ...
 *
 */
int _join_line(bool stripLeadingSpaces=false),
    _sc_lang_editor::_join_line(bool stripLeadingSpaces=false);
 ...
 * <P>
 * @param stripLeadingBlanks  When true, leading blanks are 
 *                            removed from the next line before
 *                            join.
 *  
 ...
 *
 */
int _JoinLineToCursor(bool stripLeadingSpaces=false),
    _sc_lang_editor::_JoinLineToCursor(bool stripLeadingSpaces=false);
 ...
 * @categories Edit_Window_Methods, Editor_Control_Methods
 */
void _delete_text(long Nofbytes,_str option=""),
     _sc_lang_editor::_delete_text(long Nofbytes,_str option="");
 ...
 * @categories Edit_Window_Methods, Editor_Control_Methods
 */
void _insert_text(_str string,bool binary=false,_str newlineChars="\r\n"),
     _sc_lang_editor::_insert_text(_str string,bool binary=false,_str newlineChars="\r\n");


/** 
 * Deletes text and inserts string at cursor position.
 * 
 * <p>This function does an overlay when changing text on
 * current line only. This is so that any selection
 * containing the overlayed text won't be modified. This is
 * useful when filtering text (upcase/lowcase/etc.).
 * 
 * <p> NOTE: If you are inserting at the end of a file and the
 * last character of string is a new line, you can end up with a
 * blank line that has no new line characters in it. You can
 * test for this condition by calling _line_length(1) which will return 0.
 * Use delete_line() to delete the line.
 * 
 * 
 * @param delLen        Number of bytes to delete
 * @param string        text to insert
 * @param flags         Maybe "C" or "B" or "". When "C" is
 *                      specified, delLen is a column count from
 *                      the cursor. When "B" is specified,
 *                      inserted text may split newline
 *                      characters. (i.e. CR&lt;insert
 *                      here&gt;LF). The "B" flags must be
 *                      specified if you want to insert multiple
 *                      lines of text.
 * @param NewLineChars  defaults to "\r\n". The NewLineChars string specifies a 1 or two
 * byte sequence which indicates the line separation characters
 * for the string argument. The NewLineChars argument is ignored
 * if the "B" flag is specified.
 *
 * @appliesTo  Edit_Window, Editor_Control
 * @categories Edit_Window_Methods, Editor_Control_Methods
 */
void _replace_text(long delLen,_str string,_str flags='',_str newlineChars="\r\n"),
     _sc_lang_editor::_replace_text(long delLen,_str string,_str option='',bool binary=false,_str newlineChars="\r\n");
 ...
 * @categories Edit_Window_Methods, Editor_Control_Methods
 */
void _insert_text_raw(_str string,bool binary=false,_str newlineChars="\r\n"),
     _sc_lang_editor::_insert_text_raw(_str string,bool binary=false,_str newlineChars="\r\n");
 ...
 * @categories Edit_Window_Methods, Editor_Control_Methods
 */
int _line_length(bool includeNLChars=false),
    _sc_lang_editor::_line_length(bool includeNLChars=false);
...
int _text_colc(int column=0,_str option="L"),
    _sc_lang_editor::_text_colc(int column=0,_str option="L");
...
_str _expand_tabsc(int start=1,int count=-1,_str option="E"),
     _sc_lang_editor::_expand_tabsc(int start=1,int count=-1,_str option="E");
...
int _expand_tabsc_raw(int start=1,int count=-1,_str option="E"),
    _sc_lang_editor::_expand_tabsc_raw(int start=1,int count=-1,_str option="E");
 ...
 *
 */
int _lineflags(int newflags=0,int mask=newflags,_str markid= null),
    _sc_lang_editor::_lineflags(int newflags=0,int mask=newflags,_str markid=null);
...
int _insert_name_list(int type_flag,_str name_prefix=""),
    _sc_lang_editor::_insert_name_list(int type_flag,_str name_prefix="");
...
int _spell_check(_str &word, _str &replace_word, int &col , _str string=""),
    _sc_lang_editor::_spell_check(_str &word, _str &replace_word, int &col , _str string="");
...
int _spell_check_area(_str &word, _str &replace_word, int &col , int start_col ,int width=-1),
    _sc_lang_editor::_spell_check_area(_str &word, _str &replace_word, int &col , int start_col ,int width=-1);
 ...
 * @param isMultiCursorClipboard 
 *               When -1,
 * 
 * @return Returns 0 if successful.
 * @see copy_to_clipboard
 */
int _copy_to_clipboard(_str markid="",bool isClipboard=true,bool addClipboard=false,int isMultiCursorClipboard=-1,int MarkFlags= -1),
    _sc_lang_editor::_copy_to_clipboard(_str markid="",bool isClipboard=true,bool addClipboard=false,int isMultiCursorClipboard=-1,int MarkFlags= -1);
 ...
 *                  <DT>'ka'<DD> Abort kbdmacro playback and
 *                  clear all kbdmacros.
 *                  <DT>'KA'<DD> Abort kbdmacro playback. Has no
 *                  effect on stacked recordings. Must use 'KE'
 *                  to terminate recordings.
 *                  <DT>'KB'<DD> Begin recording keyboard macro
 *                  to the keyboard macro index specified by
 *                  new_value (0..N).
 *                  <DT>'KE'<DD> End recording keyboard macro
 *                  for the keyboard macro index specified by
 *                  new_value (0..N).
 *                  <DT>'KD'<DD> Delete the last key sequence in
 *                  the all keyboard macro currently recording
 *                  or the keyboard macro index specified by
 *                  new_value (0..N). Call before calling
 *                  _macro('KE').
 *                  <DT>'KG'<DD> Get the string value for the 
 *                  keyboard macro index specified by new_value
 *                  (0..N). Call after calling _macro('KE').
 *                  <DT>'KK'<DD>Append key event to end of all
 *                  keyboard macros being recorded. new_value is
 *                  an event string ('a', name2event('ENTER'),
 *                  etc.).
 *                  <DT>'KI'<DD>Query if a keyboard macro is
 *                  recording. If new_value is null or '', true
 *                  is returned if there are any keyboard macros
 *                  recording. Otherwise, true is return if the
 *                  keyboard macro index specified by new_value
 *                  (0..N) is recording.
 *                  <DT>'KR'<DD> Query if a keyboard macro is
 *                  being played back. More specify, return true
 *                  if the next keystroke will be from a
 *                  keyboard macro. Once the last keystroke is
 *                  played back, this returns false. The
 *                  new_value argument is ignored.
 *                  <DT>'KP'<DD> Play the keyboard macro index
 *                  specified by new_index (0..N), or the
 *                  keyboard macro specified by kbdmacro_string.
 *                  If kbdmacro_string (returned by 'KG' option)
 *                  is specified, new_value is ignored
 *                  </DL>
 *                  <P>
 ...
 * @see _macro
 */
typeless _macro(_str option='M', _str new_value=null, _str kbdmacro_string=null),
    _sc_lang_editor::_macro(_str option='M', _str new_value=null, _str kbdmacro_string=null);

int _undo_status(_str option='U'),
    _sc_lang_editor::_undo_status(_str option='U');

int _pixel2col(int x),
    _sc_lang_editor::_pixel2col(int x);
 ...
 *
 */
void save_search(_str &search_string, long &flags, _str &word_re,_str &ReservedMore="",int &flags2=0),
     _sc_lang_editor::save_search(_str &search_string, long &flags, _str &word_re,_str &ReservedMore="",int &flags2=0);
 ...
 *
 */
void restore_search(_str search_string, long flags, _str word_re,_str ReservedMore=null,int flags2=0),
     _sc_lang_editor::restore_search(_str search_string, long flags, _str word_re,_str ReservedMore=null,int flags2=0);
...
int mou_col(int pixel_x),
    _sc_lang_editor::mou_col(int pixel_x);
...
int _reflow_selection(_str markid=""),
    _sc_lang_editor::_reflow_selection(_str markid="");
...
int _sort_selection(_str cmdline="",_str markid=""),
    _sc_lang_editor::_sort_selection(_str cmdline="",_str markid="");
...
void _select_match(_str markid=""),
    _sc_lang_editor::_select_match(_str markid="");
 ...
 * <DL compact>
 * <DT>'C'</DT><DD> Specifies that the selection extend as the
 * cursor moves.</DD>
 * <DT>'E'</DT><DD> (Default) Requires that _select_block be
 * executed to end the text selection.</DD>
 * <DT>'P'</DT><DD> specifies a persistent select style.  Macros
 * use this to help determine if a selection should be
 * unhighlighted when the cursor moves.</DD>
 * <DT>'I'</DT><DD> This option is ignored. For
 * backward compatibilty, BLOCK mark must be
 * initially inclusive. Use _select_type(mark,'I',0) to
 * change to non-inclusive.</DD>
 * <DT>'N'</DT><DD> This option is ignored.</DD>
 * </DL>
 *
...
int _select_block(_str markid="",_str options='E'),
    _sc_lang_editor::_select_block(_str markid="",_str options='E');

/**
 * Starts or extends the character selection specified.  Used for processin, 
 *  _sc_lang_editor::or extends the character selection specified.  Used for processing 
...
int _select_char(_str markid="",_str options='EN'),
    _sc_lang_editor::_select_char(_str markid="",_str options='EN');
...
int _select_line(_str markid="",_str options='E'),
    _sc_lang_editor::_select_line(_str markid="",_str options='E');

/**
 * Places cursor on first character of selection specified, 
 *  _sc_lang_editor::cursor on first character of selection specified. 
 ...
 * @param markid
 * @param LockSelection
 *                   When true, the selection is extended to the cursor and the
 *                   select is locked (moving the cursor will no longer remove or
 *                   extend the selection).
 * @param RestoreScrollPos
 *                   When true, the cursor y and left edge scroll positions are
 *                   restored if possible (window size could be smaller and y
 *                   be outsize window height).
 * @param beginPivot When non-zero, go to the start pivot of the
 *                   selection. When beginPivot==2, also
 *                   swap the begin/end pivot.
 * 
 ...
 */
int _begin_select(_str markid="",bool LockSelection=true,bool RestoreScrollPos=true,int beginPivot=0),
    _sc_lang_editor::_begin_select(_str markid="",bool LockSelection=true,bool RestoreScrollPos=true,int beginPivot=0);
 ...
 *                         restored if possible (window size could be smaller and y
 *                         be outsize window height).
 * @param endPivot   When true, go to the end opposit the pivot
 *
 * @return Returns 0 if successful.  Possible return values are TEXT_NOT_SELECTED_RC or
 *         INVALID_SELECTION_HANDLE_RC.  On error, message is displayed.
 *
 ...
 * @categories Edit_Window_Methods, Editor_Control_Methods, Selection_Functions
 */
int _end_select(_str markid="",bool LockSelection=true,bool RestoreScrollPos=true,bool endPivot=false),
    _sc_lang_editor::_end_select(_str markid="",bool LockSelection=true,bool RestoreScrollPos=true,bool endPivot=false);
...
int _shift_selection_left(_str markid=""),
    _sc_lang_editor::_shift_selection_left(_str markid="");
...
int _shift_selection_right(_str markid=""),
    _sc_lang_editor::_shift_selection_right(_str markid="");
 ...
 * selection is always on destination text.<p>
 * 
 * @appliesTo Edit_Window, Editor_Control
 * @categories Edit_Window_Methods, Editor_Control_Methods, Selection_Functions
 * @param markid       source select id
 * @param MarkFlags    VSMARKFLAG_*
 * 
 * @return Returns 0 if successful.  Common return codes are
...
int _copy_to_cursor(_str markid="",int MarkFlags=-1),
    _sc_lang_editor::_copy_to_cursor(_str markid="",int MarkFlags=-1);
...
int _adjust_block_selection(_str markid=""),
    _sc_lang_editor::_adjust_block_selection(_str markid="");

/**
 * Overwrites block selection specified at cursor position.  No clipboard i, 
 *  _sc_lang_editor::block selection specified at cursor position.  No clipboard is 
 * created.  Resulting selection is placed on inserted text.
 * 
 * @appliesTo Editor_Control, Edit_Window
 * @categories Edit_Window_Methods, Editor_Control_Methods, Selection_Functions
 * @param markid
 * @param MarkFlags When set to
 *                  VSMARKFLAG_BLOCK_INCLUDE_REST_OF_LINE,
 *                  source will include all text to end of
 *                  line.
 * @param overlay_markid  Optionally specifies text to be 
 *                        overlayed. This parameter is ignored
 *                        if overlay_markid has no selection,
 *                        buffer does not match destination, or
 *                        does not specify a proportional font
 *                        selection. This is only useful when
 *                        the the original selection was copied
 *                        to another source file (or temp view).
 *                        See sort_within_selection for an
 *                        example where this parameter is
 *                        useful.
 * 
 * @return Returns 0 if successful.  Common return codes are
 *         TEXT_NOT_SELECTED_RC, BLOCK_SELECTION_REQUIRED_RC.  On error, message is
 *         displayed.
 */
int _overlay_block_selection(_str markid="",int MarkFlags= -1,_str overlay_markid),
    _sc_lang_editor::_overlay_block_selection(_str markid="",int MarkFlags= -1,_str overlay_markid);
 ...
 * @appliesTo Edit_Window, Editor_Control
 * @categories Edit_Window_Methods, Editor_Control_Methods, Selection_Functions
 * @param markid    is a handle to a selection returned by one
 *                  of the built-ins _alloc_selection or
 *                  _duplicate_selection.  A mark_id of '' or
 *                  no mark_id parameter identifies the active
 *                  selection.
 * @param MarkFlags   When set to 
 *                    VSMARKFLAG_BLOCK_INCLUDE_REST_OF_LINE,
 *                    source will include all text to end of
 ...
 *         INVALID_SELECTION_HANDLE_RC.  On error, message is displayed.
 */
int _move_to_cursor(_str markid="",int MarkFlags = -1),
    _sc_lang_editor::_move_to_cursor(_str markid="",int MarkFlags = -1);
...
int _begin_select_compare(_str markid=""),
    _sc_lang_editor::_begin_select_compare(_str markid="");
...
int _end_select_compare(_str markid=""),
    _sc_lang_editor::_end_select_compare(_str markid="");
...
void _next_buffer(_str options=""),
    _sc_lang_editor::_next_buffer(_str options="");
...
void _prev_buffer(_str options=""),
    _sc_lang_editor::_prev_buffer(_str options="");
 ...
 */
void _delete_buffer(),
    _sc_lang_editor::_delete_buffer();
 ...
 *    <DT>'V'
 *    <DD>Same 'C' option except this option avoids doing an
 *    undo such that the buffer goes from not having a selection
 *    to having a selection. This would put Vim in Visual mode
 *    which is annoying to Vim users.
 *    <DT>'R'
...
void _undo(_str option="U"),
     _sc_lang_editor::_undo(_str option="U");
 ...
 */
void _delete_char(int wrapFlags=0),
    _sc_lang_editor::_delete_char(int wrapFlags=0);
 ...
 *
 */
void _rubout(int wrapFlags=0),
    _sc_lang_editor::_rubout(int wrapFlags=0);
 ...
 * @see down
 */
int up(int Noflines=1,bool doScreenLines=false),
    _sc_lang_editor::up(int Noflines=1,bool doScreenLines=false);
 ...
 * @categories CursorMovement_Functions, Edit_Window_Methods, Editor_Control_Methods
 */
int down(int Noflines=1,bool doScreenLines=false),
    _sc_lang_editor::down(int Noflines=1,bool doScreenLines=false);
...
int search_replace(_str replace_string,_str option=""),
    _sc_lang_editor::search_replace(_str replace_string,_str option="");
...
int repeat_search(_str options,int start_col=0),
    _sc_lang_editor::repeat_search(_str options,int start_col=0);
...
int search(_str searchString,_str options="E",_str replaceString=null,int &Nofchanges=0),
    _sc_lang_editor::search(_str searchString,_str options="E",_str replaceString=null,int &Nofchanges=0);

int replace(_str searchString, _str replaceString, _str options='E'),
    _sc_lang_editor::replace(_str searchString, _str replaceString, _str options='E');
 ...
 * is returned.
 *
 * <p>The ['S'][0..N] parameter is used to return a match length or a start
 * buffer position of a tagged expression.  Specifying 'S' followed by a tagged
 * expression number (i.e. 'S0') will return the start buffer position of
 ...
 * expression number (such as '0') will return the match length of that group.  0 is
 * returned if that tagged expression was not found. For Perl and Vim regular expressions,
 * the first auto generated tagged expression number is 1.</p>
 *
 * @example
 * <pre>
 ...
 *              return(status);
 *         }
 *         // First tagged expression is 0 for SlickEdit syntax.
...
int match_length(_str option=""),
    _sc_lang_editor::match_length(_str option="");
 ...
 * </pre>
 */
_str get_text(int count=1,long seek_pos=-3),
    _sc_lang_editor::get_text(int count=1,long seek_pos=-3);
 ...
 * @categories Edit_Window_Methods, Editor_Control_Methods
 */
_str get_text_raw(int count=1,long seek_pos=-3),
    _sc_lang_editor::get_text_raw(int count=1,long seek_pos=-3);

/**
 * This function is identical to the <b>{@link get_text}</b> function,
 * except that it returns the buffers new line characters if the
 * cursor is in virtual space past the end of line characters.
 *
 * @appliesTo Edit_Window, Editor_Control
 * @categories Edit_Window_Methods, Editor_Control_Methods
 */
_str get_text_safe(int count=1,long seek_pos=-3),
    _sc_lang_editor::get_text_safe(int count=1,long seek_pos=-3);
 ...
 * @categories Edit_Window_Methods, Editor_Control_Methods
 */
bool past_end_of_line(bool moveToEndIfPast = false),
    _sc_lang_editor::past_end_of_line(bool moveToEndIfPast = false);


_str GetRText(int count,int seek_pos=-3),
    _sc_lang_editor::GetRText(int count,int seek_pos=-3);
_str GetRTextRaw(int count,int seek_pos=-3),
    _sc_lang_editor::GetRTextRaw(int count,int seek_pos=-3);
...
void insert_line(_str line),
    _sc_lang_editor::insert_line(_str line);
...
void insert_line_raw(_str line),
    _sc_lang_editor::insert_line_raw(_str line);
...
void get_line(_str &line),
    _sc_lang_editor::get_line(_str &line);
...
void get_line_raw(_str &line),
    _sc_lang_editor::get_line_raw(_str &line);
...
void replace_line(_str line),
    _sc_lang_editor::replace_line(_str line);
...
void replace_line_raw(_str line),
    _sc_lang_editor::replace_line_raw(_str line);
 ...
 * <pre>
 *      {<i>filespec</i>  | ['-' | '+' option_letters] {-wc wcfiles} {-exclude exfiles}}
 * </pre>
 *
 ...
 * <dt>Z</dt><dd>Treat Zip files as directories of files.</dd>
 * </dl>
 *
 ...
 * </pre> 
 * 
 * @param exfiles may contain ant-like wild cards. ** represents 
 *                0 or more path parts. * represents
 *                exactly one path part.
 * <pre> 
 *    Example
 *       -exclude junk*.cpp junk*.h
 *       -exclude **\backup\**   -- Exclude backup directory
 *       -exclude **\backup\     -- Exclude backup directory
 *       -exclude **\backup\*\dir1\**
 *       -exclude backup\        -- (need +t) Exclude backup directory
 * </pre> 
 *
 * @return Returns 0 if successful.  Common return codes are:
 * <ul>
...
int insert_file_list(_str cmdline),
    _sc_lang_editor::insert_file_list(_str cmdline);
 ...
 */
void _insert_toggle(),
    _sc_lang_editor::_insert_toggle();
...
void _insert_state(_str mode="",_str set_default=""),
    _sc_lang_editor::_insert_state(_str mode="",_str set_default="");

/**
 * This function returns information about the process running depending
 * upon the option given.
 * 
 * @see concur_shell
 * @see _stop_process
 * 
 ...
 * @param option 
 *  
 * <i>option</i> may be one of the following values:
 * <dl>
 ...
 * If the current line is not reading input for a concurrent 
 * process, 0 is returned.</dd> 
 * <dt>'B'</dt><dd>Returns 1 if the current buffer has a 
 * process running in it. Otherwise 0 is returned.</dd> 
 * <dt>'E'</dt><dd>Gets and/or sets the "Send input on Enter".
 * When 0, a line of input is read one line at a time and sent 
 * to the process giving the process a chance to process the 
 * line and return output. When non-zero, input is only sent to 
 * the process when the 'R' option is explicitly specified. 
 * </dd> 
 * <dt>'H'</dt><dd>Returns 1 if the current line is reading 
 * input for a hidden password for a pseudo TTY. Otherwise, 0 
 * is returned.</dd> 
 * <dt>'K'</dt><dd>(Unix and macOS only) Returns 0. Sends 
 * backspace to pseudo TTY.</dd> 
 * <dt>'P'</dt><dd>(Unix and macOS only) Returns process id of 
 * process running in buffer.</dd> 
 * <dt>'Q'</dt><dd>Forcefully terminates the process running in 
 * the process buffer.</dd> 
 ...
 * the build window has exited. Otherwise 0 is returned. A 
 * delay is performed and pending build window output is read 
 * into the build window.</dd> 
 * </dl>
 * 
 * 
 * @param idname  Specifies a specific concurrent process to 
 * apply option to. This arguments is only supported by 
 * supported by 'R', 'X', 'Q', 'L', and 'S' options. 
 *  
 * @param value  Specifies a new value for option. 
 * Currently, only the  'L' option supports this argument.
 * 
 * @return
 * 
 */
int _process_info(_str option="",_str idname="", _str value="");
...
int text_col(_str string,int column=0,_str option="L"),
    _sc_lang_editor::text_col(_str string,int column=0,_str option="L");
...
_str expand_tabs(_str string,int start=1,int count=-1,_str option='E'),
    _sc_lang_editor::expand_tabs(_str string,int start=1,int count=-1,_str option='E');
...
_str set_scroll_pos(int left_edge,int cursor_y),
     _sc_lang_editor::set_scroll_pos(int left_edge,int cursor_y);
...
int block_was_read(int newValue=-1),
    _sc_lang_editor::block_was_read(int newValue=-1);
 ...
 *
 * <p>Specify 'S' for <i>option</i> to return just the offset to
 * the cursor. Unlike the _QROffset function, the offset 
 * returned includes no save lines.
 *
...
typeless point(_str option="P"),
    _sc_lang_editor::point(_str option="P");
...
int goto_point(_str text_pos,int linenum=-1),
    _sc_lang_editor::goto_point(_str text_pos,int linenum=-1);
 ...
 * Default is off.  Old line numbers are used to better handle 
 * going to an error line after lines have been inserted or 
 * deleted. We don't recommend setting the old line numbers on 
 * every save because this requires that you do not save the 
 * file until you have performed edits for all compile or 
 * multi-file search messages.  See 
...
int _save_file(_str cmdline=""),
    _sc_lang_editor::_save_file(_str cmdline="");
 ...
 * This is the fastest way to count the number of lines in
 ...
 *
 * <dt>+T [<i>buf_name</i>]</dt><dd>Start a default operating system format temp buffer
 * with name <i>buf_name</i>.</dd>
 *
 * <dt>+TU [<i>buf_name</i>]</dt><dd>Start a UNIX format temp buffer with name
 * <i>buf_name</i>. +TNU indicates that <i>buf_name</i> is an internal name and
 * should not be converted to absolute. </dd>
 *
 * <dt>+TM [<i>buf_name</i>]</dt><dd>Start a MACINTOSH format temp buffer with name
 * <i>buf_name</i>.</dd>
 *
 * <dt>+TD [<i>buf_name</i>]</dt><dd>Start a DOS format temp buffer with name
 * <i>buf_name</i>.</dd>
 *
 * <dt>+T<i>nnn</i></dt><dd>Start a temp buffer where <i>nnn</i> is the decimal value
 * of the character to be used as the line separator character..</dd>
 *
 * <dt>+FU [<i>buf_name</i>]</dt><dd>Use &lt;LF&gt; for the line
 ...
 * ending interpretation for existing files.</dd> 
 *
 * <dt>+FN<i>nnn [<i>buf_name</i>]</i></dt><dd>SBCS/DBCS mode. 
 * Use <i>nnn</i> as the decimal value for the line separator 
 ...
 * "slick.sh."</dd>
 *
 * <dt>+FAUTOTEXT</dt><dd> If the file has a standard Unicode signature, 
 * open the file as a Unicode file. Otherwise if the default encoding 
 * is Utf-8, open the file as Utf-8. Otherwise, open the file as SBCS/DBCS data.
 *
 * <dt>+FAUTOXML</dt><dd> Unicode mode. Open XML file. If the file has a standard 
 * Unicode signature, open the file as a Unicode file. Otherwise, the encoding is determined
 ...
 * consistent with XML standards.</dd>
 *
 * <dt>+FAUTOUNICODE</dt><dd>Same as +FAUTOTEXT</dd> 
 *  
 * <dt>+FAUTOUNICODEUTF8</dt><dd> If the file has a standard Unicode signature, 
 * open the file as a Unicode file. Otherwise open the file as Utf-8.
 *
 * <dt>+FAUTOUNICODE2</dt><dd>If the file has a standard Unicode signature
 * or "looks" like a Unicode file, open the file as a Unicode file. Otherwise if the default encoding 
 * is Utf-8, open the file as Utf-8. Otherwise, open the file as SBCS/DBCS data.
 * This option is NOT full proof and may give incorrect
 * results.</dd> 
 *  
 * <dt>+FAUTOUNICODE2UTF8</dt><dd>If the file has a standard Unicode signature
 * or "looks" like a Unicode * file, open the file as a Unicode file. Otherwise 
 * open the file as Utf-8. This option is NOT full proof and may give incorrect
 * results.</dd>
 *
 * <dt>+FAUTOEBCDIC</dt><dd>If the file "looks" like an EBCDIC file, open the file
 * as an EBCDIC file. Otherwise if the default encoding is Utf-8, open the file 
 * as Utf-8. Otherwise, open the file as SBCS/DBCS data. This option is NOT
...
int load_files(_str options),
    _sc_lang_editor::load_files(_str options);
 ...
 * </pre>
 */
int _BufLoad(_str filename,_str options=null,bool CreateIfNotFound=true,int &BLResultFlags=0),
    _sc_lang_editor::_BufLoad(_str filename,_str options=null,bool CreateIfNotFound=true,int &BLResultFlags=0);


/**
 * Creates a build window running in the current buffer.
 * 
 * 
 * @param command  If <i>command</i> is an empty string ('')
 * then the default command processor is started.  The default
 * command processor is defined by the COMSPEC (UNIX: SHELL)
 * environment variable.  Otherwise <i>command</i> contains the
 * program name and arguments to be executed as a concurrent
 * process.
 * 
 * @param idname is a unique name identifing the process buffer 
 *   instance. The idname of the Build window process buffer 
 *    always ''.
 * 
 * @param supty   Indicates whether to use a PSuedo pty. This
 *                argument is currently only supported by
 *                interactive shells. Specify -1 for default, 0
 *                for pipe, 1 for Psuedo pty.
 *
 ...
 * @categories File_Functions
 */
int concur_shell(_str cmdline,_str idname='',int supty=-1);
...
void _refresh_scroll(),
    _sc_lang_editor::_refresh_scroll();
...
void get_command(_str &text,int &start_sel=0,int &end_sel=0,_str &prompt=""),
    _sc_lang_text_box::get_command(_str &text,int &start_sel=0,int &end_sel=0,_str &prompt="");
...
void set_command(_str command_text,int start_sel=-1,int end_sel=-1,_str prompt=null),
    _sc_lang_text_box::set_command(_str command_text,int start_sel=-1,int end_sel=-1,_str prompt=null);
...
int _get_sel(int &start_pos=0,int &end_pos=0),
    _sc_lang_text_box::_get_sel(int &start_pos=0,int &end_pos=0);
...
void _set_sel(int start_pos,int end_pos=start_pos),
    _sc_lang_text_box::_set_sel(int start_pos,int end_pos=start_pos);
 ...
 */
void _retrieve_prev(),
    _sc_lang_control::_retrieve_prev();
 ...
 */
void _retrieve_next(),
    _sc_lang_control::_retrieve_next();
 ...
 *
 */
void _setEnabled(int tabIndex, bool enabled),
     _sc_lang_sstab::_setEnabled(int tabIndex, bool enabled);
...
int _xyHitTest(int x, int y),
    _sc_lang_sstab::_xyHitTest(int x, int y);
 ...
 *
 */
bool _getTabInfo(int tabIndex, SSTABCONTAINERINFO& info),
        _sc_lang_sstab::_getTabInfo(int tabIndex, SSTABCONTAINERINFO& info);
...
int _getActiveWindow(),
    _sc_lang_sstab::_getActiveWindow();
...
void _SetListColInfo(int index,int width=0,int flags=0,int state=0),
     _sc_lang_list_box::_SetListColInfo(int index,int width=0,int flags=0,int state=0);
...
void _SetListColCaption(int index,_str caption),
     _sc_lang_list_box::_SetListColCaption(int index,_str caption);
...
void _GetListColInfo(int index,int &width,int &flags=0,int &state=0),
    _sc_lang_list_box::_GetListColInfo(int index,int &width,int &flags=0,int &state=0);
...
_str _GetListColCaption(int index),
     _sc_lang_list_box::_GetListColCaption(int index);
...
int _find_longest_line(),
    _sc_lang_editor::_find_longest_line();
 ...
 * @categories Miscellaneous_Functions
 */
_str _assert(bool condition, _str msg=null);
 ...
 * @categories File_Functions
 */
bool _file_eq(_str file1, _str file2);
 ...
 * expression number (i.e. 'S0') will return the start position of that
 ...
 * will return the match length of the group.  For SlickEdit
 * regular expressions, the first tagged expression is 0.
 * For Perl and Vim regular expressions, the first tagged expression is 1. 0
 * is returned if that tagged expression was not found.  A
 ...
 * @categories String_Functions
 */
_str translate(_str string,_str output_table,_str input_table,_str pad="",int compliment=0,bool binary=false);
/**
 ...
 * @categories Window_Functions
 */
CTL_FORM _load_template(int index_or_wid, int parent, _str options, ...);
...
/**
 * Compile a list of Slick-C modules using the Slick-C compiler.
 * 
 * @param modules  Space-separated list of modules to compile
 * @param async    Build modules asynchronously? 
 *                 This spawns multiple instances of the macro compiler. 
 * 
 * @return 0 on success, &lt;0 on error. 
 *  
 * @categories Miscellaneous_Functions
 */
int _make(_str modules, bool async=false);
/**
 * Reserved word.
 *
 * @categories Miscellaneous_Functions
 ...
 *   <DT>9        <DD>Case insensitive prefix matching
 *   <DT>DIR_SIZE_COL
 *   <DT>DIR_SIZE_WIDTH
 *   <DT>DIR_DATE_COL
 *   <DT>DIR_DATE_WIDTH
...
int eventtab_index(int root_keys_index, int mode_keys_index, int key_index,_str option=""),
    _sc_lang_editor::eventtab_index(int root_keys_index, int mode_keys_index, int key_index,_str option="");
...
void set_eventtab_index( int eventtab_index, int key_index, int index,int key_index2=VSEV_NULL),
    _sc_lang_editor::set_eventtab_index( int eventtab_index, int key_index, int index,int key_index2=VSEV_NULL);
...
int eventtab_inherit(int etab_index, int new_etab_index=-1),
    _sc_lang_editor::eventtab_inherit(int etab_index, int new_etab_index=-1);
 ...
 *
 */
bool isnumber(_str number);
/**
 * @return Returns <b>true</b> if <i>string</i> is a valid signed or
 * unsigned integer. Returns true for integers up to 64-bits. If
 * <i>string</i> is floating point number, 0 is returned.
 *
 * @categories String_Functions
 *
 */
bool isinteger(_str string);
 ...
 *
 */
bool _IsEventPending(int flags);
 ...
 *
 */
int _strBeginChar(_str string,int col,int &charLen=0,bool beginComposite=true);
 ...
 * @categories String_Functions
 */
bool _dbcsIsLeadByte(_str ch);
/**
 * @return  Returns <b>true</b> if the character at <i>i</i> in string is
 ...
 * @categories String_Functions
 */
bool _dbcsIsStartOfDBCS(_str &string, int i);
 ...
 *
 */
void process_events(bool &cancel,_str options="");
/**
 ...
 *    <dt><b>9</b> <dd>Case insensitive prefix matching
 *    </dl>
 * 
 ...
 *                 <DT>VSOPTION_MAX_STACK_DUMP_ARGUMENT_NOFLINES</DT><DD>int. When you call _dump_var, there is a limit to the number of lines that will be dumped.  Use this to change the limit.
 *                 </DL>
 * @param newValue
 *
 ...
 * @example
 * <pre>
 * // 'E' - Find edited forms only | 'N'-Find non-edited forms only
 * int _find_formobj(form_name, _str option="")
 * {
 ...
 * event. 
 * 
 * @param exclude_mouse_moves When true, mouse moves are not
 *                            considered in idle time elasped.
 *
 * @categories Miscellaneous_Functions
 *
 */
long _idle_time_elapsed(bool exclude_mouse_moves=false);
void _reset_idle();
...
_str _scroll_page(_str option="",int value=p_char_height),
     _sc_lang_editor::_scroll_page(_str option="",int value=p_char_height);
/**
 ...
 * style."  For other platforms, the format is settable
 * under "Appearance -> General -> Time display style."
 * defined.</dd>
 *  
...
int _insert_font_list(_str options="S",_str font_name=""),
    _sc_lang_editor::_insert_font_list(_str options="S",_str font_name="");
 ...
 *         returned.
 */
_str _clipboard_format(_str format,bool isClipboard=true);
 ...
 */
int _clipboard_empty(bool isClipboard=true);
 ...
 *  0 Turn mode off.
 *  1 Turn mode on. When on, mouse button press, and mouse move events are returned by get_event() and test_event().
 *  2 Same as 1 but also get events for WHEEL_UP and WHEEL_DOWN
 * </pre>
 *
...
/**
 * Fills the selection specified with <i>character</i>. 
 * 
 * @appliesTo Edit_Window, Editor_Control
 * @categories Selection_Functions
 * @param ch
 * @param mark_id
 * <i>mark_id</i> is a handle to a selection returned by one of 
 * the built-ins 
 ...
 * @param markflags  Maybe be -1 for default flags. One or more 
 *                   of the flags VSMARKFLAG_FILL_NO_FILL and
 *                   VSMARKFLAG_FILL_INSERT_ONCE.
 * 
 * @return Returns 0 if successful.  Otherwise, TEXT_NOT_SELECTED_RC is
 *         returned.
 */
int _fill_selection(_str ch,_str mark_id="",int markflags=-1),
    _sc_lang_editor::_fill_selection(_str ch,_str mark_id="",int markflags=-1);
...
int _delete_selection(_str mark_id=""),
    _sc_lang_editor::_delete_selection(_str mark_id="");
...
int _show_selection(_str mark_id=""),
    _sc_lang_editor::_show_selection(_str mark_id="");
...
int _alloc_selection(_str option=""),
    _sc_lang_editor::_alloc_selection(_str option="");
...
int _duplicate_selection(_str markid=null),
    _sc_lang_editor::_duplicate_selection(_str markid=null);
...
void _free_selection(_str markid),
    _sc_lang_editor::_free_selection(_str markid);
...
void _deselect(_str markid=""),
    _sc_lang_editor::_deselect(_str markid="");
 ...
 *
 * @param option may be 'T', 'S', 'P', 'I', 'U', 'A'
 *
 ...
 *
 * <p>When a value of 'A' is specified for <i>option</i>, a '1'
 * is returned if columns are adjusted for the selection 
 * specified. Otherwise, '0' is returned. This option is only 
 * supported for CHAR type selections. This option is new in 
 * v19. Column adjusing occurs on calls like _insert_text() and
 * _delete_text().
 * </p> 
 * 
 *
...
int _select_type(_str markid="",_str option='T',_str newValue=null),
    _sc_lang_editor::_select_type(_str markid="",_str option='T',_str newValue=null);
...
int _get_reflow_pos(int &Noflines_down,int &col),
    _sc_lang_editor::_get_reflow_pos(int &Noflines_down,int &col);
 ...
 * @param store_new_setting  When true, new scroll style
 *                           settings are stored in the
 *                           "misc.options" profile.
 *
 * @categories CursorMovement_Functions
 *
 */
_str _scroll_style(_str newScrollStyle=null,bool store_new_setting=true),
     _sc_lang_editor::_scroll_style(_str newScrollStyle=null,bool store_new_setting=true);
 ...
 *  
 * @param filename   file name (or base file name) to search for 
 * @param env_var    name of environment variable to use for search path
 * @param options    is a string of zero or more of the following:
 * <dl compact>
 ...
 * UNIX.</dd>
 * <dt>'V'</dt><dd>indicates that contains a search path value 
 *                 rather than an environment variable name</dd>
 * <dt>'R'</dt><dd>relative path search. Append filename to each
 * possible path to look for a match.</dd>
 * </dl>
 * @param dotExtList space delimited list of file extensions to search for
 *  
 * @example
 * <pre>
 ...
 * macro
 * name=path_search('options.ini');  // Find ini file
 * </pre>
 *
 * @categories File_Functions
 *
 ...
 * @param resolveSymLinks  When true, symbolic links are fully
 *                         resolved. Note that on windows,
 *                         symbolic link support must be enabled
 *                         with a command line argument. It's
 *                         disable by default since it can
 *                         effect performance badly on slow
 *                         networks.
 *
 ...
 * @categories File_Functions
 */
_str absolute(_str filename,_str toDir=null,bool resolveSymLinks=false);
/**
 ...
 *
 */
_str relative(_str filename,_str toDir=null,bool addDotDots=true);
/**
 ...
 *
 */
_str last_event(_str newEvent=null, bool keysOnly=false);
/**
 ...
 * </pre> 
 * 
 * @param set_defaults  When true, the cursor_shapce and
 *                      vertical_cursor properties are set.
 *
 * @categories Miscellaneous_Functions
 *
 * @return   */
_str _cursor_shape(_str cmdline=null,bool set_defaults=true);
/**
 ...
 * of "vslick.sta" to be kept in memory.
 * -1 specifies no limit. The -ST invocation option may
 * be used to specify the state cache size.  Modifying the state 
 * cache size may not take effect until the editor is reinvoked. 
 * When you specify 0 as the argument to the -ST invocation , 
 * this specifies to preload the entire state file and close the 
 * file handle. This function does NOT support the "-ST 0" 
 * feature. 
 *
 ...
 *  
 * @param  idname Unique name identifing the process buffer
 * instance. The idname of the Build window process buffer
 * always ''.
 * 
 * @see concur_shell
 ...
 *
 */
void _stop_process(_str idname='');
/**
 ...
 * machine. Returns 'MACOSX11' if running under macOS on a
 * PowerPC.
 * <ul>
 ...
 * <li>"MACOSX"       -- Native macOS 
 * <li>"MACOSX11"     -- macOS under X11
 * </ul>
 *
 * @see _win32s
 * @see machine_bits 
 ...
 *             symlinks resolved
 *    <li>9 -- Case insensitive prefix matching.
 *    </ul>
 *
 * @example
 * <pre>
 ...
 * @categories Miscellaneous_Functions
 */
_str _default_font(int FontIndex,_str font="");
...
void _BookmarkRestore(int vsbmflags=-1),
    _sc_lang_editor::_BookmarkRestore(int vsbmflags=-1);
...
void _BookmarkRemove(int i,int free_markid=1),
    _sc_lang_editor::_BookmarkRemove(int i,int free_markid=1);
...
void _BookmarkAdd(_str BookmarkName,
    ...
    _sc_lang_editor::_BookmarkAdd(_str BookmarkName,
                  int markid,
                  int vsbmflags=VSBMFLAG_SHOWNAME|VSBMFLAG_STANDARD,
                  int RealLineNumber=-1,
                  int col=0,
...
int _BookmarkGetInfo(int i,
    ...
    _sc_lang_editor::_BookmarkGetInfo(int i,
                     _str &BookmarkName=0,
                     int &markid=0,
                     int &vsbmflags=0,
                     int &buf_id=0,
...
int _BookmarkFind(_str BookmarkName,int vsbmflags=VSBMFLAG_STANDARD),
    _sc_lang_editor::_BookmarkFind(_str BookmarkName,int vsbmflags=VSBMFLAG_STANDARD);
 ...
 */
int _BookmarkQCount(),
    _sc_lang_editor::_BookmarkQCount();
 ...
 * to set color. While the number of colors that can be
 * allocated is limited to an signed integer, only colors with
 * an index below 65536 are usable due to limits else where.
 *
 * @param fg_color   foreground color (RGB)
 * @param bg_color   background color (RGB)
 * @param font_flags is one of the following font flags:
...
int _AllocColor(int fg=0x000000, int bg=0xffffff, int fontFlags=0, int parent_color=0),
    _sc_lang_editor::_AllocColor(int fg=0x000000, int bg=0xffffff, int fontFlags=0, int parent_color=0);
...
void _FreeColor(int cfg),
    _sc_lang_editor::_FreeColor(int cfg);
...
int _InheritColor(int cfg, int parent_color=0),
    _sc_lang_editor::_InheritColor(int cfg, int parent_color=0);
 ...
 * @see _default_color
 */
int _SetTextColor(int ColorIndex, int Nofbytes,bool replacePreviousColor=true),
    _sc_lang_editor::_SetTextColor(int ColorIndex, int Nofbytes,bool replacePreviousColor=true);
 ...
 *                  <LI>CFG_MARKDOWN_LINK2
 *                  <LI>CFG_MARKDOWN_BULLET
 *                  <LI>CFG_MARKDOWN_EMPHASIS
 *                  <LI>CFG_MARKDOWN_EMPHASIS2
 *                  <LI>CFG_MARKDOWN_EMPHASIS3
 *                  <LI>CFG_MARKDOWN_EMPHASIS4
 *                  <LI>CFG_CSS_ELEMENT
 *                  <LI>CFG_CSS_CLASS
 *                  <LI>CFG_CSS_PROPERTY
 *                  <LI>CFG_CSS_SELECTOR
 *                  <LI>CFG_YAML_TEXT_COLON
 *                  <LI>CFG_YAML_TEXT
 *                  <LI>CFG_YAML_TAG
 *                  <LI>CFG_YAML_DIRECTIVE
 *                  <LI>CFG_YAML_ANCHOR_DEF
 *                  <LI>CFG_YAML_ANCHOR_REF
 *                  <LI>CFG_YAML_PUNCTUATION
 *                  <LI>CFG_YAML_OPERATOR
 *                  </UL>
 *  
...
int _clex_find(int clexflags,_str options="O"),
    _sc_lang_editor::_clex_find(int clexflags,_str options="O");



/**
 * Loads color coding lexer profile specified.
 * 
 * Color coding lexer profiles are in the path
 * "colorcoding_profiles" (VSCFGPACKAGE_COLORCODING_PROFILES).
 *
 * @return  Returns 0 if successful.
 *
 * @see _clex_find
 ...
 * @categories File_Functions
 */
int _clex_load(_str profileName),
    _sc_lang_editor::_clex_load(_str profileName);
...
int _copy_color_coding_to_clipboard(_str format, _str markid=""),
    _sc_lang_editor::_copy_color_coding_to_clipboard(_str format, _str markid="");
...
int _col_width(int column,int width=-3),
    _sc_lang_editor::_col_width(int column,int width=-3);
...
int _spell_insert_suglist(_str word=""),
    _sc_lang_list_box::_spell_insert_suglist(_str word="");
...
void _insert_drive_list(),
    _sc_lang_list_box::_insert_drive_list();

/**
 * Insert the Slick-C&reg; stack dump into the list
 */
void _StackInsertList(int ignoreNStackItems=0),
     _sc_lang_list_box::_StackInsertList(int ignoreNStackItems=0);
 ...
 * Menu item is inserted before position.  The first menu item 
 * position is 0.  Specify -1 or a position greater than the 
 * last menu item to insert after the last menu item. 
 *
 ...
 *
 */
int _menu_show(int menu_handle, int vpm_flags=VPM_LEFTBUTTON|VPM_LEFTALIGN,int x=0, int y=0);
...
int _TreeGetIndexFromLineNumber(int LineNumber),
    _sc_lang_tree_view::_TreeGetIndexFromLineNumber(int LineNumber);
 ...
 *
 * <dl>
 * <dt>TREE_ADD_BEFORE</dt><dd>Add this item before the item specified.</dd>
 * <dt>TREE_ADD_AS_CHILD</dt><dd>Add this item after last child of
 *       the item specified by <i>ItemIndex</i>.</dd>
 * <dt>TREE_ADD_SORTED_CS</dt><dd>Add this item sorted case sensitive.</dd>
 * <dt>TREE_ADD_SORTED_CI</dt><dd>Add this item sorted case insensitive.</dd>
 * <dt>TREE_ADD_SORTED_FILENAME</dt><dd>Add this item sorted by filename.</dd>
 * <dt>TREE_OVERLAY_BITMAP1</dt><dd>Use the overlay bitmap index.
 *       Otherwise, 'overlayBitmapIndex' is ignored.</dd>
 * </dl>
 *
 * @param overlayBitmapIndex  Names table index to a picture which gets 
 *                            overlayed on top of the 'bitmapIndex' picture.
 *                            This is only used if (flags & TREE_OVERLAY_BITMAP1) != 0,
 *                            otherwise it is ignored.
 *
 * @param bitmapIndex   Names table index to a picture which gets displayed to
 *                      the left of the caption text.
 *
 * @param ShowChildren  Indicates whether to show the children of this node. 
 *                      TREE_NODE_COLLAPSED specifies not to show the children.
 *                      Specify TREE_NODE_EXPANDED to initially show children of this node. 
 ...
 * @categories Tree_View_Methods
 */
int _TreeAddItem(int ItemIndex, 
                 _str caption,
                 int flags=0, 
                 int overlayBitmapIndex=0,
                 int bitmapIndex=0, 
                 int ShowChildren=TREE_NODE_EXPANDED,
                 int moreFlags=0, 
                 typeless userInfo=0),
    _sc_lang_tree_view::_TreeAddItem(int ItemIndex,
                                     _str caption,
                                     int flags=0, 
                                     int overlayBitmapIndex=0,
                                     int bitmapIndex=0, 
...
int _TreeIndexIsValid(int index),
    _sc_lang_tree_view::_TreeIndexIsValid(int index);
 ...
 */
void _TreeRefresh(),
    _sc_lang_tree_view::_TreeRefresh();
 ...
 */
void _TreeBottom(),
    _sc_lang_tree_view::_TreeBottom();
 ...
 */
int _TreeCurIndex(),
    _sc_lang_tree_view::_TreeCurIndex();
...
void _TreeSetUserInfo(int ItemIndex, typeless info),
    _sc_lang_tree_view::_TreeSetUserInfo(int ItemIndex, typeless info);
...
typeless _TreeGetUserInfo(int ItemIndex),
    _sc_lang_tree_view::_TreeGetUserInfo(int ItemIndex);
 ...
 * @param overlayBitmapIndexes Array of bitmap indexes, [0] is drawn 
 ...
 * @see _TreeSetUserInfo
 * @see _TreeGetUserInfo 
 * @see _TreeSetCurFlags 
 * @see _TreeGetCurFlags 
 * @see _TreeSetOverlayBitmaps 
 * @see _TreeGetOverlayBitmaps 
 *
 * @appliesTo Tree_View
 * @categories Tree_View_Methods
 */
void _TreeSetInfo(int ItemIndex, int ShowChildren,
                  ...
                  int flagMask=-1, int (&overlayBitmapIndexes)[]=null),
    _sc_lang_tree_view::_TreeSetInfo(int ItemIndex, int ShowChildren,
                  int NonCurrentBMIndex=-1, int CurrentBMIndex=-1,
                  int moreFlags=0,int setCurrentNodeIfHidden=1,
                  int flagMask=-1, int (&overlayBitmapIndexes)[]=null);
...
void _TreeGetInfo(int ItemIndex, int &ShowChildren,
    ...
    _sc_lang_tree_view::_TreeGetInfo(int ItemIndex, int &ShowChildren,
                  int &NonCurrentBMIndex=0, int &CurrentBMIndex=0,
                  int &moreFlags=0,int &lineNumber,int flagMask=-1,
                  INTARRAY &overlays=null);
 ...
 * @categories Tree_View_Methods
 */
void _TreeGetCurFlags(int ItemIndex, int flagMask=-1),
    _sc_lang_tree_view::_TreeGetCurFlags(int ItemIndex, int flagMask=-1);

/**
 * Set flags info for a tree node. 
 *
 * @param ItemIndex           Specifies a tree item.  The root of the tree can't
 *                            be deleted and always has an item index of 0.
 * @param moreFlags           Combination of TREENODE_* flags.
 ...
 * @categories Tree_View_Methods
 */
void _TreeSetCurFlags(int ItemIndex, int moreFlags, int setCurrentNodeIfHidden=1, int flagMask=-1),
    _sc_lang_tree_view::_TreeSetCurFlags(int ItemIndex, int moreFlags, int setCurrentNodeIfHidden=1, int flagMask=-1);
...
int _TreeGetIndexFromPoint(int mou_x,int mou_y,_str option="S"),
    _sc_lang_tree_view::_TreeGetIndexFromPoint(int mou_x,int mou_y,_str option="S");
...
void _TreeGetSelInfo(int &NofSelected,int &startSelectedItem=0,int &endSelectedItem=0),
    _sc_lang_tree_view::_TreeGetSelInfo(int &NofSelected,int &startSelectedItem=0,int &endSelectedItem=0);
...
void _TreeSetAllFlags(int flags,int Mask=flags),
    _sc_lang_tree_view::_TreeSetAllFlags(int flags,int Mask=flags);
...
void _TreeSetCaption(int ItemIndex, _str caption, int ColIndex=-1),
    _sc_lang_tree_view::_TreeSetCaption(int ItemIndex, _str caption, int ColIndex=-1);
...
_str _TreeGetCaption(int ItemIndex, int ColIndex=-1),
    _sc_lang_tree_view::_TreeGetCaption(int ItemIndex, int ColIndex=-1);
...
int _TreeGetFirstChildIndex(int ItemIndex),
    _sc_lang_tree_view::_TreeGetFirstChildIndex(int ItemIndex);
...
int _TreeGetPrevSiblingIndex(int ItemIndex),
    _sc_lang_tree_view::_TreeGetPrevSiblingIndex(int ItemIndex);
...
int _TreeGetNextSiblingIndex(int ItemIndex),
    _sc_lang_tree_view::_TreeGetNextSiblingIndex(int ItemIndex);
...
int _TreeGetPrevIndex(int ItemIndex),
    _sc_lang_tree_view::_TreeGetPrevIndex(int ItemIndex);
...
int _TreeGetNextIndex(int ItemIndex),
    _sc_lang_tree_view::_TreeGetNextIndex(int ItemIndex);
...
int _TreeGetParentIndex(int ItemIndex),
    _sc_lang_tree_view::_TreeGetParentIndex(int ItemIndex);
...
void _TreeDelete(int ItemIndex,_str option=""),
    _sc_lang_tree_view::_TreeDelete(int ItemIndex,_str option="");
 ...
 */
void _TreePageUp(),
    _sc_lang_tree_view::_TreePageUp();
 ...
 */
void _TreePageDown(),
    _sc_lang_tree_view::_TreePageDown();
...
void _TreeSetCurIndex(int ItemIndex),
    _sc_lang_tree_view::_TreeSetCurIndex(int ItemIndex);
...
int _TreeGetDepth(int ItemIndex),
    _sc_lang_tree_view::_TreeGetDepth(int ItemIndex);
 ...
 *    <DT>'P'<DD>Sort parents nodes at the top. Here
 ...
 *    <DT>'M'<DD>Sort tab delimited column (column specified in
 *    ExInfo argument) for captions with tab delimited info.
 *    Defaults to 0 (first column). Currently only supported in
 *    _TreeSortCaption()
 *    </DL>
 ...
 * @categories Tree_View_Methods
 */
void _TreeSortCaption(int ItemIndex,_str PrimarySortOptions="",_str SecondarySortOptions="",_str ExInfo=""),
    _sc_lang_tree_view::_TreeSortCaption(int ItemIndex,_str PrimarySortOptions="",_str SecondarySortOptions="",_str ExInfo="");
...
void _TreeSortUserInfo(int ItemIndex,_str PrimarySortOptions="",_str SecondarySortOptions=""),
    _sc_lang_tree_view::_TreeSortUserInfo(int ItemIndex,_str PrimarySortOptions="",_str SecondarySortOptions="");
...
int _TreeSearch(int ItemIndex,_str searchCaption,_str options="",_str searchUserInfo=null,int ColIndex=-1),
    _sc_lang_tree_view::_TreeSearch(int ItemIndex,_str searchCaption,_str options="",_str searchUserInfo=null,int ColIndex=-1);
...
int _TreeScroll(int lineNumber=-1),
    _sc_lang_tree_view::_TreeScroll(int lineNumber=-1);
...
int _TreeCurLineNumber(int lineNumber=-1),
    _sc_lang_tree_view::_TreeCurLineNumber(int lineNumber=-1);
...
int _TreeGetNumChildren(int ItemIndex,_str options=""),
    _sc_lang_tree_view::_TreeGetNumChildren(int ItemIndex,_str options="");
...
int _TreeBeginUpdate(int ItemIndex,_str options=""),
    _sc_lang_tree_view::_TreeBeginUpdate(int ItemIndex,_str options="");
...
int _TreeEndUpdate(int ItemIndex),
    _sc_lang_tree_view::_TreeEndUpdate(int ItemIndex);
...
void _TreeSetColButtonInfo(int ButtonIndex,int ButtonWidth,int ButtonFlags=-1,int State=-1,_str Caption=''),
    _sc_lang_tree_view::_TreeSetColButtonInfo(int ButtonIndex,int ButtonWidth,int ButtonFlags=-1,int State=-1,_str Caption='');
...
void _TreeGetColButtonInfo(int ButtonIndex,int &ButtonWidth,int &ButtonFlags,int &StateNOTUSED,_str &Caption),
    _sc_lang_tree_view::_TreeGetColButtonInfo(int ButtonIndex,int &ButtonWidth,int &ButtonFlags,int &StateNOTUSED,_str &Caption);
...
void _TreeDeleteColButton(int ButtonIndex),
    _sc_lang_tree_view::_TreeDeleteColButton(int ButtonIndex);
...
int _TreeGetNumColButtons(),
    _sc_lang_tree_view::_TreeGetNumColButtons();
...
void _TreeGetCurCoord(int ItemIndex,int &x,int &y,int &HorizontalScrollPos,int &Height),
    _sc_lang_tree_view::_TreeGetCurCoord(int ItemIndex,int &x,int &y,int &HorizontalScrollPos,int &Height);
...
void _TreeSortCol(int ButtonIndex=0,_str PrimarySortOptions="",_str SecondarySortOptionsDEPRECATED=""),
    _sc_lang_tree_view::_TreeSortCol(int ButtonIndex=0,_str PrimarySortOptions="",_str SecondarySortOptionsDEPRECATED="");

/**
 * Set header to be clickable, regardless of if it is actually 
 * sortable. 
 *  
 * @param Clickable if non-zero, header is clickable 
 * @param ShowSortIndicator if non-zero, sort indicator will be shown
 *
 * @appliesTo Tree_View
 * @categories Tree_View_Methods
 */
void _TreeSetHeaderClickable(int Clickable,int ShowSortIndicator=0),
    _sc_lang_tree_view::_TreeSetHeaderClickable(int Clickable,int ShowSortIndicator=0);
...
int _TreeMoveUp(int ItemIndex),
    _sc_lang_tree_view::_TreeMoveUp(int ItemIndex);
/**
...
int _TreeMoveDown(int ItemIndex),
    _sc_lang_tree_view::_TreeMoveDown(int ItemIndex);
...
int _TreeCompare(int parent1Index,int parent2Index,_str reservedOptions=""),
    _sc_lang_tree_view::_TreeCompare(int parent1Index,int parent2Index,_str reservedOptions="");
...
void _TreeSetColor(int nodeIndex,int col,int FGColor,int BGColor,int Flags),
    _sc_lang_tree_view::_TreeSetColor(int nodeIndex,int col,int FGColor,int BGColor,int Flags);
...
void _TreeGetColor(int nodeIndex,int col,int &FGColor,int &BGColor,int &Flags),
    _sc_lang_tree_view::_TreeGetColor(int nodeIndex,int col,int &FGColor,int &BGColor,int &Flags);
...
void _TreeSetColColor(int col,int FGColor,int BGColor,int Flags),
    _sc_lang_tree_view::_TreeSetColColor(int col,int FGColor,int BGColor,int Flags);
...
void _TreeGetColColor(),
    _sc_lang_tree_view::_TreeGetColColor();
...
void _TreeSetRowColor(int nodeIndex,int FGColor,int BGColor,int Flags),
    _sc_lang_tree_view::_TreeSetRowColor(int nodeIndex,int FGColor,int BGColor,int Flags);
...
void _TreeSetOverlayBitmaps(int nodeIndex,int bitmapArrayIndex[]),
    _sc_lang_tree_view::_TreeSetOverlayBitmaps(int nodeIndex,int bitmapArrayIndex[]);
...
void _TreeGetOverlayBitmaps(int nodeIndex,int (&bitmapArrayIndex)[]),
    _sc_lang_tree_view::_TreeGetOverlayBitmaps(int nodeIndex,int (&bitmapArrayIndex)[]);


#define SHIFT
#define CTRL

typedef typeless event;
typedef event key_event;
typedef event mouse_event;
typedef event form_event;

key_event backspace(),            _sc_lang_control::backspace();                const key_event BACKSPACE;
key_event del(),                  _sc_lang_control::del();                      const key_event DEL;
key_event enter(),                _sc_lang_control::enter();                    const key_event ENTER;
key_event esc(),                  _sc_lang_control::esc();                      const key_event ESC;
key_event home(),                 _sc_lang_control::home();                     const key_event HOME;
key_event end(),                  _sc_lang_control::end();                      const key_event END;
key_event ins(),                  _sc_lang_control::ins();                      const key_event INS;
key_event pgdn(),                 _sc_lang_control::pgdn();                     const key_event PGDN;
key_event pgup(),                 _sc_lang_control::pgup();                     const key_event PGUP;
key_event tab(),                  _sc_lang_control::tab();                      const key_event TAB;
key_event up(),                   _sc_lang_control::up();                       const key_event UP;
key_event down(),                 _sc_lang_control::down();                     const key_event DOWN;
key_event left(),                 _sc_lang_control::left();                     const key_event LEFT;
key_event right(),                _sc_lang_control::right();                    const key_event RIGHT;
key_event f1(),                   _sc_lang_control::f1();                       const key_event F1;
key_event f2(),                   _sc_lang_control::f2();                       const key_event F2;
key_event f3(),                   _sc_lang_control::f3();                       const key_event F3;
key_event f4(),                   _sc_lang_control::f4();                       const key_event F4;
key_event f5(),                   _sc_lang_control::f5();                       const key_event F5;
key_event f6(),                   _sc_lang_control::f6();                       const key_event F6;
key_event f7(),                   _sc_lang_control::f7();                       const key_event F7;
key_event f8(),                   _sc_lang_control::f8();                       const key_event F8;
key_event f9(),                   _sc_lang_control::f9();                       const key_event F9;
key_event f10(),                  _sc_lang_control::f10();                      const key_event F10;
key_event f11(),                  _sc_lang_control::f11();                      const key_event F11;
key_event f12(),                  _sc_lang_control::f12();                      const key_event F12;
key_event a_f1(),                 _sc_lang_control::a_f1();                     const key_event A_F1;
key_event a_f2(),                 _sc_lang_control::a_f2();                     const key_event A_F2;
key_event a_f3(),                 _sc_lang_control::a_f3();                     const key_event A_F3;
key_event a_f4(),                 _sc_lang_control::a_f4();                     const key_event A_F4;
key_event a_f5(),                 _sc_lang_control::a_f5();                     const key_event A_F5;
key_event a_f6(),                 _sc_lang_control::a_f6();                     const key_event A_F6;
key_event a_f7(),                 _sc_lang_control::a_f7();                     const key_event A_F7;
key_event a_f8(),                 _sc_lang_control::a_f8();                     const key_event A_F8;
key_event a_f9(),                 _sc_lang_control::a_f9();                     const key_event A_F9;
key_event a_f10(),                _sc_lang_control::a_f10();                    const key_event A_F10;
key_event a_f11(),                _sc_lang_control::a_f11();                    const key_event A_F11;
key_event a_f12(),                _sc_lang_control::a_f12();                    const key_event A_F12;
key_event c_f1(),                 _sc_lang_control::c_f1();                     const key_event C_F1;
key_event c_f2(),                 _sc_lang_control::c_f2();                     const key_event C_F2;
key_event c_f3(),                 _sc_lang_control::c_f3();                     const key_event C_F3;
key_event c_f4(),                 _sc_lang_control::c_f4();                     const key_event C_F4;
key_event c_f5(),                 _sc_lang_control::c_f5();                     const key_event C_F5;
key_event c_f6(),                 _sc_lang_control::c_f6();                     const key_event C_F6;
key_event c_f7(),                 _sc_lang_control::c_f7();                     const key_event C_F7;
key_event c_f8(),                 _sc_lang_control::c_f8();                     const key_event C_F8;
key_event c_f9(),                 _sc_lang_control::c_f9();                     const key_event C_F9;
key_event c_f10(),                _sc_lang_control::c_f10();                    const key_event C_F10;
key_event c_f11(),                _sc_lang_control::c_f11();                    const key_event C_F11;
key_event c_f12(),                _sc_lang_control::c_f12();                    const key_event C_F12;
key_event s_f1(),                 _sc_lang_control::s_f1();                     const key_event S_F1;
key_event s_f2(),                 _sc_lang_control::s_f2();                     const key_event S_F2;
key_event s_f3(),                 _sc_lang_control::s_f3();                     const key_event S_F3;
key_event s_f4(),                 _sc_lang_control::s_f4();                     const key_event S_F4;
key_event s_f5(),                 _sc_lang_control::s_f5();                     const key_event S_F5;
key_event s_f6(),                 _sc_lang_control::s_f6();                     const key_event S_F6;
key_event s_f7(),                 _sc_lang_control::s_f7();                     const key_event S_F7;
key_event s_f8(),                 _sc_lang_control::s_f8();                     const key_event S_F8;
key_event s_f9(),                 _sc_lang_control::s_f9();                     const key_event S_F9;
key_event s_f10(),                _sc_lang_control::s_f10();                    const key_event S_F10;
key_event s_f11(),                _sc_lang_control::s_f11();                    const key_event S_F11;
key_event s_f12(),                _sc_lang_control::s_f12();                    const key_event S_F12;
key_event s_tab(),                _sc_lang_control::s_tab();                    const key_event S_TAB;
key_event a_0(),                  _sc_lang_control::a_0();                      const key_event A_0;
key_event a_1(),                  _sc_lang_control::a_1();                      const key_event A_1;
key_event a_2(),                  _sc_lang_control::a_2();                      const key_event A_2;
key_event a_3(),                  _sc_lang_control::a_3();                      const key_event A_3;
key_event a_4(),                  _sc_lang_control::a_4();                      const key_event A_4;
key_event a_5(),                  _sc_lang_control::a_5();                      const key_event A_5;
key_event a_6(),                  _sc_lang_control::a_6();                      const key_event A_6;
key_event a_7(),                  _sc_lang_control::a_7();                      const key_event A_7;
key_event a_8(),                  _sc_lang_control::a_8();                      const key_event A_8;
key_event a_9(),                  _sc_lang_control::a_9();                      const key_event A_9;
key_event a_a(),                  _sc_lang_control::a_a();                      const key_event A_A;
key_event a_b(),                  _sc_lang_control::a_b();                      const key_event A_B;
key_event a_c(),                  _sc_lang_control::a_c();                      const key_event A_C;
key_event a_d(),                  _sc_lang_control::a_d();                      const key_event A_D;
key_event a_e(),                  _sc_lang_control::a_e();                      const key_event A_E;
key_event a_f(),                  _sc_lang_control::a_f();                      const key_event A_F;
key_event a_g(),                  _sc_lang_control::a_g();                      const key_event A_G;
key_event a_h(),                  _sc_lang_control::a_h();                      const key_event A_H;
key_event a_i(),                  _sc_lang_control::a_i();                      const key_event A_I;
key_event a_j(),                  _sc_lang_control::a_j();                      const key_event A_J;
key_event a_k(),                  _sc_lang_control::a_k();                      const key_event A_K;
key_event a_l(),                  _sc_lang_control::a_l();                      const key_event A_L;
key_event a_m(),                  _sc_lang_control::a_m();                      const key_event A_M;
key_event a_n(),                  _sc_lang_control::a_n();                      const key_event A_N;
key_event a_o(),                  _sc_lang_control::a_o();                      const key_event A_O;
key_event a_p(),                  _sc_lang_control::a_p();                      const key_event A_P;
key_event a_q(),                  _sc_lang_control::a_q();                      const key_event A_Q;
key_event a_r(),                  _sc_lang_control::a_r();                      const key_event A_R;
key_event a_s(),                  _sc_lang_control::a_s();                      const key_event A_S;
key_event a_t(),                  _sc_lang_control::a_t();                      const key_event A_T;
key_event a_u(),                  _sc_lang_control::a_u();                      const key_event A_U;
key_event a_v(),                  _sc_lang_control::a_v();                      const key_event A_V;
key_event a_w(),                  _sc_lang_control::a_w();                      const key_event A_W;
key_event a_x(),                  _sc_lang_control::a_x();                      const key_event A_X;
key_event a_y(),                  _sc_lang_control::a_y();                      const key_event A_Y;
key_event a_z(),                  _sc_lang_control::a_z();                      const key_event A_Z;
key_event a_equal(),              _sc_lang_control::a_equal();                  const key_event A_EQUAL;
key_event a_minus(),              _sc_lang_control::a_minus();                  const key_event A_MINUS;
key_event c_a(),                  _sc_lang_control::c_a();                      const key_event C_A;
key_event c_b(),                  _sc_lang_control::c_b();                      const key_event C_B;
key_event c_c(),                  _sc_lang_control::c_c();                      const key_event C_C;
key_event c_d(),                  _sc_lang_control::c_d();                      const key_event C_D;
key_event c_e(),                  _sc_lang_control::c_e();                      const key_event C_E;
key_event c_f(),                  _sc_lang_control::c_f();                      const key_event C_F;
key_event c_g(),                  _sc_lang_control::c_g();                      const key_event C_G;
key_event c_h(),                  _sc_lang_control::c_h();                      const key_event C_H;
key_event c_i(),                  _sc_lang_control::c_i();                      const key_event C_I;
key_event c_j(),                  _sc_lang_control::c_j();                      const key_event C_J;
key_event c_k(),                  _sc_lang_control::c_k();                      const key_event C_K;
key_event c_l(),                  _sc_lang_control::c_l();                      const key_event C_L;
key_event c_m(),                  _sc_lang_control::c_m();                      const key_event C_M;
key_event c_n(),                  _sc_lang_control::c_n();                      const key_event C_N;
key_event c_o(),                  _sc_lang_control::c_o();                      const key_event C_O;
key_event c_p(),                  _sc_lang_control::c_p();                      const key_event C_P;
key_event c_q(),                  _sc_lang_control::c_q();                      const key_event C_Q;
key_event c_r(),                  _sc_lang_control::c_r();                      const key_event C_R;
key_event c_s(),                  _sc_lang_control::c_s();                      const key_event C_S;
key_event c_t(),                  _sc_lang_control::c_t();                      const key_event C_T;
key_event c_u(),                  _sc_lang_control::c_u();                      const key_event C_U;
key_event c_v(),                  _sc_lang_control::c_v();                      const key_event C_V;
key_event c_w(),                  _sc_lang_control::c_w();                      const key_event C_W;
key_event c_x(),                  _sc_lang_control::c_x();                      const key_event C_X;
key_event c_y(),                  _sc_lang_control::c_y();                      const key_event C_Y;
key_event c_z(),                  _sc_lang_control::c_z();                      const key_event C_Z;
key_event c_backspace(),          _sc_lang_control::c_backspace();              const key_event C_BACKSPACE;
key_event c_end(),                _sc_lang_control::c_end();                    const key_event C_END;
key_event c_home(),               _sc_lang_control::c_home();                   const key_event C_HOME;
key_event c_left(),               _sc_lang_control::c_left();                   const key_event C_LEFT;
key_event c_pgdn(),               _sc_lang_control::c_pgdn();                   const key_event C_PGDN;
key_event c_pgup(),               _sc_lang_control::c_pgup();                   const key_event C_PGUP;
key_event c_right(),              _sc_lang_control::c_right();                  const key_event C_RIGHT;
key_event a_left(),               _sc_lang_control::a_left();                   const key_event A_LEFT;
key_event a_right(),              _sc_lang_control::a_right();                  const key_event A_RIGHT;
key_event c_up(),                 _sc_lang_control::c_up();                     const key_event C_UP;
key_event a_up(),                 _sc_lang_control::a_up();                     const key_event A_UP;
key_event a_down(),               _sc_lang_control::a_down();                   const key_event A_DOWN;
key_event c_down(),               _sc_lang_control::c_down();                   const key_event C_DOWN;
key_event a_ins(),                _sc_lang_control::a_ins();                    const key_event A_INS;
key_event c_ins(),                _sc_lang_control::c_ins();                    const key_event C_INS;
key_event a_home(),               _sc_lang_control::a_home();                   const key_event A_HOME;
key_event a_pgup(),               _sc_lang_control::a_pgup();                   const key_event A_PGUP;
key_event a_del(),                _sc_lang_control::a_del();                    const key_event A_DEL;
key_event c_del(),                _sc_lang_control::c_del();                    const key_event C_DEL;
key_event a_end(),                _sc_lang_control::a_end();                    const key_event A_END;
key_event a_pgdn(),               _sc_lang_control::a_pgdn();                   const key_event A_PGDN;
key_event a_pad_slash(),          _sc_lang_control::a_pad_slash();              const key_event A_PAD_SLASH;
key_event c_pad_slash(),          _sc_lang_control::c_pad_slash();              const key_event C_PAD_SLASH;
key_event a_slash(),              _sc_lang_control::a_slash();                  const key_event A_SLASH;
key_event pad_5(),                _sc_lang_control::pad_5();                    const key_event PAD_5;
key_event a_tab(),                _sc_lang_control::a_tab();                    const key_event A_TAB;
key_event a_backspace(),          _sc_lang_control::a_backspace();              const key_event A_BACKSPACE;
key_event a_backslash(),          _sc_lang_control::a_backslash();              const key_event A_BACKSLASH;
key_event a_comma(),              _sc_lang_control::a_comma();                  const key_event A_COMMA;
key_event a_dot(),                _sc_lang_control::a_dot();                    const key_event A_DOT;
key_event a_semicolon(),          _sc_lang_control::a_semicolon();              const key_event A_SEMICOLON;
key_event a_quote(),              _sc_lang_control::a_quote();                  const key_event A_QUOTE;
key_event a_left_bracket(),       _sc_lang_control::a_left_bracket();           const key_event A_LEFT_BRACKET;
key_event a_right_bracket(),      _sc_lang_control::a_right_bracket();          const key_event A_RIGHT_BRACKET;
key_event a_enter(),              _sc_lang_control::a_enter();                  const key_event A_ENTER;
key_event a_pad_plus(),           _sc_lang_control::a_pad_plus();               const key_event A_PAD_PLUS;
key_event c_pad_plus(),           _sc_lang_control::c_pad_plus();               const key_event C_PAD_PLUS;
key_event pad_star(),             _sc_lang_control::pad_star();                 const key_event PAD_STAR;
key_event pad_minus(),            _sc_lang_control::pad_minus();                const key_event PAD_MINUS;
key_event pad_plus(),             _sc_lang_control::pad_plus();                 const key_event PAD_PLUS;
key_event pad_slash(),            _sc_lang_control::pad_slash();                const key_event PAD_SLASH;
key_event s_left(),               _sc_lang_control::s_left();                   const key_event S_LEFT;
key_event s_right(),              _sc_lang_control::s_right();                  const key_event S_RIGHT;
key_event s_up(),                 _sc_lang_control::s_up();                     const key_event S_UP;
key_event s_down(),               _sc_lang_control::s_down();                   const key_event S_DOWN;
key_event s_pgup(),               _sc_lang_control::s_pgup();                   const key_event S_PGUP;
key_event s_pgdn(),               _sc_lang_control::s_pgdn();                   const key_event S_PGDN;
key_event s_home(),               _sc_lang_control::s_home();                   const key_event S_HOME;
key_event s_end(),                _sc_lang_control::s_end();                    const key_event S_END;
key_event c_break(),              _sc_lang_control::c_break();                  const key_event C_BREAK;
key_event c_0(),                  _sc_lang_control::c_0();                      const key_event C_0;
key_event c_1(),                  _sc_lang_control::c_1();                      const key_event C_1;
key_event c_2(),                  _sc_lang_control::c_2();                      const key_event C_2;
key_event a_alt(),                _sc_lang_control::a_alt();                    const key_event A_ALT;
key_event c_ctrl(),               _sc_lang_control::c_ctrl();                   const key_event C_CTRL;
key_event c_minus(),              _sc_lang_control::c_minus();                  const key_event C_MINUS;
key_event c_equal(),              _sc_lang_control::c_equal();                  const key_event C_EQUAL;
key_event c_left_bracket(),       _sc_lang_control::c_left_bracket();           const key_event C_LEFT_BRACKET;
key_event c_right_bracket(),      _sc_lang_control::c_right_bracket();          const key_event C_RIGHT_BRACKET;

mouse_event mbutton_up(),         _sc_lang_control::mbutton_up();               const mouse_event MBUTTON_UP;
mouse_event mbutton_down(),       _sc_lang_control::mbutton_down();             const mouse_event MBUTTON_DOWN;
mouse_event mbutton_double_click(), _sc_lang_control::mbutton_double_click();   const mouse_event MBUTTON_DOUBLE_CLICK;
mouse_event lbutton_triple_click(), _sc_lang_control::lbutton_triple_click();   const mouse_event LBUTTON_TRIPLE_CLICK;
mouse_event rbutton_triple_click(), _sc_lang_control::rbutton_triple_click();   const mouse_event RBUTTON_TRIPLE_CLICK;
mouse_event mbutton_triple_click(), _sc_lang_control::mbutton_triple_click();   const mouse_event MBUTTON_TRIPLE_CLICK;
mouse_event wheel_up(),           _sc_lang_control::wheel_up();                 const mouse_event WHEEL_UP;
mouse_event wheel_down(),         _sc_lang_control::wheel_down();               const mouse_event WHEEL_DOWN;
mouse_event wheel_left(),         _sc_lang_control::wheel_left();               const mouse_event WHEEL_LEFT;
mouse_event wheel_right(),        _sc_lang_control::wheel_right();              const mouse_event WHEEL_RIGHT;

form_event on_paint(),            _sc_lang_control::on_paint();                 const form_event ON_PAINT;
form_event on_sb_end_scroll(),    _sc_lang_control::on_sb_end_scroll();         const form_event ON_SB_END_SCROLL;
form_event on_drag_drop(),        _sc_lang_control::on_drag_drop();             const form_event ON_DRAG_DROP;
form_event on_drag_over(),        _sc_lang_control::on_drag_over();             const form_event ON_DRAG_OVER;
form_event on_num_lock(),         _sc_lang_control::on_num_lock();              const form_event ON_NUM_LOCK;
form_event on_drop_files(),       _sc_lang_control::on_drop_files();            const form_event ON_DROP_FILES;
 ...
 *
 */
extern mouse_event lbutton_double_click(), _sc_lang_control::lbutton_double_click();
const  mouse_event LBUTTON_DOUBLE_CLICK;
 ...
 *
 */
extern mouse_event lbutton_triple_click(), _sc_lang_control::lbutton_triple_click();
const  mouse_event LBUTTON_TRIPLE_CLICK;
 ...
 *
 */
extern mouse_event lbutton_up(), _sc_lang_control::lbutton_up();
const  mouse_event LBUTTON_UP;
/**
 ...
 *
 */
extern mouse_event lbutton_down(), _sc_lang_control::lbutton_down();
const  mouse_event LBUTTON_DOWN;
 ...
 *
 */
extern mouse_event mouse_move(), _sc_lang_control::mouse_move();
const  mouse_event MOUSE_MOVE;
 ...
 *
 */
extern form_event on_change(int reason, int index=0), 
                  _sc_lang_control::on_change(int reason, int index=0);
const  form_event ON_CHANGE;
 ...
 *
 */
extern event on_change2(), _sc_lang_control::on_change2();
const  event ON_CHANGE2;
 ...
 */
extern event on_highlight(int index, _str caption=""),
             _sc_lang_control::on_highlight(int index, _str caption="");
const event ON_HIGHLIGHT;
 ...
 *
 */
extern event on_close(), _sc_lang_form::on_close();
const  event ON_CLOSE;
 ...
 *
 */
extern event on_create(), _sc_lang_control::on_create();
const  event ON_CREATE;
 ...
 *
 */
extern event on_create2(), _sc_lang_control::on_create2();
const  event ON_CREATE2;
 ...
 *
 */
extern event on_destroy(), _sc_lang_control::on_destroy();
const  event ON_DESTROY;
 ...
 *
 */
extern event on_destroy2(), _sc_lang_control::on_destroy2();
const  event ON_DESTROY2;
 ...
 *
 */
extern event on_got_focus(), _sc_lang_control::on_got_focus();
const  event ON_GOT_FOCUS;
 ...
 *
 */
extern event on_drop_down(), _sc_lang_combo_box::on_drop_down();
const  event ON_DROP_DOWN;
 ...
 *
 */
extern event on_hsb_bottom(), _sc_lang_editor::on_hsb_bottom();
const  event ON_HSB_BOTTOM;
 ...
 *
 */
extern event on_hsb_line_down(), _sc_lang_editor::on_hsb_line_down();
const  event ON_HSB_LINE_DOWN;
 ...
 *
 */
extern event on_hsb_line_up(), _sc_lang_editor::on_hsb_line_up();
const  event ON_HSB_LINE_UP;
 ...
 *
 */
extern event on_hsb_page_down(), _sc_lang_editor::on_hsb_page_down();
const  event ON_HSB_PAGE_DOWN;
 ...
 *
 */
extern event on_hsb_page_up(), _sc_lang_editor::on_hsb_page_up();
const  event ON_HSB_PAGE_UP;
 ...
 *
 */
extern event on_hsb_thumb_pos(), _sc_lang_editor::on_hsb_thumb_pos();
const  event ON_HSB_THUMB_POS;
 ...
 *
 */
extern event on_hsb_thumb_track(), _sc_lang_editor::on_hsb_thumb_track();
const  event ON_HSB_THUMB_TRACK;
 ...
 *
 */
extern event on_hsb_top(), _sc_lang_editor::on_hsb_top();
const  event ON_HSB_TOP;
 ...
 *
 */
extern event on_init_menu(), _sc_lang_form::on_init_menu();
const  event ON_INIT_MENU;
 ...
 *
 */
extern event on_keystatechange(); 
const  event ON_KEYSTATECHANGE;
/**
 ...
 *
 */
extern event on_load(), _sc_lang_form::on_load();
const  event ON_LOAD;
 ...
 *
 */
extern event on_lost_focus(), _sc_lang_control::on_lost_focus();
const  event ON_LOST_FOCUS;
 ...
 *
 */
extern event on_resize(), _sc_lang_window::on_resize();
const  event ON_RESIZE;
 ...
 *
 */
extern event on_scroll(), _sc_lang_scroll_bar::on_scroll();
const  event ON_SCROLL;
 ...
 *
 */
extern event on_scroll_lock(), _sc_lang_scrollable::on_scroll_lock();
const  event ON_SCROLL_LOCK;
 ...
 *
 */
extern event on_select(), _sc_lang_editor::on_select();
const  event ON_SELECT;
 ...
 *
 */
extern event on_spin_down(), _sc_lang_spin::on_spin_down();
const  event ON_SPIN_DOWN;
 ...
 *
 */
extern event on_spin_up(), _sc_lang_spin::on_spin_up();
const  event ON_SPIN_UP;
 ...
 * @categories Miscellaneous_Functions
 */
form_event on_timer(), _sc_lang_control::on_timer();
const form_event ON_TIMER;
 ...
 *
 */
extern event on_vsb_bottom(), _sc_lang_editor::on_vsb_bottom();
const  event ON_VSB_BOTTOM;
 ...
 *
 */
extern event on_vsb_line_down(), _sc_lang_editor::on_vsb_line_down();
const  event ON_VSB_LINE_DOWN;
 ...
 *
 */
extern event on_vsb_line_up(), _sc_lang_editor::on_vsb_line_up();
const  event ON_VSB_LINE_UP;
 ...
 *
 */
extern event on_vsb_page_down(), _sc_lang_editor::on_vsb_page_down();
const  event ON_VSB_PAGE_DOWN;
 ...
 *
 */
extern event on_vsb_page_up(), _sc_lang_editor::on_vsb_page_up();
const  event ON_VSB_PAGE_UP;
 ...
 *
 */
extern event on_vsb_thumb_pos(), _sc_lang_editor::on_vsb_thumb_pos();
const  event ON_VSB_THUMB_POS;
 ...
 *
 */
extern event on_vsb_thumb_track(), _sc_lang_editor::on_vsb_thumb_track();
const  event ON_VSB_THUMB_TRACK;
 ...
 *
 */
extern event on_vsb_top(), _sc_lang_editor::on_vsb_top();
const  event ON_VSB_TOP;
 ...
 * @categories All_Windows_Properties
 */
extern mouse_event rbutton_double_click(), _sc_lang_control::rbutton_double_click();
const  mouse_event RBUTTON_DOUBLE_CLICK;
 ...
 * @categories All_Windows_Properties
 */
extern mouse_event rbutton_down(), _sc_lang_control::rbutton_down();
const  mouse_event RBUTTON_DOWN;
 ...
 * @categories All_Windows_Properties
 */
extern event rbutton_triple_click(), _sc_lang_control::rbutton_triple_click();
const  event RBUTTON_TRIPLE_CLICK;
 ...
 * @categories All_Windows_Properties
 */
extern mouse_event rbutton_up(), _sc_lang_control::rbutton_up();
const  mouse_event RBUTTON_UP;
 ...
 *                        is bool mycallback(). Return true if no further processing of
...
_command void left_justify(),
    _sc_lang_editor::void left_justify();

void mou_set_xy(int x, int y),
     _sc_lang_editor::mou_set_xy(int x, int y);
...
int p_TextWrapChangeNotify,
    _sc_lang_editor::p_TextWrapChangeNotify;
...
int p_UseFileInfoOverlays,
   _sc_lang_tree_view::p_UseFileInfoOverlays;
 ...
 * @appliesTo Tree_View
 */
bool p_ShowExpandPicture,
        _sc_lang_tree_view::p_ShowExpandPicture;

/**
 * When on, the DEL key will delete history from PSCBO_EDIT combo boxes. 
 *  
 * @categories Combo_Box_Properties
 * @appliesTo Combo_Box
 */
bool p_AllowDeleteHistory,
        _sc_lang_combo_box::p_AllowDeleteHistory;

/**
 * When on, an extra line will appear past the last line 
 * terminated with newline character(s)
 *  
 * @categories Combo_Box_Properties
 * @appliesTo Combo_Box
 */
bool p_ShowExtraLine,
        _sc_lang_editor::p_ShowExtraLine;
 ...
 */
int _frame_width(),
    _sc_lang_window::_frame_width();

bool _haveBuild();
bool _haveDebugging();
bool _haveContextTagging();
bool _haveVersionControl();
bool _haveProMacros();
bool _haveBeautifiers();
bool _haveRefactoring();
bool _haveRealTimeErrors();
bool _haveProDiff();
bool _haveMerge();
bool _haveCodeAnnotations();

bool _haveDiff();
bool _haveFTP();
bool _haveBackupHistory();
bool _haveXMLValidation();
bool _haveSmartOpen();
bool _haveMainframeLangs();
bool _haveHardwareLangs();
bool _haveAdaLangs();
bool _haveSQLLangs();
bool _haveDefsToolWindow();
bool _haveCurrentContextToolBar();
bool _haveCtags();
bool _haveCodeTemplates();
bool _haveFileTabsWindow();

bool _isProEdition();
bool _isStandardEdition();
bool _isCommunityEdition();

/**
 * @return true if current operating system is macOS compatible.
 */
bool _isMac();
/**
 * @return true if current operating system is UNIX compatible. 
 */
bool _isUnix();
/**
 * @return true if current operating system is Linux compatible. 
 */
bool _isLinux();
/**
 * @return true if current operating system is Microsoft Windows compatible.
 */
bool _isWindows();
/**
 * @return true if current operating system is Oracle Solaris compatible. 
 */
bool _isSolaris();
