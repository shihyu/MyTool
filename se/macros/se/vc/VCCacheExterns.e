...
extern int vsGetSVNHistoryForCurrentBranch(_str pszLocalFilename, SVCHistoryInfo (&hrefVarHistoryInfo)[], _str dateBack, _str pszSVNExeName,int lastEntryOnly,int includeWorkingFile,bool stopOnCopy=false);
