 ...
 */
bool dbgp_almost_active(int new_value=-1)
{
...
_str dbgp_make_debugger_args(DBGpFeatures& dbgp_features)
{
   ...
   for( i=0; i < n; ++i ) {
      args :+= ' -feature-set='translate(dbgp_features._fieldname(i),'_','-')'='dbgp_features._getfield(i);
   }
   return args;
}
...
/*
// DEBUG
_command void dbgp_test1() name_info(','VSARG2_NCW|VSARG2_READ_ONLY)
{
