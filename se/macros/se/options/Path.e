...
class Path : Property {
   ...
   private bool m_encodeEnvVars = false;

   /**
    * Constructor.
    */
   Path(_str caption = '', int index = 0, PATH_TYPE type = FILEPATH, _str delimiter = '', bool encode = false)
   {
    ...
    */
   public bool allowMultiplePaths()
   {
      return (m_delimiter :!= '');
   }
