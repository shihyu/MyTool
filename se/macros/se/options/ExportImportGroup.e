...
struct ExportImportItem {
   ExportImportItemStatus       Status;             // one of the ExportImportItemStatus enum
   ExportImportProtectionStatus ProtectStatus;      // one of the ExportImportProtectionStatus enum
};
...
class ExportImportGroup {
   ...
   private bool m_modified = false;          // whether this group has been modified
    ...
    *                      status)
    */
   public void addGroupItem(ExportImportItem eti, int index, bool isNew = true)
   {
      m_items:[index] = eti;
      if (!m_modified) {
         m_modified = isNew;
    ...
    */
   public ExportImportProtectionStatus getItemProtectionStatus(int index)
   {
      if (m_items._indexin(index)) {
    ...
    *                         DOM)
    */
   public INTARRAY getAllIndices(bool allowSomeChildren = true)
   {
      int list[];
    ...
    */
   public bool areAnyItemsProtected(bool includeUnprotects)
   {
      ExportImportItem item;
