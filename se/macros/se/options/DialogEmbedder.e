...
//    } 
   ...
   private void shiftControls()
   {
      ...
      for(;;) {
         ...
         if (wid.p_visible) {
            ...
            if (wid.p_x_extent > rightmost) {
               rightmost = wid.p_x_extent;
            }
            if (wid.p_y_extent > bottommost) {
               bottommost = wid.p_y_extent;
            }
    ...
    */
   public bool validate(int action)
   {
    ...
    */
   private bool compareCurrentSettings(int firstWid, bool setModifiedControls = false)
   {
   ...
   private bool doPreserveSpacesForControl(int wid)
   {
   ...
   public bool canControlsBeListed()
   {
