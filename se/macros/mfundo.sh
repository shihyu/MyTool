 ...
 *
 */
extern void _MFUndoNextSet(bool redo);
/**
 ...
 */
extern int _MFUndoGetStepCount(bool redo);
/**
 ...
 */
extern _str _MFUndoGetTitle(bool redo);
/**
 ...
 */
extern int _MFUndoGetStatus(bool redo);
/**
 ...
 */
extern _str _MFUndoGetStepFilename(int i,bool redo);
/**
 ...
 */
extern _str _MFUndoGetStepBackup(int i,bool redo,bool CheckCurrent);
/**
 ...
 * _MFUndoCancel().
 */
extern int _MFUndoGetStepStatus(int i,bool redo);
/**
 ...
 *
 */
extern void _MFUndoGetStepFileDate(int i,bool redo,_str &FileDate,bool CheckCurrent);
/**
