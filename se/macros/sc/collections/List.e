...
static const LISTNODE_ITEM_INDEX = 0;
...
class List : IList {
   ...
   public bool move(typeless where_from, typeless where_to);
   public bool swap(typeless where1, typeless where2);
   public bool assign(typeless where, typeless item);
   ...
   private bool isValidIterator(typeless iter);
