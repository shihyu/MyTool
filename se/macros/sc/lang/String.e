   ...
   IHashable      // may be used as hash table keys
{
    ...
    */
   void maybeAppend(_str ch, bool appendIfEmpty=false) {
      orig_length := length(m_s);
    ...
    * @param appendIfEmpty Append char even if the string is empty.
    */
   void maybePrepend(_str ch, bool appendIfEmpty=false) {
   ...
   void replaceFirst(_str pattern, _str rep_pattern, _str options='') {
      p := pos(pattern, this.m_s, 1, options);
      if (p > 0) {
   ...
   void replaceFirstString(String pattern, String rep_pattern, _str options='') {
      p := pos(pattern.m_s, this.m_s, 1, options);
      if (p > 0) {
    ...
    */
   void stripChars(_str ch, _str ltb='B', bool strip_all=true) {
      ltb=lowcase(ltb);
    ...
    * @param strip_all     Strip all matches or just the first one?
    */
   void stripMulti(_str strip_chars, _str ltb='B', bool strip_all=true) {
      ltb=lowcase(ltb);
    ...
    * @return 'true' if this equals 'rhs', false otherwise
    */
   bool equalToIgnoreCase(String &rhs) {
      if (rhs==null) {
         return (this==null);
      }
      if (rhs.m_s == null) {
    ...
    *         >  0 greater than rhs
    */
   int compareCase(String& rhs, bool caseSensitive) /*const*/ {
      if (rhs==null) {
         return (this==null)? 0:-1;
      }
      if (rhs.m_s == null) {
      ...
      if (caseSensitive) {
         ...
         low_lhs := lowcase(this.m_s);
         low_rhs := lowcase(rhs.m_s);
    ...
    */
   bool beginsWith(_str pattern, _str options='') /*const*/ {
    ...
    * @return true if it begins with it, false otherwise
    */
   bool beginsWithString(String pattern, _str options='') /*const*/ {
    ...
    * @return true if it begins with it, false otherwise
    */
   bool beginsWithChar(_str ch) /*const*/ {
    ...
    * @return true if it begins with it, false otherwise
    */
   bool endsWith(_str pattern, _str options='') /*const*/ {
    ...
    * @return true if it begins with it, false otherwise
    */
   bool endsWithString(String pattern, _str options='') /*const*/ {
    ...
    * @return true if it begins with it, false otherwise
    */
   bool endsWithChar(_str ch) /*const*/ {
    ...
    */
   void splitLines(_str (&a)[], bool stripLineEndings=true) /*const*/ {
      a._makeempty();
      start := 1;
      loop {
    ...
    * @param stripLineEndings    strip line endings for each line
    */
   typeless splitLinesToArray(bool stripLineEndings=true) /*const*/ {
      _str a[];
