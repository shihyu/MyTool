...
bool _deignore_ctllist_on_change;
_control combo;

#pragma option(deprecateconst,off)
static const OBJECT_KIND_LIST=\
         '_form='OI_FORM' ':+
...
static const COLOR_PROPS=' backcolor forecolor ActiveColor';
//  Boolean properties.  Show True or False.
//  Can not edit in text box.
static const BOOLEAN_PROPS= ' ActiveEnabled AllowDeleteHistory AlwaysColorCurrent auto_size cancel CaptionClick case_sensitive':+
               ...
               ' visible word_wrap';
//  Can edit combo text.
static const INCINT_PROPS='font_size  Gridlines LineStyle value';
static const INT_PROPS='ActiveTab ActiveOrder delay FirstActiveTab font_size height increment large_change LevelIndent max min Nofstates small_change tab_index SpaceY ':+
          'value width PaddingX PaddingY';
static const MIN_VALUES='font_size=1 height=4 Nofstates=1 tab_index=0 ':+
          'width=4 x=0 y=0';
static const MAX_VALUES='';
// Properties selectable from combo list.
static const CBLIST_PROPS=' alignment border_style command completion font_name':+
                   ' Gridlines LineStyle ListCompletions max_click mouse_pointer':+
                   ' multi_select Orientation scroll_bars style ':+
                   ' UseFileInfoOverlays ';
static const TRUEFALSE_LIST='FALSE=':+false:+' TRUE=':+true;
static const AL_LIST='AL_LEFT='AL_LEFT' ':+
          'AL_RIGHT='AL_RIGHT' ':+
          'AL_CENTER='AL_CENTER' ':+
...
static const AL_CHECK_LIST='AL_LEFT='AL_LEFT' ':+
          'AL_RIGHT='AL_RIGHT;
static const SB_LIST='SB_NONE='SB_NONE' ':+
        'SB_HORIZONTAL='SB_HORIZONTAL' ':+
        'SB_VERTICAL='SB_VERTICAL' ':+
        'SB_BOTH='SB_BOTH;
static const BDS_FORM_LIST='BDS_NONE='BDS_NONE' ':+
           'BDS_FIXED_SINGLE='BDS_FIXED_SINGLE' ':+
           'BDS_SIZABLE='BDS_SIZABLE' ':+
           'BDS_DIALOG_BOX='BDS_DIALOG_BOX;
static const BDS_LIST='BDS_NONE='BDS_NONE' ':+
           'BDS_FIXED_SINGLE='BDS_FIXED_SINGLE;
// List for label
static const BDS_LIST2='BDS_NONE='BDS_NONE' ':+
         'BDS_FIXED_SINGLE='BDS_FIXED_SINGLE' ':+
         'BDS_SUNKEN='BDS_SUNKEN;
static const BDS_LIST3='BDS_NONE='BDS_NONE' ':+
         'BDS_FIXED_SINGLE='BDS_FIXED_SINGLE' ':+
         'BDS_SUNKEN='BDS_SUNKEN' ':+
         'BDS_SUNKEN_LESS='BDS_SUNKEN_LESS;
static const TREE_GRIDLINE_LIST='TREE_GRID_NONE='TREE_GRID_NONE' ':+
...
static const TREE_FILE_INFO_OVERLAY_LIST='FILE_OVERLAYS_NONE='FILE_OVERLAYS_NONE' ':+
         'FILE_OVERLAYS_NODE='FILE_OVERLAYS_NODE;
static const MC_LIST='MC_SINGLE='MC_SINGLE' ':+
        'MC_DOUBLE='MC_DOUBLE' ':+
        'MC_TRIPLE='MC_TRIPLE;
static const MP_LIST='MP_DEFAULT='MP_DEFAULT' ':+
          'MP_ARROW='MP_ARROW' ':+
          'MP_CROSS='MP_CROSS' ':+
          'MP_IBEAM='MP_IBEAM' ':+
          'MP_ICON='MP_ICON' ':+
...
static const COMPLETION_LIST='picture='PICTURE_ARG' ':+
                'command='COMMAND_ARG' ':+
                'help='HELP_ARG' ':+
                'ActiveHelp='HELP_ARG;

static const PSCH_LIST='PSCH_AUTO2STATE='PSCH_AUTO2STATE' ':+
          'PSCH_AUTO3STATEA='PSCH_AUTO3STATEA' ':+
          'PSCH_AUTO3STATEB='PSCH_AUTO3STATEB;
static const PSCBO_LIST='PSCBO_EDIT='PSCBO_EDIT' ':+
           'PSCBO_LIST_ALWAYS='PSCBO_LIST_ALWAYS' ':+
           'PSCBO_NOEDIT='PSCBO_NOEDIT;
static const PSGA_LIST='PSGA_HORZ_WITH_PERCENT='PSGA_HORZ_WITH_PERCENT' ':+
...
static const PSPIC_LIST='PSPIC_DEFAULT='PSPIC_DEFAULT' ':+
...
static const PSIMG_LIST='PSPIC_DEFAULT='PSPIC_DEFAULT' ':+
...
static const PSPIC_ORIENTATION_LIST='PSPIC_OHORIZONTAL='PSPIC_OHORIZONTAL' ':+
           'PSPIC_OVERTICAL='PSPIC_OVERTICAL;

static const SSTAB_ORIENTATION_LIST='SSTAB_OTOP='SSTAB_OTOP' ':+
           'SSTAB_OBOTTOM='SSTAB_OBOTTOM' ':+
           'SSTAB_OLEFT='SSTAB_OLEFT' ':+
           'SSTAB_ORIGHT='SSTAB_ORIGHT;


static const TREE_LINE_LIST='TREE_NO_LINES='TREE_NO_LINES' ':+
...
void _deupdate()
{
   ...
   _deignore_ctllist_on_change=true;
   ...
   _delist_wid.p_enabled=true;
   //_decombo_wid.p_enabled=true;
...
_str _format_color(int color)
{
   ...
   return "0x":+_dec2hex(color,16,8);
}
static const CHECK_BOX_PROPS=' alignment auto_size backcolor caption enabled eventtab eventtab2 font_bold':+
               ' font_italic font_name font_size forecolor height help':+
               ' mouse_pointer tab_stop value visible width x y ';

static _str _quote_tm(_str s, bool isTitleBar=false)
{
...
static safe_insert_line(_str property,_str value,bool isTitleBar=false)
{
...
static _str _quote_font(_str fontName)
{
   switch (fontName) {
   case VSDEFAULT_DIALOG_FONT_NAME:       return "VSDEFAULT_DIALOG_FONT_NAME";
   case VSOEM_FIXED_FONT_NAME:            return "VSOEM_FIXED_FONT_NAME";
   case VSANSI_VAR_FONT_NAME:             return "VSANSI_VAR_FONT_NAME";
   case VSANSI_FIXED_FONT_NAME:           return "VSANSI_FIXED_FONT_NAME";
   case VSDEFAULT_UNICODE_FONT_NAME:      return "VSDEFAULT_UNICODE_FONT_NAME";
   case VSDEFAULT_FIXED_FONT_NAME:        return "VSDEFAULT_FIXED_FONT_NAME";
   case VSDEFAULT_COMMAND_LINE_FONT_NAME: return "VSDEFAULT_COMMAND_LINE_FONT_NAME";
   case VSDEFAULT_MENU_FONT_NAME:         return "VSDEFAULT_MENU_FONT_NAME";
   case VSDEFAULT_MDICHILD_FONT_NAME:     return "VSDEFAULT_MDICHILD_FONT_NAME";
   }
   return _quote(fontName);
}
void _insert_check_props(int _display_wid,int indent,_str form_name)
{
   ...
   if(_display_wid.p_font_name!=VSDEFAULT_DIALOG_FONT_NAME) insert_prop(indent,"p_font_name",_quote_font(_display_wid.p_font_name));
...
void _insert_radio_props(int _display_wid,int indent,_str form_name)
{
   ...
   if(_display_wid.p_font_size!=VSDEFAULT_DIALOG_FONT_SIZE) insert_prop(indent,"p_font_size",_display_wid.p_font_size);
   if(_display_wid.p_font_underline) insert_prop(indent,"p_font_underline",_bool2truefalse(_display_wid.p_font_underline));
   if(_display_wid.p_auto_size) insert_prop(indent,"p_auto_size",_bool2truefalse(_display_wid.p_auto_size));
   insert_prop(indent,"p_forecolor",_format_color(_display_wid.p_forecolor));
   insert_prop(indent,"p_height",_display_wid.p_height);
   if (_display_wid.p_help!='') safe_insert_line(substr('',1,indent)"p_help=",_display_wid.p_help);
   if(_display_wid.p_mouse_pointer!=MP_DEFAULT) insert_prop(indent,"p_mouse_pointer",eq_value2name(_display_wid.p_mouse_pointer,MP_LIST))
...
static _str _qpicture_name(int index) {
   if (_isWindows()) {
      return translate(_quote(name_name(index)),'/','\');
   }
   return  _quote(name_name(index));
...
void _insert_form_props(int _display_wid,int indent,_str form_name)
{
   ...
   if( _display_wid.p_picture!=0 ) {
      insert_prop(indent,"p_picture",_qpicture_name(_display_wid.p_picture));
   }
...
static const SWITCH_PROPS=' enabled eventtab eventtab2 font_bold':+
...
static const TEXTBROWSER_PROPS=' backcolor border_style enabled':+
                        ' eventtab eventtab2':+
...
static const
   COMBO_BOX_PROPS=' AllowDeleteHistory backcolor completion enabled eventtab eventtab2 font_bold font_italic font_name':+
             ' font_size font_underline forecolor height help mouse_pointer':+
             ' tab_stop text visible width x y ';
static void _decombo_props()
{
   _TreeAddItem(TREE_ROOT_INDEX,"AllowDeleteHistory\t"_bool2TRUEFALSE(_display_wid.p_AllowDeleteHistory),TREE_ADD_AS_CHILD,0,0,-1);
   _TreeAddItem(TREE_ROOT_INDEX,"auto_size\t"_bool2TRUEFALSE(_display_wid.p_auto_size),TREE_ADD_AS_CHILD,0,0,-1);
   _TreeAddItem(TREE_ROOT_INDEX,"backcolor\t"_format_color(_display_wid.p_backcolor),TREE_ADD_AS_CHILD,0,0,-1);
...
{
   if (_display_wid.p_AllowDeleteHistory) insert_prop(indent,"p_AllowDeleteHistory",_bool2truefalse(_display_wid.p_AllowDeleteHistory));
   insert_prop(indent,"p_auto_size",_bool2truefalse(_display_wid.p_auto_size));
   insert_prop(indent,"p_backcolor",_format_color(_display_wid.p_backcolor));
...
void _insert_picture_props(int _display_wid,int indent,_str form_name)
{
   ...
   if( _display_wid.p_font_name != VSDEFAULT_DIALOG_FONT_NAME ) {
      insert_prop(indent,"p_font_name",_quote_font(_display_wid.p_font_name));
   }
...
static _str _bool2truefalse(bool value)
{
...
static bool _truefalse2bool(_str value)
{
...
void _deupdate_edit_in_place(int index,bool setNodeEditStyle,int wid=0) {
...
static int _deset_property(int _display_wid, _str pname, typeless value)
{
   ...
   if (status==1) {
      //_deupdate_combo();
      _post_call(find_index('popup_message',COMMAND_TYPE),nls('40 Invalid property value'));
   } else if (status==2){
      //_deupdate_combo();
...
static _str _set_property(int _display_wid, _str _depname, var value)
{
   ...
   case "ActiveOrder":
      ...
      break;
   case "ActiveColor":
      new_value=_hex2dec(new_value,16,isValid);
      if (isValid) {
   ...
   case "alignment":
      ...
      break;
   case "AllowDeleteHistory":
      p_AllowDeleteHistory = eq_name2value(new_value,TRUEFALSE_LIST);
      break;
   case "auto_size":
      if (!isinteger(new_value)) {
         new_value=eq_name2value(new_value,TRUEFALSE_LIST);
...
static _str _get_property(int _display_wid, _str property)
{
   ...
   case "AllowDeleteHistory":
      return(_bool2TRUEFALSE(_display_wid.p_AllowDeleteHistory));
   case "auto_size":
...
static void _de_space_controls(_str options)
{
   ...
   int selected[];
   vert_space := (pos('v', lowcase(options)) != 0);
   inc_space := (pos('+', lowcase(options)) != 0);
   dec_space := (pos('-', lowcase(options)) != 0);
   no_spacing := (pos('0', lowcase(options)) != 0);
...
static void _de_center_controls(_str options)
{
   ...
   _de_sortselected(_display_wid, selected);
   x1 = _display_wid.p_x;
   x2 = _display_wid.p_x_extent;
   y1 = _display_wid.p_y;
   y2 = _display_wid.p_y_extent;
   for (i = 0; i < selected._length(); ++i) {
      wid = selected[i];
      x1 = (wid.p_x < x1) ? wid.p_x : x1;
      x2 = (wid.p_x_extent > x2) ? wid.p_x_extent : x2;
      y1 = (wid.p_y < y1) ? wid.p_y : y1;
      y2 = (wid.p_y_extent > y2) ? wid.p_y_extent : y2;
   }
...
static void _de_snap_controls()
{
   ...
   for (i = 0; i < selected._length(); ++i) {
      wid = selected[i];
      x = (wid.p_x intdiv w) * w;
      y = (wid.p_y intdiv h) * h;
      _set_property(wid, "x", x);
      _set_property(wid, "y", y);
   }
...
_command void vdlgedit_move(_str cmdline = '') name_info(','VSARG2_EXECUTE_FROM_MENU_ONLY)
{
   _str action, option;
