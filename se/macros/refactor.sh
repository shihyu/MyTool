...
////////////////////////////////////////////////////////////////////////////////////
#pragma option(metadata,"refactor.e")

///////////////////////////////////////////////////////////////////////////
// General DLL entry points
///////////////////////////////////////////////////////////////////////////
int def_refactor_option_flags = 0;
bool gcanceled_finding_children = false;
...
_metadata const REFACTOR_GO_TO_NEXT_FILE=    0x0001; // go to next file after last diff
_metadata const REFACTOR_GO_TO_PREV_FILE=    0x0002; // go to prev file after first diff
_metadata const REFACTOR_SYSTEM_INCLUDES=    0x0004; // allow refactoring engine to do system includes
_metadata const REFACTOR_PREVIEW_REVERSED=   0x0008; // Display modified file(s) on the left
 ...
 * @return 0 on success, <0 on error
 */
extern int refactor_c_preprocess(int handle, int wid, bool addLineMarkers=true);


///////////////////////////////////////////////////////////////////////////
// Refactoring operations
///////////////////////////////////////////////////////////////////////////
const VSREFACTOR_DEFTYPE_CONSTANT=                            1;
const VSREFACTOR_DEFTYPE_STATIC=                              2;
const VSREFACTOR_DEFTYPE_DEFINE=                              3;

const VSREFACTOR_RENAME_DEFINE=                               0x00000001;
const VSREFACTOR_RENAME_VIRTUAL_METHOD_IN_BASE_CLASSES=       0x00000002;
const VSREFACTOR_RENAME_VIRTUAL_METHOD_IN_DERIVED_CLASSES=    0x00000004;
const VSREFACTOR_RENAME_OVERLOADED_METHODS=                   0x00000008;

const VSREFACTOR_ACCESS_PUBLIC=                               0x00000100;
const VSREFACTOR_ACCESS_PROTECTED=                            0x00000200;
const VSREFACTOR_ACCESS_PRIVATE=                              0x00000400;

const VSREFACTOR_FORMAT_K_AND_R_STYLE_BRACES=                 0x00000100; // style 1
const VSREFACTOR_FORMAT_ALIGNED_STYLE_BRACES=                 0x00000200; // style 2
const VSREFACTOR_FORMAT_INDENTED_STYLE_BRACES=                0x00000400; // style 3
const VSREFACTOR_FORMAT_FUNCTION_BRACES_ON_NEW_LINE=          0x00000800; // function option
const VSREFACTOR_FORMAT_INDENT_FIRST_LEVEL_OF_CODE=           0x00001000; // indent first level
const VSREFACTOR_FORMAT_USE_CONTINUATION_INDENT=              0x00002000; // use continuation indent
const VSREFACTOR_FORMAT_INDENT_WITH_TABS=                     0x00004000; // indent with tabs
const VSREFACTOR_FORMAT_PAD_PARENS=                           0x00008000; // pad around parens
const VSREFACTOR_FORMAT_INSERT_SPACE_AFTER_COMMA=             0x00010000; // space after comma

// Bits describing properties to create a method or describe a method
const VSREFACTOR_METHOD_CREATE=                              0x00000001; // create this method or this method exists.
const VSREFACTOR_METHOD_VIRTUAL=                             0x00000002; // make the method virtual or this method is.
const VSREFACTOR_METHOD_PUBLIC=                              0x00000004; // make the method public or this method is.
const VSREFACTOR_METHOD_PROTECTED=                           0x00000008; // make the method protected or this method is.
const VSREFACTOR_METHOD_PRIVATE=                             0x00000010; // make the method private or this method is.
const VSREFACTOR_METHOD_REPLACEABLE=                         0x00000020; // should this method be allowed to be replaced.
const VSREFACTOR_METHOD_STATIC=                              0x00000040; // make the method static or this method is.

// Standard method types
const VSREFACTOR_FLAGS_MASK=                                 63;  // Mask out lowest six bits
const VSREFACTOR_METHOD_DEFAULT_CONSTRUCTOR=                 0;   // bitshift to start of default constructor flags
const VSREFACTOR_METHOD_COPY_CONSTRUCTOR=                    6;   // bitshift to start of default constructor flags
const VSREFACTOR_METHOD_ASSIGNMENT_OPERATOR=                 12;  // bitshift to start of default constructor flags
const VSREFACTOR_METHOD_DESTRUCTOR=                          18;  // bitshift to start of default constructor flags
 ...
 * @param methodName       Name of method declaration to insert
 *                         getter and setter after
 * @param beginSeekPos     Seek position of symbol or position to start search
 * @param endSeekPos       Seek position to end symbol search (0 if begin is actual symbol)
 ...
 * @categories Refactoring_Functions
 */
extern int refactor_c_push_down_find_class_in_file(int handle, _str className, _str filename, bool& found);
...
*/
extern int refactor_get_active_config( _str &header_file, _str &includes, int project_handle=-1, bool quiet=false);

extern int refactor_c_extract_class(int nHandle,_str szClass,_str szHFile,_str szCPPFile,int (&memberIdxs)[],bool bExtractSuper);
...
extern int refactor_c_extract_class_get_dependency(int nHandle, int nMemberInfoIdx, int nDependencyIdx, int& nMemberIdx, _str& szName, _str& szDescription, _str& szTypeName, bool& bIsAGlobal);

extern bool refactor_c_is_valid_id( _str id_name );
