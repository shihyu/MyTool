...
import org.junit.platform.JUnit5Core;
...
public class JUnitCore {
	...
	public Result runMain(JUnitSystem system, String... args) {
		...
		// Maybe we can support multiple requests at some point...
		...
		for (String each : args)
			try {
    			...
    			// Not so fast...maybe it's a specific method
				String className = each.substring(0, each.lastIndexOf("."));
				String methodName = each.substring(each.lastIndexOf(".")+1);
				try {
					Request r = Request.method(Class.forName(className),methodName);
					requests.add(r);
