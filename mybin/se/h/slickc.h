...
#define VSHVAR_DOT   2
 ...
 #define VSARGTYPE_BUF      6
 #define VSARGTYPE_EMPTY    7
 #define VSARGTYPE_INT64    8
      union {
         int i;
         long l;
 ...
 * reason, the output file is openned and closed on each call to ensure 
 ...
 */
int VSAPI vsEvent2Index(int event,int version VSDEFAULT(0));
/**
 * @return Returns input <i>index</i> unmodified.
 * 
 * @param index	 Event
 ...
 * 
 */ 
int VSAPI vsIndex2Event(int index,int version VSDEFAULT(0));
/**
 * Set event binding.
 * 
 * @examples 
...
/**
 * @return Returns pointer to Lstring value of interpreter variable corresponding 
 * to <i>hvar</i>.  Currently, this data format is the most efficient for 
 * retrieving interpreter variable data because no format change is 
 * required.
 * 
 * @example
 * <pre>
 ...
 * 
 */ 
VSPSZ VSAPI vsHvarGetZ(HVAR hvar);
/**
 ...
 * @categories Miscellaneous_Functions
 */
void VSAPI vsHvarArrayInsertEl(HVAR hvarArray,HVAR hvarValue,int start,int Nofitems VSDEFAULT(1));
/**
 ...
 * @categories Miscellaneous_Functions
 */
void VSAPI vsHvarArrayDeleteEl(HVAR hvarArray,int start,int Nofitems VSDEFAULT(1));
/**
 ...
 * @categories Miscellaneous_Functions
 */
void VSAPI vsHvarHashtabInsertEl(HVAR hvarArray,HVAR hvarValue,VSPSZ pBuf,int BufLen VSDEFAULT(-1));
/**
 ...
 * @categories Miscellaneous_Functions
 */
void VSAPI vsHvarHashtabDeleteEl(HVAR hvarHashtab,VSPSZ pBuf,int BufLen VSDEFAULT(-1));
/**
 * @return
 ...
 * @categories Miscellaneous_Functions
 */
VSHVAR VSAPI vsHvarIndexIn(HVAR hvarHashtab,VSPSZ pBuf,int BufLen VSDEFAULT(-1));
/**
 ...
 * @categories Miscellaneous_Functions
 */
int VSAPI vsHvarCopy(HVAR hvar,HVAR src);
/** 
 ...
 * @categories Miscellaneous_Functions
 */
int VSAPI vsHvarEqual(HVAR rhs,HVAR lhs);
/** 
 ...
 * @categories Miscellaneous_Functions
 */
int VSAPI vsHvarSetPointer(HVAR hvar,HVAR src);
 ...
 * @categories Miscellaneous_Functions
 */
int VSAPI vsHvarCallMethod(int wid,VSHVAR hvar,int index,int Nofargs,VSARGTYPE *pArgList);
/**
 * Call a class method with the given argument list. 
 * 
 * @param wid        window ID
...
int VSAPI vsHvarCallMethodByName(int wid,VSHVAR hvar,VSPSZ func_name,
                                 int Nofargs,VSARGTYPE *pArgList);
/**
 ...
 * @see vsHvarAlloc
 */
int VSAPI vsHvarConstruct(VSHVAR hvar, VSPSZ class_name,int Nofargs,VSARGTYPE *pArgList);
...
/** 
 * @return Returns value of an HVAR property. 
 ...
 * @categories Miscellaneous_Functions
 * 
 * @return Returns the value of an HVAR property.
 * 
 * @param wid
 * @param prop_id
 * 
...
/**
 * Sets value of HVAR property to <i>hvar</i>. 
 ...
 *                "c:\slickedit\_stackex.ico") to indicate that
 *                your bitmap is global. Otherwise when the
 ...
 *    }
 *    VSARGTYPE ArgList[1];
 *    ArgList[0].kind=VSARGTYPE_PSZ;ArgList[0].u.psz="some * message";
 *    vsCallIndex(0,index,1,ArgList);
 *    // Get first element of array or struct
 *    VSHVAR hvar;
 *    hvar=vsHvarArrayEl(VSHVAR_RC,0);
...
void VSAPI vsCallPtr(int wid,VSCALLPTR *pCallPtr,int Nofargs,VSARGTYPE *pArgList);
...
long VSAPI vsHvarGetL(HVAR hvar);
int VSAPI vsHvarSetLstr(VSHVAR hVar,VSLSTR *plstr);
int VSAPI vsHvarGetCallptr(HVAR hvar, VSCALLPTR *pcallptr);
...
EXTERN_C void VSAPI vsStackDump(int dumpToFile,int dumpToScreen,int errorCode=0,
                       int ignoreNStackItems=0,VSPSZ pszDumpFileName=0);
EXTERN_C_END
