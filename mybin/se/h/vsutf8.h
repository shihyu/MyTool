...
#define VSCP_ISO_8859_13      30013   /* Latin 7 */
#define VSCP_ISO_8859_14      30014   /* Latin 8 */
#define VSCP_ISO_8859_15      30015   /* Latin 9 */
#define VSCP_ISO_8859_16      30016   /* Latin 10? */

#define VSCP_CYRILLIC_KOI8_U  30100   // Cyrillic
...
#define VSCP_TIS_620          30105   // Thai

#define VSCP_MACROMAN         30113   // Macintosh Roman

#define VSCP_GB_1988          30118   // Chinese Simplified
#define VSCP_GB_12345         30120   // Chinese Simplified

#define VSCP_EUC_CN           30121   // Chinese Simplified
#define VSCP_EUC_JP           30122   // Japanese
#define VSCP_EUC_KR           30123   // Korean

#define VSCP_SYMBOLS          30200   // Symbols
#define VSCP_DINGBATS         30201   // Dingbats

// Some hardcoded code pages.
#define VSCP_SJIS             932     // Japanese Shift-JIS
#define VSCP_CYRILLIC_WINDOWS_1251 1251   // Cyrillic (Windows-1251)
#define VSCP_GB_2312          936     // Chinese Simplified
#define VSCP_BIG5             950     // Chinese Traditional Big5
 ...
 * all data converted.
 *
 * @param pCharsWritten	Receives number of characters written.
 *
 * @param pstatus	Set to 0 if no error.  Otherwise, a negative
 * return code.
 *
 ...
 *
 * @param DestLen	Length of resulting multi-byte string.
 *
 ...
 * length from a null terminated buffer.
 *
 * @param DestLen	Length of resulting UTF-16 string.
 *
 * @param i	Destination temp buffer index where
 * 0&lt;=i&lt;=9.  This allows you to call this
 * function multiple times without the previous
 ...
 * length from a null terminated buffer.
 *
 * @param DestLen	Length of resulting UTF-8 string.
 *
 * @param i	Destination temp buffer index where
 * 0&lt;=i&lt;=9.  This allows you to call this
 * function multiple times without the previous
 ...
 * pString</i> is null terminated, you can
 ...
 *
 */
unsigned VSAPI vsUTF32ToUpper(unsigned u);
/**
 ...
 *
 */
unsigned VSAPI vsUTF32ToLower(unsigned u);
const char * VSAPI vsUTF8CharName(unsigned u);
/**
 ...
 *
 */
VSSTATIC inline int vsUTF8MemICmp(const char *pBuf1,const char *pBuf2,int len)
{
