...
////////////////////////////////////////////////////////////////////////////////////
#ifndef VS_REFACTOR_H
#define VS_REFACTOR_H
 ...
 *
 */
EXTERN_C int VSAPI refactor_config_save(VSPSZ xmlConfigFile VSDEFAULT(NULL));
 ...
 *
 */
EXTERN_C int VSAPI vsRefactorConfigSave(const char *xmlConfigFile VSDEFAULT(NULL));
...
EXTERN_C int VSAPI vsRefactorCountErrors(int handle, 
                                         const char *filename VSDEFAULT(NULL));
...
#if !USE_EXTERN_TEMPLATE
#include "TBPParseNode.inl"
#include "TBPTypeInfo.inl"
#endif
