...
////////////////////////////////////////////////////////////////////////////////////
#ifndef SE_TOKEN_LIST_H
#define SE_TOKEN_LIST_H
...
private:
    ...
    */
   class SEMainTokenList * const mpMainTokenList;
...
public:
    ...
    * @see deleteTokenRange() 
    */
   int addToken(const SETokenStruct &tokenInfo, SETokenID *pNewTokenID=NULL);
   int addToken(const SETokenReadInterface &tokenInfo, SETokenID *pNewTokenID=NULL);
    ...
    */
   const SEString getTokenFileName(const SETokenID tokenID) const;
    ...
    */
   const SEString getTokenText(const SETokenID tokenID) const;
   /**
   ...
   const unsigned int getLineNumberAtOffset(const unsigned int offset,
                                            unsigned int *pLineOffset=NULL) const;
   /**
    * @return 
    ...
    * @see setTokenText() 
    */
   const SEString getText(const unsigned int startOffset,
    ...
    */
   const SEString getTokenRangeText(const SETokenID firstTokenID,
