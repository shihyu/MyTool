...
EXTERN_C_BEGIN
   ...
   */
    ...
    * 
    */ 
   int VSAPI vsBPMAdd(int wid,seSeekPos RealLineNum,int flags,void *puserdata VSDEFAULT(0));
   /**
    * 
    * @deprecated Use vsLineMarker* functions
    * 
    ...
    * 
    */ 
   int VSAPI vsBPMAddB(const char *pszBufName,seSeekPos LineNum,int flags,void *puserdata VSDEFAULT(0));
   int VSAPI vsBPMAddDeferedBreakPoint(seSeekPos LineNum,seSeekPos NofLines,const char *pszBufName,int flags,int mask,int autoadd,int alwaysAddNewBreakPoint,void *pUserData,int BMIndex,int type,const char *pszMessage,int oldAPI,int markid,seSeekPos BeginLineROffset,const char *pszLineData,int col);
   /**
    * 
    * @deprecated Use vsLineMarker* functions
    * 
    ...
    * 
    */ 
   void VSAPI vsBPMRemove(int BreakPointIndex);
   /**
    * 
    * @deprecated Use vsLineMarker* functions
    * 
    ...
    * 
    */ 
   int VSAPI vsBPMGet(int BreakPointIndex,seSeekPos *pRealLineNum= 0,int *pflags VSDEFAULT(0),void **ppuserdata VSDEFAULT(0),int *pBufID VSDEFAULT(0),void *preserved1 VSDEFAULT(0),void *preserved2 VSDEFAULT(0));
   /**
    * 
    * @deprecated Use vsLineMarker* functions
    * 
    ...
    * 
    */ 
   int VSAPI vsBPMNext(int BreakPointIndex);
    ...
    * 
    */ 
   int VSAPI vsBPMQDefaultPicture(int wid,seSeekPos LineNum,seSeekPos RealLineNum,seSeekPos OldLineNum,int reserved VSDEFAULT(0));
   /**
    * 
    * @deprecated Use vsLineMarker* functions
    * 
    ...
    * 
    */ 
   int VSAPI vsBPMQShowBreakPointsFor(int wid);
   /**
    * 
    * @deprecated Use vsLineMarker* functions
    * 
    ...
    * 
    */ 
   void VSAPI vsBPMShowBreakPoints(int onoff);
   /**
    * 
    * @deprecated Use vsLineMarker* functions
    * 
    ...
    * 
    */ 
   void VSAPI vsBPMShowBreakPointsFor(int wid,int onoff);
    ...
    * 
    */ 
   inline void VSAPI vsBPMClearAll() {vsBPMSetAll(0,-1);}
