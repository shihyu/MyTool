 ...
 */
EXTERN_C int VSAPI 
dbg_session_step_into(int session_id, int thread_id);
 ...
 */
EXTERN_C int VSAPI 
dbg_session_update_registers(int session_id);
 ...
 * @parma autovar_path    (optional) position to start updating tree at
 *
 * @return 0 on success, <0 on error.
 * 
 */
 ...
 * @parma watch_path      (optional) position to start updating tree at
 *
 * @return 0 on success, <0 on error.
 * 
 */
 ...
 * 
 */
EXTERN_C int VSAPI dbg_update_registers_tree(int tree_wid,int tree_index);
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_num_registers();
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_get_register(int reg_id,VSHREFSTR name,VSHREFSTR value);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_set_register(int reg_id, VSPSZ value);
/**
 ...
 * 
 */
EXTERN_C int VSAPI dbg_cache_resolved_path(VSPSZ file_name, VSPSZ full_path);
 ...
 * @param breakpoint_id index of variable in list of breakpoints
 *
 * @return -1 for temporary breakpoing, <-1 on error, >=0 otherwise
 * 
 */
 ...
 *
 * @parma stop_when     THROWN, CAUGHT, UNCAUGHT
 * @param count         number of times to skip breakpoint
 *                      -1 indicates that it is a one-time breakpoint
 ...
 * @parma stop_when     (reference) THROWN, CAUGHT, UNCAUGHT
 * @param count         (reference) number of times to skip breakpoint
 *                      -1 indicates that it is a one-time breakpoint
 ...
 * 
 */
EXTERN_C int VSAPI dbg_clear_registers();
 ...
 * 
 */
EXTERN_C int VSAPI dbg_gdb_update_registers();
/**
 * Update the watched memory region.
 *
 * @param address    Start address to dump
