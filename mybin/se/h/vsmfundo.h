...
EXTERN_C_BEGIN
  ...
  void VSAPI vsMFUndoGetStepFileDate(int i,int redo,VSFILEDATE *pFileDate,int CheckCurrent=0);
  int VSAPI vsFileGetDate(const char *pszFilename,VSFILEDATE *pFileDate);
  int VSAPI vsFileCompareDates(VSFILEDATE *pFileDate1,VSFILEDATE *pFileDate2);
