...
const MAPI_MAP_INDEX   = 0;
const MAPI_IMAPI_INDEX = 1;
...
class MultiMap : IMultiMap, sc.lang.IHashIndexable, sc.lang.IEquals {
    ...
    */
   public boolean assign(IMapIterator where, typeless value) {
    ...
    *         to by where-iterator is not valid.
    */
   public boolean remap(IMapIterator where, _str key) {
    ...
    */
   public boolean exists(_str key) {
   ...
   public boolean equals(IEquals& rhs) {
