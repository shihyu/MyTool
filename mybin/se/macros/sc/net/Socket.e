...
class Socket : IServerSocket, IClientSocket {
   ...
   boolean getListeningStatus(int& pending_conn);
    ...
    * @return 0 on success, <0 on error.
    */
   public int receive(_str& data, boolean peek=false, int timeout=0) {
    ...
    * @see receieveToBlob
    */
   public int receiveToFile(_str filename, XLAT_FLAGS xlatFlags=0, int timeout=0) {
    ...
    * @see receieveToFile
    */
   public int receiveToBlob(int hblob, boolean peek=false, int timeout=0) {
