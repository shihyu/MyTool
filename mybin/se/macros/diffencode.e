...
ctlok.on_create(_str filename1, _str filename2,
                ...
                boolean modify1, boolean modify2)
{
   ...
   p_text=nls('<B>%s1</B> is a unicode file and <B>%s2</B> is not.<P><B>%s3</B> must be temporarily converted to a unicode file.<p>Select the current Unicode encoding of your file so the other file can be converted to the same Unicode format and compared.',encoded_filename,unencoded_filename,unencoded_filename);
   p_window_id=wid;
