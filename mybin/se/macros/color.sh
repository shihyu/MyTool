...
////////////////////////////////////////////////////////////////////////////////////
extern boolean _clex_InString(int LineFlags);
extern boolean _clex_InComment(int LineFlags);
extern boolean _clex_InState(int LineFlags);
 ...
 */
extern void _clex_xmlSetConfig(boolean forceUpdate,_str pszTagFilename);
 ...
 * @categories Editor_Control_Methods, Miscellaneous_Functions
 */
extern void _clex_jspSetConfig(boolean forceUpdate,_str pszTagFilename);
