...
{
   _str msg = "Unable to associate font. ";
   switch (status) {
   case 1:
      msg = msg:+"Font association is not supported under current locale";
      break;
   case 2:
      msg = msg:+"Unable to parse font ":+sbfont;
      break;
   case 3:
      msg = msg:+"Unable to load font ":+sbfont;
      break;
   case 4:
      msg = msg:+"Unable to parse font ":+mbfont;
      break;
   case 5:
      msg = msg:+"Unable to load font ":+mbfont;
      break;
   }
   return(msg);
}
...
static void printMsg(boolean verbose, _str msg)
{
   if (!verbose) return;
   _message_box(msg, "Setup Japanese Fonts");
}

static int mapfont(boolean verbose=true)
{
   // Identify the locale.
   _str val = get_env("VSLICKLANG");
   if (val == "") {
      val = get_env("LANG");
      if (val == '') {
   ...
   _str ulocation = upcase(location);
   ...
   // Check encoding.
   _str uencoding = upcase(encoding);
   ...
   //    2. The width of characters in the multibyte font must be exactly
   //       twice the width of the characters in the singlebyte font.
   _str mbfont10 = "-misc-fixed-medium-r-normal--13-120-75-75-c-120-jisx0208.1983-0";
   _str mbfont12 = "-misc-fixed-medium-r-normal--14-130-75-75-c-140-jisx0208.1983-0";
   _str mbfont14 = "-misc-fixed-medium-r-normal--19-180-75-75-c-180-jisx0208.1983-0";
   _str sbfont10 = "adobe-courier,10";
   _str sbfont12 = "adobe-courier,12";
   _str sbfont14 = "adobe-courier,14";
