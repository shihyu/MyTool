...
#define FIRSTSPECIALCHAR   6
#define LASTSPECIALCHAR    11
...
#define SPEC_CHARS_EDITOR_CTRL_NAME    "_ctlSpecialCharE"
#define SPEC_CHARS_TB_CTRL_NAME        "_ctlSpecialCharC"
#define SPEC_CHARS_UNICODE_CTRL_NAME   "_ctlSpecialCharUE"
#define DEC_HEX_RETRIEVE_NAME          "_special_characters_form._ctlViewDec"
#define ORIG_SPEC_CHARS                _ctlSpecialCharReset.p_user
#define ORIG_UNICODE_SPEC_CHARS        _ctlViewDec.p_user
#define DEC_HEX_MODE                   _ctlViewHex.p_user

defeventtab _special_characters_form;

#region Options Dialog Helper Functions

boolean _special_characters_form_is_modified()
{
...
boolean _special_characters_form_validate()
{
   int wid;
   _str ctlName;
...
{
   heightDiff := p_height - (_ctlSpecialCharReset.p_y + _ctlSpecialCharReset.p_height);
   widthDiff := p_width - (_ctlSpecialCharReset.p_x + _ctlSpecialCharReset.p_width);
...
{
   // make sure we're properly hexified
   text := lowcase(p_text);
...
{
   colWidth := ctl_unicode_tree.p_width / 7;
