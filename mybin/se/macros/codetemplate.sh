...
////////////////////////////////////////////////////////////////////////////////////
#ifndef CODETEMPLATE_SH
#define CODETEMPLATE_SH

#define CT_ROOT_DIR "templates"
#define CT_SYS_ITEM_DIR "ItemTemplates"
#define CT_USER_ITEM_DIR "ItemTemplates"

#define CT_SYS_ITEM_CAT_CAPTION "Installed Templates"
#define CT_USER_ITEM_CAT_CAPTION "User Templates"

#define CT_ITEM_TEMPLATE_TEMPLATE "ItemTemplate.setemplate"

#define CT_EXT ".setemplate"
// Current template metadata version supported
#define CT_VERSION "1.0"
// Default delimiter for a substitution parameter
#define CTPARAMETER_DELIM '$'
// Default word characters that make up a valid identifier
#define CTPARAMETER_NAME_RE '[a-zA-Z0-9_]@'
// Invalid DefaultName characters (can also be used to validate item name)
#define CTDEFAULTNAME_INVALID_CHARS '[\@\&\<\>\|\?\\/]'

#define CTOPTIONS_VERSION "1.0"
#define CTOPTIONS_FILENAME "options.xml"
