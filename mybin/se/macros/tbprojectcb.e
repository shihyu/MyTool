...
static void _update_projects_cb()
{
   ...
   if (_project_name == '') {
      ...
      _str current_project = GetProjectDisplayName(_project_name);
...
static void _update_project_configurations_cb()
{
   ...
   _str active_config = GetCurrentConfigName(_project_name);
