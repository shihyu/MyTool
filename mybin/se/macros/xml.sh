 ...
 * @categories XMLCFG_Functions
 */
extern int _xmlcfg_get_num_nodes(int iHandle);
/**
 ...
 * @categories XMLCFG_Functions
 * @param iHandle   Handle to an XMLCFG tree returned by _xmlcfg_open() ,_xmlcfg_create(), or _xmlcfg_open_from_buffer().
 * @param QueryStr  This is a small subset of an XPath expression.  Do not add white space since
 ...
 * @param NodeIndex Tree node index to start search from.
 * 
 * @return Returns node index (>=0) found if successful.  Otherwise a negative
