...
/** Open folder */
#define DLITEMTYPE_FOLDER_OPEN   0
/** Active open folder */
#define DLITEMTYPE_FOLDER_AOPEN  1
/** Closed folder */
#define DLITEMTYPE_FOLDER_CLOSED 2
/** Leaf (no children) */
#define DLITEMTYPE_LEAF          3
 ...
 */
typedef boolean (*pfnDLViewAddChildItem_t)(_str item, int itemType, _str fullPath);
 ...
 * @return true if the child was added; false otherwise.
 */
typedef boolean (*pfnDLViewAddSiblingItem_t)(_str item, int itemType, _str fullPath);
 ...
 */
typedef boolean (*pfnDLViewGotoParent_t)();

/**
 * Set cursor to first child of current item.
 */
typedef boolean (*pfnDLViewGotoFirstChild_t)();

/**
 * Set cursor to next sibling of current item.
 */
typedef boolean (*pfnDLViewGotoNextSibling_t)();
