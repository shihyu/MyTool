...
/**
 * Determines whether the Product Improvement Program is actively collecting
 * data and then attempting to send it in.
 */
 ...
 * participate. 
 */
boolean def_pip_show_options = true;
 ...
 *                               error
 */
extern int _pip_start_logging(_str pipFilename, boolean doUpgrade);
