...
def  'M-Z'= emacs_scroll_down;
def  'M-['= prev_paragraph;
def  'M-\'= delete_space;
def  'M-]'= next_paragraph;
def  'M-F1'= api_index;
def  'M-F2'= move_edge;
...
def  'M-PGUP'= prev_window;
def  'M-PGDN'= next_window;
def  'M-DEL'= cut_prev_level;
def  'S- '= keyin_space;
def  'S-F1'= scroll_up;
...
def  'A-LEFT'= begin_line;
def  'A-RIGHT'= end_line;
def  'A-PGUP'= prev_window;
def  'A-PGDN'= next_window;
def  'A-DEL'= cut_prev_level;
