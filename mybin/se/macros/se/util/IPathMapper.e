...
interface IPathMapper {
    ...
    *                            to false.
    */
   void removeByPath(_str path, boolean removeDefaultPaths=false);
    ...
    *                            to false.
    */
   void removeByPathSpec(_str path_spec, boolean removeDefaultPaths=false);
    ...
    *         match found.
    */
   typeless getByPath(_str path, boolean useDefaultPaths=false);
    ...
    *         method of iterator to retrieve the key of the match.
    */
   IPathMapperIterator mapNext(IPathMapperIterator where, boolean fail_fast=false);
