...
#include "se/debug/perl5db/Perl5dbOptions.e"
#import "debug.e"
#import "main.e"
#import "stdprocs.e"
...
Perl5dbOptions perl5db_make_default_options(Perl5dbOptions& perl5db_opts=null)
{
 ...
 */
void perl5db_project_get_options_for_config(int projectHandle, _str config, Perl5dbOptions& perl5db_opts, Perl5dbOptions& default_perl5db_opts=null)
{
   ...
   boolean listenInBackground = default_perl5db_opts.listenInBackground;
   Perl5dbRemoteFileMapping remoteFileMap[] = default_perl5db_opts.remoteFileMap;
 ...
 *                             options present for config.
 */
void perl5db_project_get_options(int projectHandle, _str (&configList)[], Perl5dbOptions (&perl5db_opts_list):[], Perl5dbOptions& default_perl5db_opts=null)
{
 ...
 */
boolean perl5db_is_pending(_str host, _str port)
{
 ...
 */
int perl5db_wait(_str host, _str port, int timeout, ServerConnectionObserver* observer, boolean close_on_error)
{
 ...
 */
int perl5db_wait_and_accept(_str host, _str port, int timeout, ServerConnectionObserver* observer, boolean close_if_first)
{
 ...
 */
boolean perl5db_is_listening(_str host, _str port)
{
 ...
 */
boolean perl5db_get_server_address(_str& host, _str& port)
{
...
static int perl5db_get_options(_str projectName, Perl5dbOptions& perl5db_opts)
{
   if( projectName != "" ) {
 ...
 * @return 0 on success, <0 on error.
 */
_command int perl5db_project_watch(_str projectName=_project_name, boolean honorListenInBackground=false)
{
   ...
   if( status != 0 ) {
      if( status != COMMAND_CANCELLED_RC ) {
         _str msg = "Invalid perl5db host/port. Cannot listen for connection.";
 ...
 *                     name.
 */
_command void perl5db_project_shutdown(_str projectName=_project_name)
{
   _str id_found = null;
   _str prefix = "";
   if( projectName != "" ) {
...
_command void perl5db_project_watch_toggle(_str projectName=_project_name)
{
   _str id_found = null;
   _str prefix = "";
   if( projectName != "" ) {
 ...
 */
void _project_close_perl5db(_str projectName)
{
   if( _project_DebugCallbackName != "perl5db" ) {
      return;
   }
