...
class ExportImportGroupManager {
   ...
   private int m_defaultStatus;

   private se.options.OptionsXMLParser * m_parser;

   ExportImportGroupManager(int defaultStatus = EIIS_TRUE, se.options.OptionsXMLParser * parser = null)
   {
    ...
    *                            otherwise
    */
   public boolean isCurrentGroupModified()
   {
    ...
    */
   public boolean doesCurrentGroupHaveProtections(boolean includeUnprotects = false)
   {
    ...
    * @return 
    */
   public void addPropertyToGroup(int index, boolean isNew = true)
   {
    ...
    *                            group specified
    */
   public boolean setCurrentGroup(_str groupName)
   {
   ...
   public void getAllIndices(int (&nodes)[], boolean onlyLeaves = false)
   {
      int allNodes[] = m_groups:[m_currentGroup].getAllIndices();
   ...
   public void saveGroups(boolean writeToFile)
   {
   ...
   public void changeXMLNodeChildrenStatus(int xmlIndex, int status)
   {
   ...
   private void changeXMLNodeParentStatus(int xmlIndex, int childStatus)
   {
      // we need more info...
