...
class ControlValues {
   ...
   public boolean hasChanged(_str langID)
   {
   ...
   public boolean doesAllLanguagesOverrideLanguageValue(_str langId)
   {
      return (getLangVersion(langId) < getAllLangsVersion());
   }

   public boolean doesAnyLanguageValueOverrideAllLanguages()
   {
      return (m_version > getAllLangsVersion());
   }

// public boolean getAllLanguagesValue(_str &value)
// {
...
class AllLanguagesTable {
    ...
    */
   public boolean doesAllLanguagesOverride(_str form, _str control, _str langId)
   {
      key := createKey(form, control);
      if (m_table._indexin(key)) {
   ...
   public boolean doesAnyLanguageOverrideAllLanguages(_str form, _str control)
   {
      key := createKey(form, control);
      if (m_table._indexin(key)) {
    ...
    */
   public boolean isAllLanguagesModified(_str form)
   {
      _str key;
      ControlValues cv;
      foreach (key => cv in m_table) {
   ...
   public boolean isLangFormModified(_str form, _str langID)
   {
      _str key;
      ControlValues cv;
   ...
   public boolean hasAllLanguagesBeenSetForControl(_str form, _str control)
   {
