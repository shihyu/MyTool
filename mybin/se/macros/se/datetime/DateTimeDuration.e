   ...
   sc.lang.IHashable
{
   ...
   public boolean equals (sc.lang.IEquals& rhs); //IEquals
   ...
   public DateTimeDuration add (DateTimeDuration& rhs)
   {
      ...
      boolean lhsWeek = (this.weeks() != 0);
      boolean rhsWeek = (rhs.weeks() != 0);
