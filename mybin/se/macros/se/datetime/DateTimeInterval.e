   ...
   se.util.IFilter
{
   ...
   public boolean filter (typeless& rhs); //IFilter
   ...
   public boolean m_activeFilterLists:[];
   ...
   private _str toStringPlain ()
   {
      ...
      if ((this.m_repetitions > 0) || (this.m_repetitions :== '')) {
         interval = interval', repeated 'this.m_repetitions' times';
      }
    ...
    * @return 
    */
   public boolean filter (typeless& rhs)
   {
