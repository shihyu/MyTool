...
//
void _tbSaveState__tboutputwin_form(typeless& state, boolean closing)
{
   //if( closing ) {
   //   return;
   //}
...
void _tbRestoreState__tboutputwin_form(typeless& state, boolean opening)
{
   //if( opening ) {
   //   return;
   //}
...
static void resizeOutputWin()
{
   ...
   ctloutput.p_height = clientH - ctloutput.p_y - ctloutput.p_x;
}
